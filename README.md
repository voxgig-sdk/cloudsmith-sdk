...
Full documentation for this SDK: [https://voxgig-sdk.github.io/cloudsmith-sdk/](https://voxgig-sdk.github.io/cloudsmith-sdk/)
...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/cloudsmith` | publish pending — [install from git tag](https://github.com/voxgig-sdk/cloudsmith-sdk/tags) |
| Python | `voxgig-sdk-cloudsmith` | publish pending — [install from git tag](https://github.com/voxgig-sdk/cloudsmith-sdk/tags) |
| PHP | `voxgig-sdk/cloudsmith` | publish pending — [install from git tag](https://github.com/voxgig-sdk/cloudsmith-sdk/tags) |
| Golang | `github.com/voxgig-sdk/cloudsmith-sdk/go` | `go get github.com/voxgig-sdk/cloudsmith-sdk/go@latest` |
| Ruby | `voxgig-sdk-cloudsmith` | publish pending — [install from git tag](https://github.com/voxgig-sdk/cloudsmith-sdk/tags) |
| Lua | `voxgig-sdk-cloudsmith` | publish pending — [install from git tag](https://github.com/voxgig-sdk/cloudsmith-sdk/tags) |
...
| **Repo** | The Repo entity (create, list, load, patch, remove, update). | `/repos/` |
...
| **RepositoryWebhook** | The RepositoryWebhook entity (create, list, load, update). | `/webhooks/{owner}/{repo}/` |
