...
func NewGeoipEntity(client *core.CloudsmithSDK, entopts map[string]any) *GeoipEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *GeoipEntity) GetName() string { return e.name }
...
func (e *GeoipEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *GeoipEntity) Deleted() bool {
	return e.deleted
}


func (e *GeoipEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewGeoipEntity(e.client, opts)
}

func (e *GeoipEntity) Data(args ...any) any {
...
func (e *GeoipEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Geoip; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *GeoipEntity) DataTyped(data ...Geoip) Geoip {
	if len(data) > 0 {
		return typedFrom[Geoip](e.Data(asMap(data[0])))
	}
	return typedFrom[Geoip](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Geoip (all fields
// optional at the wire level).
func (e *GeoipEntity) MatchTyped(match ...Geoip) Geoip {
	if len(match) > 0 {
		return typedFrom[Geoip](e.Match(asMap(match[0])))
	}
	return typedFrom[Geoip](e.Match())
}
...
func (e *GeoipEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *GeoipEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *GeoipEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *GeoipEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *GeoipEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *GeoipEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *GeoipEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
