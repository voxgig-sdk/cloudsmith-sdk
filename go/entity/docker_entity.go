...
func NewDockerEntity(client *core.CloudsmithSDK, entopts map[string]any) *DockerEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *DockerEntity) GetName() string { return e.name }
...
func (e *DockerEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *DockerEntity) Deleted() bool {
	return e.deleted
}


func (e *DockerEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewDockerEntity(e.client, opts)
}

func (e *DockerEntity) Data(args ...any) any {
...
func (e *DockerEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Docker; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *DockerEntity) DataTyped(data ...Docker) Docker {
	if len(data) > 0 {
		return typedFrom[Docker](e.Data(asMap(data[0])))
	}
	return typedFrom[Docker](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Docker (all fields
// optional at the wire level).
func (e *DockerEntity) MatchTyped(match ...Docker) Docker {
	if len(match) > 0 {
		return typedFrom[Docker](e.Match(asMap(match[0])))
	}
	return typedFrom[Docker](e.Match())
}
...
func (e *DockerEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *DockerEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// DockerLoadMatch and returns an Docker. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *DockerEntity) LoadTyped(reqmatch DockerLoadMatch, ctrl map[string]any) (Docker, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Docker{}, err
	}
	return typedFrom[Docker](res), nil
}




func (e *DockerEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// DockerListMatch and returns []Docker. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *DockerEntity) ListTyped(reqmatch DockerListMatch, ctrl map[string]any) ([]Docker, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Docker](res), nil
}




func (e *DockerEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// DockerCreateData and returns an Docker. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *DockerEntity) CreateTyped(reqdata DockerCreateData, ctrl map[string]any) (Docker, error) {
...
func (e *DockerEntity) Update(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "update",
		"ctrl":    ctrl,
...
// DockerUpdateData and returns an Docker. It delegates to the untyped
// Update (identical runtime) and converts at the typed boundary.
func (e *DockerEntity) UpdateTyped(reqdata DockerUpdateData, ctrl map[string]any) (Docker, error) {
...
func (e *DockerEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *DockerEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
