...
type UserAuthTokenEntity struct {
	name    string
...
func NewUserAuthTokenEntity(client *core.CloudsmithSDK, entopts map[string]any) *UserAuthTokenEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *UserAuthTokenEntity) GetName() string { return e.name }
...
func (e *UserAuthTokenEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *UserAuthTokenEntity) Deleted() bool {
	return e.deleted
}


func (e *UserAuthTokenEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewUserAuthTokenEntity(e.client, opts)
}

func (e *UserAuthTokenEntity) Data(args ...any) any {
...
func (e *UserAuthTokenEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an UserAuthToken; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *UserAuthTokenEntity) DataTyped(data ...UserAuthToken) UserAuthToken {
	if len(data) > 0 {
		return typedFrom[UserAuthToken](e.Data(asMap(data[0])))
	}
	return typedFrom[UserAuthToken](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through UserAuthToken (all fields
// optional at the wire level).
func (e *UserAuthTokenEntity) MatchTyped(match ...UserAuthToken) UserAuthToken {
	if len(match) > 0 {
		return typedFrom[UserAuthToken](e.Match(asMap(match[0])))
	}
	return typedFrom[UserAuthToken](e.Match())
}
...
func (e *UserAuthTokenEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *UserAuthTokenEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *UserAuthTokenEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *UserAuthTokenEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// UserAuthTokenCreateData and returns an UserAuthToken. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *UserAuthTokenEntity) CreateTyped(reqdata UserAuthTokenCreateData, ctrl map[string]any) (UserAuthToken, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return UserAuthToken{}, err
	}
	return typedFrom[UserAuthToken](res), nil
}



func (e *UserAuthTokenEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *UserAuthTokenEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *UserAuthTokenEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
