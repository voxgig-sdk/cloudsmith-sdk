...
func NewLuarockEntity(client *core.CloudsmithSDK, entopts map[string]any) *LuarockEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *LuarockEntity) GetName() string { return e.name }
...
func (e *LuarockEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *LuarockEntity) Deleted() bool {
	return e.deleted
}


func (e *LuarockEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewLuarockEntity(e.client, opts)
}

func (e *LuarockEntity) Data(args ...any) any {
...
func (e *LuarockEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Luarock; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *LuarockEntity) DataTyped(data ...Luarock) Luarock {
	if len(data) > 0 {
		return typedFrom[Luarock](e.Data(asMap(data[0])))
	}
	return typedFrom[Luarock](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Luarock (all fields
// optional at the wire level).
func (e *LuarockEntity) MatchTyped(match ...Luarock) Luarock {
	if len(match) > 0 {
		return typedFrom[Luarock](e.Match(asMap(match[0])))
	}
	return typedFrom[Luarock](e.Match())
}
...
func (e *LuarockEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *LuarockEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *LuarockEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *LuarockEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *LuarockEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *LuarockEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *LuarockEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
