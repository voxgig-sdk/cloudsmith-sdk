...
func NewCompleteEntity(client *core.CloudsmithSDK, entopts map[string]any) *CompleteEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CompleteEntity) GetName() string { return e.name }
...
func (e *CompleteEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CompleteEntity) Deleted() bool {
	return e.deleted
}


func (e *CompleteEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCompleteEntity(e.client, opts)
}

func (e *CompleteEntity) Data(args ...any) any {
...
func (e *CompleteEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Complete; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *CompleteEntity) DataTyped(data ...Complete) Complete {
	if len(data) > 0 {
		return typedFrom[Complete](e.Data(asMap(data[0])))
	}
	return typedFrom[Complete](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Complete (all fields
// optional at the wire level).
func (e *CompleteEntity) MatchTyped(match ...Complete) Complete {
	if len(match) > 0 {
		return typedFrom[Complete](e.Match(asMap(match[0])))
	}
	return typedFrom[Complete](e.Match())
}
...
func (e *CompleteEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CompleteEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *CompleteEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *CompleteEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *CompleteEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *CompleteEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *CompleteEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
