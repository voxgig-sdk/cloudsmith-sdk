...
func NewStatusEntity(client *core.CloudsmithSDK, entopts map[string]any) *StatusEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *StatusEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
