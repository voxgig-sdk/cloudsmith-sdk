...
func NewVersionEntity(client *core.CloudsmithSDK, entopts map[string]any) *VersionEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *VersionEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
