...
func NewHexEntity(client *core.CloudsmithSDK, entopts map[string]any) *HexEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *HexEntity) GetName() string { return e.name }
...
func (e *HexEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *HexEntity) Deleted() bool {
	return e.deleted
}


func (e *HexEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewHexEntity(e.client, opts)
}

func (e *HexEntity) Data(args ...any) any {
...
func (e *HexEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Hex; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *HexEntity) DataTyped(data ...Hex) Hex {
	if len(data) > 0 {
		return typedFrom[Hex](e.Data(asMap(data[0])))
	}
	return typedFrom[Hex](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Hex (all fields
// optional at the wire level).
func (e *HexEntity) MatchTyped(match ...Hex) Hex {
	if len(match) > 0 {
		return typedFrom[Hex](e.Match(asMap(match[0])))
	}
	return typedFrom[Hex](e.Match())
}
...
func (e *HexEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *HexEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// HexLoadMatch and returns an Hex. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *HexEntity) LoadTyped(reqmatch HexLoadMatch, ctrl map[string]any) (Hex, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Hex{}, err
	}
	return typedFrom[Hex](res), nil
}




func (e *HexEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// HexListMatch and returns []Hex. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *HexEntity) ListTyped(reqmatch HexListMatch, ctrl map[string]any) ([]Hex, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Hex](res), nil
}




func (e *HexEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// HexCreateData and returns an Hex. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *HexEntity) CreateTyped(reqdata HexCreateData, ctrl map[string]any) (Hex, error) {
...
func (e *HexEntity) Update(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "update",
		"ctrl":    ctrl,
...
// HexUpdateData and returns an Hex. It delegates to the untyped
// Update (identical runtime) and converts at the typed boundary.
func (e *HexEntity) UpdateTyped(reqdata HexUpdateData, ctrl map[string]any) (Hex, error) {
...
func (e *HexEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *HexEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
