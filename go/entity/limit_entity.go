...
func NewLimitEntity(client *core.CloudsmithSDK, entopts map[string]any) *LimitEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *LimitEntity) GetName() string { return e.name }
...
func (e *LimitEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *LimitEntity) Deleted() bool {
	return e.deleted
}


func (e *LimitEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewLimitEntity(e.client, opts)
}

func (e *LimitEntity) Data(args ...any) any {
...
func (e *LimitEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Limit; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *LimitEntity) DataTyped(data ...Limit) Limit {
	if len(data) > 0 {
		return typedFrom[Limit](e.Data(asMap(data[0])))
	}
	return typedFrom[Limit](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Limit (all fields
// optional at the wire level).
func (e *LimitEntity) MatchTyped(match ...Limit) Limit {
	if len(match) > 0 {
		return typedFrom[Limit](e.Match(asMap(match[0])))
	}
	return typedFrom[Limit](e.Match())
}
...
func (e *LimitEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *LimitEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *LimitEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *LimitEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *LimitEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *LimitEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *LimitEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
