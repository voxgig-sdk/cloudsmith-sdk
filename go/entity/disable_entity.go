...
func NewDisableEntity(client *core.CloudsmithSDK, entopts map[string]any) *DisableEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *DisableEntity) GetName() string { return e.name }
...
func (e *DisableEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *DisableEntity) Deleted() bool {
	return e.deleted
}


func (e *DisableEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewDisableEntity(e.client, opts)
}

func (e *DisableEntity) Data(args ...any) any {
...
func (e *DisableEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Disable; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *DisableEntity) DataTyped(data ...Disable) Disable {
	if len(data) > 0 {
		return typedFrom[Disable](e.Data(asMap(data[0])))
	}
	return typedFrom[Disable](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Disable (all fields
// optional at the wire level).
func (e *DisableEntity) MatchTyped(match ...Disable) Disable {
	if len(match) > 0 {
		return typedFrom[Disable](e.Match(asMap(match[0])))
	}
	return typedFrom[Disable](e.Match())
}
...
func (e *DisableEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *DisableEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *DisableEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *DisableEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *DisableEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *DisableEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *DisableEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
