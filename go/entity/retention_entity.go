...
func NewRetentionEntity(client *core.CloudsmithSDK, entopts map[string]any) *RetentionEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *RetentionEntity) GetName() string { return e.name }
...
func (e *RetentionEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *RetentionEntity) Deleted() bool {
	return e.deleted
}


func (e *RetentionEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewRetentionEntity(e.client, opts)
}

func (e *RetentionEntity) Data(args ...any) any {
...
func (e *RetentionEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Retention; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *RetentionEntity) DataTyped(data ...Retention) Retention {
	if len(data) > 0 {
		return typedFrom[Retention](e.Data(asMap(data[0])))
	}
	return typedFrom[Retention](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Retention (all fields
// optional at the wire level).
func (e *RetentionEntity) MatchTyped(match ...Retention) Retention {
	if len(match) > 0 {
		return typedFrom[Retention](e.Match(asMap(match[0])))
	}
	return typedFrom[Retention](e.Match())
}
...
func (e *RetentionEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *RetentionEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *RetentionEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *RetentionEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *RetentionEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *RetentionEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *RetentionEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
