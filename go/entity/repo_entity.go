...
func NewRepoEntity(client *core.CloudsmithSDK, entopts map[string]any) *RepoEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *RepoEntity) GetName() string { return e.name }
...
func (e *RepoEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *RepoEntity) Deleted() bool {
	return e.deleted
}


func (e *RepoEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewRepoEntity(e.client, opts)
}

func (e *RepoEntity) Data(args ...any) any {
...
func (e *RepoEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Repo; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *RepoEntity) DataTyped(data ...Repo) Repo {
	if len(data) > 0 {
		return typedFrom[Repo](e.Data(asMap(data[0])))
	}
	return typedFrom[Repo](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Repo (all fields
// optional at the wire level).
func (e *RepoEntity) MatchTyped(match ...Repo) Repo {
	if len(match) > 0 {
		return typedFrom[Repo](e.Match(asMap(match[0])))
	}
	return typedFrom[Repo](e.Match())
}
...
func (e *RepoEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *RepoEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// RepoLoadMatch and returns an Repo. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *RepoEntity) LoadTyped(reqmatch RepoLoadMatch, ctrl map[string]any) (Repo, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Repo{}, err
	}
	return typedFrom[Repo](res), nil
}




func (e *RepoEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// RepoListMatch and returns []Repo. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *RepoEntity) ListTyped(reqmatch RepoListMatch, ctrl map[string]any) ([]Repo, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Repo](res), nil
}




func (e *RepoEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// RepoCreateData and returns an Repo. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *RepoEntity) CreateTyped(reqdata RepoCreateData, ctrl map[string]any) (Repo, error) {
...
func (e *RepoEntity) Update(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "update",
		"ctrl":    ctrl,
...
// RepoUpdateData and returns an Repo. It delegates to the untyped
// Update (identical runtime) and converts at the typed boundary.
func (e *RepoEntity) UpdateTyped(reqdata RepoUpdateData, ctrl map[string]any) (Repo, error) {
...
func (e *RepoEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "remove",
		"ctrl":     ctrl,
...
// RepoRemoveMatch and returns an Repo. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *RepoEntity) RemoveTyped(reqmatch RepoRemoveMatch, ctrl map[string]any) (Repo, error) {
...
func (e *RepoEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
