...
func NewSelfEntity(client *core.CloudsmithSDK, entopts map[string]any) *SelfEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *SelfEntity) GetName() string { return e.name }
...
func (e *SelfEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *SelfEntity) Deleted() bool {
	return e.deleted
}


func (e *SelfEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewSelfEntity(e.client, opts)
}

func (e *SelfEntity) Data(args ...any) any {
...
func (e *SelfEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Self; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *SelfEntity) DataTyped(data ...Self) Self {
	if len(data) > 0 {
		return typedFrom[Self](e.Data(asMap(data[0])))
	}
	return typedFrom[Self](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Self (all fields
// optional at the wire level).
func (e *SelfEntity) MatchTyped(match ...Self) Self {
	if len(match) > 0 {
		return typedFrom[Self](e.Match(asMap(match[0])))
	}
	return typedFrom[Self](e.Match())
}
...
func (e *SelfEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *SelfEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *SelfEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *SelfEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *SelfEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *SelfEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *SelfEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
