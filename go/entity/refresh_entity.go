...
func NewRefreshEntity(client *core.CloudsmithSDK, entopts map[string]any) *RefreshEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *RefreshEntity) GetName() string { return e.name }
...
func (e *RefreshEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *RefreshEntity) Deleted() bool {
	return e.deleted
}


func (e *RefreshEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewRefreshEntity(e.client, opts)
}

func (e *RefreshEntity) Data(args ...any) any {
...
func (e *RefreshEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Refresh; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *RefreshEntity) DataTyped(data ...Refresh) Refresh {
	if len(data) > 0 {
		return typedFrom[Refresh](e.Data(asMap(data[0])))
	}
	return typedFrom[Refresh](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Refresh (all fields
// optional at the wire level).
func (e *RefreshEntity) MatchTyped(match ...Refresh) Refresh {
	if len(match) > 0 {
		return typedFrom[Refresh](e.Match(asMap(match[0])))
	}
	return typedFrom[Refresh](e.Match())
}
...
func (e *RefreshEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *RefreshEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *RefreshEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *RefreshEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *RefreshEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *RefreshEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *RefreshEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
