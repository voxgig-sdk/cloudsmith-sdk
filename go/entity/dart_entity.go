...
func NewDartEntity(client *core.CloudsmithSDK, entopts map[string]any) *DartEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *DartEntity) GetName() string { return e.name }
...
func (e *DartEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *DartEntity) Deleted() bool {
	return e.deleted
}


func (e *DartEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewDartEntity(e.client, opts)
}

func (e *DartEntity) Data(args ...any) any {
...
func (e *DartEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Dart; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *DartEntity) DataTyped(data ...Dart) Dart {
	if len(data) > 0 {
		return typedFrom[Dart](e.Data(asMap(data[0])))
	}
	return typedFrom[Dart](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Dart (all fields
// optional at the wire level).
func (e *DartEntity) MatchTyped(match ...Dart) Dart {
	if len(match) > 0 {
		return typedFrom[Dart](e.Match(asMap(match[0])))
	}
	return typedFrom[Dart](e.Match())
}
...
func (e *DartEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *DartEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// DartLoadMatch and returns an Dart. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *DartEntity) LoadTyped(reqmatch DartLoadMatch, ctrl map[string]any) (Dart, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Dart{}, err
	}
	return typedFrom[Dart](res), nil
}




func (e *DartEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// DartListMatch and returns []Dart. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *DartEntity) ListTyped(reqmatch DartListMatch, ctrl map[string]any) ([]Dart, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Dart](res), nil
}




func (e *DartEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// DartCreateData and returns an Dart. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *DartEntity) CreateTyped(reqdata DartCreateData, ctrl map[string]any) (Dart, error) {
...
func (e *DartEntity) Update(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "update",
		"ctrl":    ctrl,
...
// DartUpdateData and returns an Dart. It delegates to the untyped
// Update (identical runtime) and converts at the typed boundary.
func (e *DartEntity) UpdateTyped(reqdata DartUpdateData, ctrl map[string]any) (Dart, error) {
...
func (e *DartEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *DartEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
