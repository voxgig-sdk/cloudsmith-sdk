...
func NewGon2Entity(client *core.CloudsmithSDK, entopts map[string]any) *Gon2Entity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *Gon2Entity) GetName() string { return e.name }

func (e *Gon2Entity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewGon2Entity(e.client, opts)
}

func (e *Gon2Entity) Data(args ...any) any {
...
func (e *Gon2Entity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Gon2; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *Gon2Entity) DataTyped(data ...Gon2) Gon2 {
	if len(data) > 0 {
		return typedFrom[Gon2](e.Data(asMap(data[0])))
	}
	return typedFrom[Gon2](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Gon2 (all fields
// optional at the wire level).
func (e *Gon2Entity) MatchTyped(match ...Gon2) Gon2 {
	if len(match) > 0 {
		return typedFrom[Gon2](e.Match(asMap(match[0])))
	}
	return typedFrom[Gon2](e.Match())
}
...
func (e *Gon2Entity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *Gon2Entity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *Gon2Entity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *Gon2Entity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *Gon2Entity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *Gon2Entity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *Gon2Entity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
