...
type LicensePolicyEntity struct {
	name    string
...
func NewLicensePolicyEntity(client *core.CloudsmithSDK, entopts map[string]any) *LicensePolicyEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *LicensePolicyEntity) GetName() string { return e.name }
...
func (e *LicensePolicyEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *LicensePolicyEntity) Deleted() bool {
	return e.deleted
}


func (e *LicensePolicyEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewLicensePolicyEntity(e.client, opts)
}

func (e *LicensePolicyEntity) Data(args ...any) any {
...
func (e *LicensePolicyEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an LicensePolicy; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *LicensePolicyEntity) DataTyped(data ...LicensePolicy) LicensePolicy {
	if len(data) > 0 {
		return typedFrom[LicensePolicy](e.Data(asMap(data[0])))
	}
	return typedFrom[LicensePolicy](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through LicensePolicy (all fields
// optional at the wire level).
func (e *LicensePolicyEntity) MatchTyped(match ...LicensePolicy) LicensePolicy {
	if len(match) > 0 {
		return typedFrom[LicensePolicy](e.Match(asMap(match[0])))
	}
	return typedFrom[LicensePolicy](e.Match())
}
...
func (e *LicensePolicyEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *LicensePolicyEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *LicensePolicyEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *LicensePolicyEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *LicensePolicyEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *LicensePolicyEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *LicensePolicyEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
