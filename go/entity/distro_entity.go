...
func NewDistroEntity(client *core.CloudsmithSDK, entopts map[string]any) *DistroEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *DistroEntity) GetName() string { return e.name }
...
func (e *DistroEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *DistroEntity) Deleted() bool {
	return e.deleted
}


func (e *DistroEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewDistroEntity(e.client, opts)
}

func (e *DistroEntity) Data(args ...any) any {
...
func (e *DistroEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Distro; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *DistroEntity) DataTyped(data ...Distro) Distro {
	if len(data) > 0 {
		return typedFrom[Distro](e.Data(asMap(data[0])))
	}
	return typedFrom[Distro](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Distro (all fields
// optional at the wire level).
func (e *DistroEntity) MatchTyped(match ...Distro) Distro {
	if len(match) > 0 {
		return typedFrom[Distro](e.Match(asMap(match[0])))
	}
	return typedFrom[Distro](e.Match())
}
...
func (e *DistroEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *DistroEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *DistroEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *DistroEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *DistroEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *DistroEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *DistroEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
