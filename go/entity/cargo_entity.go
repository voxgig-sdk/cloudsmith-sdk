...
func NewCargoEntity(client *core.CloudsmithSDK, entopts map[string]any) *CargoEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CargoEntity) GetName() string { return e.name }
...
func (e *CargoEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CargoEntity) Deleted() bool {
	return e.deleted
}


func (e *CargoEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCargoEntity(e.client, opts)
}

func (e *CargoEntity) Data(args ...any) any {
...
func (e *CargoEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Cargo; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *CargoEntity) DataTyped(data ...Cargo) Cargo {
	if len(data) > 0 {
		return typedFrom[Cargo](e.Data(asMap(data[0])))
	}
	return typedFrom[Cargo](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Cargo (all fields
// optional at the wire level).
func (e *CargoEntity) MatchTyped(match ...Cargo) Cargo {
	if len(match) > 0 {
		return typedFrom[Cargo](e.Match(asMap(match[0])))
	}
	return typedFrom[Cargo](e.Match())
}
...
func (e *CargoEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CargoEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// CargoLoadMatch and returns an Cargo. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *CargoEntity) LoadTyped(reqmatch CargoLoadMatch, ctrl map[string]any) (Cargo, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Cargo{}, err
	}
	return typedFrom[Cargo](res), nil
}




func (e *CargoEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// CargoListMatch and returns []Cargo. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *CargoEntity) ListTyped(reqmatch CargoListMatch, ctrl map[string]any) ([]Cargo, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Cargo](res), nil
}




func (e *CargoEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// CargoCreateData and returns an Cargo. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *CargoEntity) CreateTyped(reqdata CargoCreateData, ctrl map[string]any) (Cargo, error) {
...
func (e *CargoEntity) Update(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "update",
		"ctrl":    ctrl,
...
// CargoUpdateData and returns an Cargo. It delegates to the untyped
// Update (identical runtime) and converts at the typed boundary.
func (e *CargoEntity) UpdateTyped(reqdata CargoUpdateData, ctrl map[string]any) (Cargo, error) {
...
func (e *CargoEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *CargoEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
