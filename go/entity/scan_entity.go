...
func NewScanEntity(client *core.CloudsmithSDK, entopts map[string]any) *ScanEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ScanEntity) GetName() string { return e.name }
...
func (e *ScanEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ScanEntity) Deleted() bool {
	return e.deleted
}


func (e *ScanEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewScanEntity(e.client, opts)
}

func (e *ScanEntity) Data(args ...any) any {
...
func (e *ScanEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Scan; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ScanEntity) DataTyped(data ...Scan) Scan {
	if len(data) > 0 {
		return typedFrom[Scan](e.Data(asMap(data[0])))
	}
	return typedFrom[Scan](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Scan (all fields
// optional at the wire level).
func (e *ScanEntity) MatchTyped(match ...Scan) Scan {
	if len(match) > 0 {
		return typedFrom[Scan](e.Match(asMap(match[0])))
	}
	return typedFrom[Scan](e.Match())
}
...
func (e *ScanEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ScanEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *ScanEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *ScanEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ScanEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ScanEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ScanEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
