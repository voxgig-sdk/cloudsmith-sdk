...
type RepositoryTokenSyncEntity struct {
	name    string
...
func NewRepositoryTokenSyncEntity(client *core.CloudsmithSDK, entopts map[string]any) *RepositoryTokenSyncEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *RepositoryTokenSyncEntity) GetName() string { return e.name }
...
func (e *RepositoryTokenSyncEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *RepositoryTokenSyncEntity) Deleted() bool {
	return e.deleted
}


func (e *RepositoryTokenSyncEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewRepositoryTokenSyncEntity(e.client, opts)
}

func (e *RepositoryTokenSyncEntity) Data(args ...any) any {
...
func (e *RepositoryTokenSyncEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an RepositoryTokenSync; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *RepositoryTokenSyncEntity) DataTyped(data ...RepositoryTokenSync) RepositoryTokenSync {
	if len(data) > 0 {
		return typedFrom[RepositoryTokenSync](e.Data(asMap(data[0])))
	}
	return typedFrom[RepositoryTokenSync](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through RepositoryTokenSync (all fields
// optional at the wire level).
func (e *RepositoryTokenSyncEntity) MatchTyped(match ...RepositoryTokenSync) RepositoryTokenSync {
	if len(match) > 0 {
		return typedFrom[RepositoryTokenSync](e.Match(asMap(match[0])))
	}
	return typedFrom[RepositoryTokenSync](e.Match())
}
...
func (e *RepositoryTokenSyncEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *RepositoryTokenSyncEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *RepositoryTokenSyncEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *RepositoryTokenSyncEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// RepositoryTokenSyncCreateData and returns an RepositoryTokenSync. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *RepositoryTokenSyncEntity) CreateTyped(reqdata RepositoryTokenSyncCreateData, ctrl map[string]any) (RepositoryTokenSync, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return RepositoryTokenSync{}, err
	}
	return typedFrom[RepositoryTokenSync](res), nil
}



func (e *RepositoryTokenSyncEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *RepositoryTokenSyncEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *RepositoryTokenSyncEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
