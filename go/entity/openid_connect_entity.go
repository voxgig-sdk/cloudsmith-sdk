...
type OpenidConnectEntity struct {
	name    string
...
func NewOpenidConnectEntity(client *core.CloudsmithSDK, entopts map[string]any) *OpenidConnectEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *OpenidConnectEntity) GetName() string { return e.name }
...
func (e *OpenidConnectEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *OpenidConnectEntity) Deleted() bool {
	return e.deleted
}


func (e *OpenidConnectEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewOpenidConnectEntity(e.client, opts)
}

func (e *OpenidConnectEntity) Data(args ...any) any {
...
func (e *OpenidConnectEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an OpenidConnect; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *OpenidConnectEntity) DataTyped(data ...OpenidConnect) OpenidConnect {
	if len(data) > 0 {
		return typedFrom[OpenidConnect](e.Data(asMap(data[0])))
	}
	return typedFrom[OpenidConnect](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through OpenidConnect (all fields
// optional at the wire level).
func (e *OpenidConnectEntity) MatchTyped(match ...OpenidConnect) OpenidConnect {
	if len(match) > 0 {
		return typedFrom[OpenidConnect](e.Match(asMap(match[0])))
	}
	return typedFrom[OpenidConnect](e.Match())
}
...
func (e *OpenidConnectEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *OpenidConnectEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *OpenidConnectEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *OpenidConnectEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *OpenidConnectEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *OpenidConnectEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *OpenidConnectEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
