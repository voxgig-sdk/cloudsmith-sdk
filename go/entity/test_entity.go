...
func NewTestEntity(client *core.CloudsmithSDK, entopts map[string]any) *TestEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *TestEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *TestEntity) Deleted() bool {
	return e.deleted
}


func (e *TestEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewTestEntity(e.client, opts)
}

func (e *TestEntity) Data(args ...any) any {
...
func (e *TestEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *TestEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *TestEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *TestEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *TestEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *TestEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *TestEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *TestEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
