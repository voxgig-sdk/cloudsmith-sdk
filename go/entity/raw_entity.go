...
func NewRawEntity(client *core.CloudsmithSDK, entopts map[string]any) *RawEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *RawEntity) GetName() string { return e.name }
...
func (e *RawEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *RawEntity) Deleted() bool {
	return e.deleted
}


func (e *RawEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewRawEntity(e.client, opts)
}

func (e *RawEntity) Data(args ...any) any {
...
func (e *RawEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Raw; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *RawEntity) DataTyped(data ...Raw) Raw {
	if len(data) > 0 {
		return typedFrom[Raw](e.Data(asMap(data[0])))
	}
	return typedFrom[Raw](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Raw (all fields
// optional at the wire level).
func (e *RawEntity) MatchTyped(match ...Raw) Raw {
	if len(match) > 0 {
		return typedFrom[Raw](e.Match(asMap(match[0])))
	}
	return typedFrom[Raw](e.Match())
}
...
func (e *RawEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *RawEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *RawEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *RawEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *RawEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *RawEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *RawEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
