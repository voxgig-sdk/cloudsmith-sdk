...
func NewCopyEntity(client *core.CloudsmithSDK, entopts map[string]any) *CopyEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CopyEntity) GetName() string { return e.name }
...
func (e *CopyEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CopyEntity) Deleted() bool {
	return e.deleted
}


func (e *CopyEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCopyEntity(e.client, opts)
}

func (e *CopyEntity) Data(args ...any) any {
...
func (e *CopyEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Copy; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *CopyEntity) DataTyped(data ...Copy) Copy {
	if len(data) > 0 {
		return typedFrom[Copy](e.Data(asMap(data[0])))
	}
	return typedFrom[Copy](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Copy (all fields
// optional at the wire level).
func (e *CopyEntity) MatchTyped(match ...Copy) Copy {
	if len(match) > 0 {
		return typedFrom[Copy](e.Match(asMap(match[0])))
	}
	return typedFrom[Copy](e.Match())
}
...
func (e *CopyEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CopyEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *CopyEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *CopyEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *CopyEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *CopyEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *CopyEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
