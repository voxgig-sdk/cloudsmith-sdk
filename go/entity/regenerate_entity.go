...
func NewRegenerateEntity(client *core.CloudsmithSDK, entopts map[string]any) *RegenerateEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *RegenerateEntity) GetName() string { return e.name }
...
func (e *RegenerateEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *RegenerateEntity) Deleted() bool {
	return e.deleted
}


func (e *RegenerateEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewRegenerateEntity(e.client, opts)
}

func (e *RegenerateEntity) Data(args ...any) any {
...
func (e *RegenerateEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Regenerate; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *RegenerateEntity) DataTyped(data ...Regenerate) Regenerate {
	if len(data) > 0 {
		return typedFrom[Regenerate](e.Data(asMap(data[0])))
	}
	return typedFrom[Regenerate](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Regenerate (all fields
// optional at the wire level).
func (e *RegenerateEntity) MatchTyped(match ...Regenerate) Regenerate {
	if len(match) > 0 {
		return typedFrom[Regenerate](e.Match(asMap(match[0])))
	}
	return typedFrom[Regenerate](e.Match())
}
...
func (e *RegenerateEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *RegenerateEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *RegenerateEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *RegenerateEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *RegenerateEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *RegenerateEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *RegenerateEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
