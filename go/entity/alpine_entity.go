...
func NewAlpineEntity(client *core.CloudsmithSDK, entopts map[string]any) *AlpineEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *AlpineEntity) GetName() string { return e.name }
...
func (e *AlpineEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *AlpineEntity) Deleted() bool {
	return e.deleted
}


func (e *AlpineEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewAlpineEntity(e.client, opts)
}

func (e *AlpineEntity) Data(args ...any) any {
...
func (e *AlpineEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Alpine; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *AlpineEntity) DataTyped(data ...Alpine) Alpine {
	if len(data) > 0 {
		return typedFrom[Alpine](e.Data(asMap(data[0])))
	}
	return typedFrom[Alpine](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Alpine (all fields
// optional at the wire level).
func (e *AlpineEntity) MatchTyped(match ...Alpine) Alpine {
	if len(match) > 0 {
		return typedFrom[Alpine](e.Match(asMap(match[0])))
	}
	return typedFrom[Alpine](e.Match())
}
...
func (e *AlpineEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *AlpineEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *AlpineEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *AlpineEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *AlpineEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *AlpineEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *AlpineEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
