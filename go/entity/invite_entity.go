...
func NewInviteEntity(client *core.CloudsmithSDK, entopts map[string]any) *InviteEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *InviteEntity) GetName() string { return e.name }
...
func (e *InviteEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *InviteEntity) Deleted() bool {
	return e.deleted
}


func (e *InviteEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewInviteEntity(e.client, opts)
}

func (e *InviteEntity) Data(args ...any) any {
...
func (e *InviteEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Invite; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *InviteEntity) DataTyped(data ...Invite) Invite {
	if len(data) > 0 {
		return typedFrom[Invite](e.Data(asMap(data[0])))
	}
	return typedFrom[Invite](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Invite (all fields
// optional at the wire level).
func (e *InviteEntity) MatchTyped(match ...Invite) Invite {
	if len(match) > 0 {
		return typedFrom[Invite](e.Match(asMap(match[0])))
	}
	return typedFrom[Invite](e.Match())
}
...
func (e *InviteEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *InviteEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *InviteEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *InviteEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *InviteEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *InviteEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *InviteEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
