...
func NewTerraformEntity(client *core.CloudsmithSDK, entopts map[string]any) *TerraformEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *TerraformEntity) GetName() string { return e.name }
...
func (e *TerraformEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *TerraformEntity) Deleted() bool {
	return e.deleted
}


func (e *TerraformEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewTerraformEntity(e.client, opts)
}

func (e *TerraformEntity) Data(args ...any) any {
...
func (e *TerraformEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Terraform; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *TerraformEntity) DataTyped(data ...Terraform) Terraform {
	if len(data) > 0 {
		return typedFrom[Terraform](e.Data(asMap(data[0])))
	}
	return typedFrom[Terraform](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Terraform (all fields
// optional at the wire level).
func (e *TerraformEntity) MatchTyped(match ...Terraform) Terraform {
	if len(match) > 0 {
		return typedFrom[Terraform](e.Match(asMap(match[0])))
	}
	return typedFrom[Terraform](e.Match())
}
...
func (e *TerraformEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *TerraformEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *TerraformEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *TerraformEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *TerraformEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *TerraformEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *TerraformEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
