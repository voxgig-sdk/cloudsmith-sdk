...
func NewValidateEntity(client *core.CloudsmithSDK, entopts map[string]any) *ValidateEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ValidateEntity) GetName() string { return e.name }
...
func (e *ValidateEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ValidateEntity) Deleted() bool {
	return e.deleted
}


func (e *ValidateEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewValidateEntity(e.client, opts)
}

func (e *ValidateEntity) Data(args ...any) any {
...
func (e *ValidateEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Validate; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ValidateEntity) DataTyped(data ...Validate) Validate {
	if len(data) > 0 {
		return typedFrom[Validate](e.Data(asMap(data[0])))
	}
	return typedFrom[Validate](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Validate (all fields
// optional at the wire level).
func (e *ValidateEntity) MatchTyped(match ...Validate) Validate {
	if len(match) > 0 {
		return typedFrom[Validate](e.Match(asMap(match[0])))
	}
	return typedFrom[Validate](e.Match())
}
...
func (e *ValidateEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ValidateEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *ValidateEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *ValidateEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ValidateEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ValidateEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ValidateEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
