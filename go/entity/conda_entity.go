...
func NewCondaEntity(client *core.CloudsmithSDK, entopts map[string]any) *CondaEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CondaEntity) GetName() string { return e.name }
...
func (e *CondaEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CondaEntity) Deleted() bool {
	return e.deleted
}


func (e *CondaEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCondaEntity(e.client, opts)
}

func (e *CondaEntity) Data(args ...any) any {
...
func (e *CondaEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Conda; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *CondaEntity) DataTyped(data ...Conda) Conda {
	if len(data) > 0 {
		return typedFrom[Conda](e.Data(asMap(data[0])))
	}
	return typedFrom[Conda](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Conda (all fields
// optional at the wire level).
func (e *CondaEntity) MatchTyped(match ...Conda) Conda {
	if len(match) > 0 {
		return typedFrom[Conda](e.Match(asMap(match[0])))
	}
	return typedFrom[Conda](e.Match())
}
...
func (e *CondaEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CondaEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// CondaLoadMatch and returns an Conda. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *CondaEntity) LoadTyped(reqmatch CondaLoadMatch, ctrl map[string]any) (Conda, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Conda{}, err
	}
	return typedFrom[Conda](res), nil
}




func (e *CondaEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// CondaListMatch and returns []Conda. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *CondaEntity) ListTyped(reqmatch CondaListMatch, ctrl map[string]any) ([]Conda, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Conda](res), nil
}




func (e *CondaEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// CondaCreateData and returns an Conda. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *CondaEntity) CreateTyped(reqdata CondaCreateData, ctrl map[string]any) (Conda, error) {
...
func (e *CondaEntity) Update(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "update",
		"ctrl":    ctrl,
...
// CondaUpdateData and returns an Conda. It delegates to the untyped
// Update (identical runtime) and converts at the typed boundary.
func (e *CondaEntity) UpdateTyped(reqdata CondaUpdateData, ctrl map[string]any) (Conda, error) {
...
func (e *CondaEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *CondaEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
