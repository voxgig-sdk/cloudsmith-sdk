...
func NewFormatEntity(client *core.CloudsmithSDK, entopts map[string]any) *FormatEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *FormatEntity) GetName() string { return e.name }
...
func (e *FormatEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *FormatEntity) Deleted() bool {
	return e.deleted
}


func (e *FormatEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewFormatEntity(e.client, opts)
}

func (e *FormatEntity) Data(args ...any) any {
...
func (e *FormatEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Format; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *FormatEntity) DataTyped(data ...Format) Format {
	if len(data) > 0 {
		return typedFrom[Format](e.Data(asMap(data[0])))
	}
	return typedFrom[Format](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Format (all fields
// optional at the wire level).
func (e *FormatEntity) MatchTyped(match ...Format) Format {
	if len(match) > 0 {
		return typedFrom[Format](e.Match(asMap(match[0])))
	}
	return typedFrom[Format](e.Match())
}
...
func (e *FormatEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *FormatEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// FormatLoadMatch and returns an Format. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *FormatEntity) LoadTyped(reqmatch FormatLoadMatch, ctrl map[string]any) (Format, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Format{}, err
	}
	return typedFrom[Format](res), nil
}




func (e *FormatEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// FormatListMatch and returns []Format. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *FormatEntity) ListTyped(reqmatch FormatListMatch, ctrl map[string]any) ([]Format, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Format](res), nil
}



func (e *FormatEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *FormatEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *FormatEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *FormatEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
