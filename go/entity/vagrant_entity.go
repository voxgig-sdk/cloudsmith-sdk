...
func NewVagrantEntity(client *core.CloudsmithSDK, entopts map[string]any) *VagrantEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *VagrantEntity) GetName() string { return e.name }
...
func (e *VagrantEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *VagrantEntity) Deleted() bool {
	return e.deleted
}


func (e *VagrantEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewVagrantEntity(e.client, opts)
}

func (e *VagrantEntity) Data(args ...any) any {
...
func (e *VagrantEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Vagrant; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *VagrantEntity) DataTyped(data ...Vagrant) Vagrant {
	if len(data) > 0 {
		return typedFrom[Vagrant](e.Data(asMap(data[0])))
	}
	return typedFrom[Vagrant](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Vagrant (all fields
// optional at the wire level).
func (e *VagrantEntity) MatchTyped(match ...Vagrant) Vagrant {
	if len(match) > 0 {
		return typedFrom[Vagrant](e.Match(asMap(match[0])))
	}
	return typedFrom[Vagrant](e.Match())
}
...
func (e *VagrantEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *VagrantEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *VagrantEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *VagrantEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *VagrantEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *VagrantEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *VagrantEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
