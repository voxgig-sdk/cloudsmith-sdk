...
func NewResyncEntity(client *core.CloudsmithSDK, entopts map[string]any) *ResyncEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ResyncEntity) GetName() string { return e.name }
...
func (e *ResyncEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ResyncEntity) Deleted() bool {
	return e.deleted
}


func (e *ResyncEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewResyncEntity(e.client, opts)
}

func (e *ResyncEntity) Data(args ...any) any {
...
func (e *ResyncEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Resync; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ResyncEntity) DataTyped(data ...Resync) Resync {
	if len(data) > 0 {
		return typedFrom[Resync](e.Data(asMap(data[0])))
	}
	return typedFrom[Resync](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Resync (all fields
// optional at the wire level).
func (e *ResyncEntity) MatchTyped(match ...Resync) Resync {
	if len(match) > 0 {
		return typedFrom[Resync](e.Match(asMap(match[0])))
	}
	return typedFrom[Resync](e.Match())
}
...
func (e *ResyncEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ResyncEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *ResyncEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *ResyncEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ResyncEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ResyncEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ResyncEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
