...
func (e *RepositoryX509EcdsaCertificateEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *RepositoryX509EcdsaCertificateEntity) Deleted() bool {
	return e.deleted
}
...
func (e *RepositoryX509EcdsaCertificateEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
