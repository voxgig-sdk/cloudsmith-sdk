...
func NewQuarantineEntity(client *core.CloudsmithSDK, entopts map[string]any) *QuarantineEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *QuarantineEntity) GetName() string { return e.name }
...
func (e *QuarantineEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *QuarantineEntity) Deleted() bool {
	return e.deleted
}


func (e *QuarantineEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewQuarantineEntity(e.client, opts)
}

func (e *QuarantineEntity) Data(args ...any) any {
...
func (e *QuarantineEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Quarantine; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *QuarantineEntity) DataTyped(data ...Quarantine) Quarantine {
	if len(data) > 0 {
		return typedFrom[Quarantine](e.Data(asMap(data[0])))
	}
	return typedFrom[Quarantine](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Quarantine (all fields
// optional at the wire level).
func (e *QuarantineEntity) MatchTyped(match ...Quarantine) Quarantine {
	if len(match) > 0 {
		return typedFrom[Quarantine](e.Match(asMap(match[0])))
	}
	return typedFrom[Quarantine](e.Match())
}
...
func (e *QuarantineEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *QuarantineEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *QuarantineEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *QuarantineEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *QuarantineEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *QuarantineEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *QuarantineEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
