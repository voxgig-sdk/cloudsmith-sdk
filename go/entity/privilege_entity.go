...
func NewPrivilegeEntity(client *core.CloudsmithSDK, entopts map[string]any) *PrivilegeEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *PrivilegeEntity) GetName() string { return e.name }
...
func (e *PrivilegeEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *PrivilegeEntity) Deleted() bool {
	return e.deleted
}


func (e *PrivilegeEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewPrivilegeEntity(e.client, opts)
}

func (e *PrivilegeEntity) Data(args ...any) any {
...
func (e *PrivilegeEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Privilege; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *PrivilegeEntity) DataTyped(data ...Privilege) Privilege {
	if len(data) > 0 {
		return typedFrom[Privilege](e.Data(asMap(data[0])))
	}
	return typedFrom[Privilege](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Privilege (all fields
// optional at the wire level).
func (e *PrivilegeEntity) MatchTyped(match ...Privilege) Privilege {
	if len(match) > 0 {
		return typedFrom[Privilege](e.Match(asMap(match[0])))
	}
	return typedFrom[Privilege](e.Match())
}
...
func (e *PrivilegeEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *PrivilegeEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *PrivilegeEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *PrivilegeEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *PrivilegeEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *PrivilegeEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *PrivilegeEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
