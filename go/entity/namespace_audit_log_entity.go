...
type NamespaceAuditLogEntity struct {
	name    string
...
func NewNamespaceAuditLogEntity(client *core.CloudsmithSDK, entopts map[string]any) *NamespaceAuditLogEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *NamespaceAuditLogEntity) GetName() string { return e.name }
...
func (e *NamespaceAuditLogEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *NamespaceAuditLogEntity) Deleted() bool {
	return e.deleted
}


func (e *NamespaceAuditLogEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewNamespaceAuditLogEntity(e.client, opts)
}

func (e *NamespaceAuditLogEntity) Data(args ...any) any {
...
func (e *NamespaceAuditLogEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an NamespaceAuditLog; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *NamespaceAuditLogEntity) DataTyped(data ...NamespaceAuditLog) NamespaceAuditLog {
	if len(data) > 0 {
		return typedFrom[NamespaceAuditLog](e.Data(asMap(data[0])))
	}
	return typedFrom[NamespaceAuditLog](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through NamespaceAuditLog (all fields
// optional at the wire level).
func (e *NamespaceAuditLogEntity) MatchTyped(match ...NamespaceAuditLog) NamespaceAuditLog {
	if len(match) > 0 {
		return typedFrom[NamespaceAuditLog](e.Match(asMap(match[0])))
	}
	return typedFrom[NamespaceAuditLog](e.Match())
}
...
func (e *NamespaceAuditLogEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *NamespaceAuditLogEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// NamespaceAuditLogLoadMatch and returns an NamespaceAuditLog. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *NamespaceAuditLogEntity) LoadTyped(reqmatch NamespaceAuditLogLoadMatch, ctrl map[string]any) (NamespaceAuditLog, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return NamespaceAuditLog{}, err
	}
	return typedFrom[NamespaceAuditLog](res), nil
}



func (e *NamespaceAuditLogEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *NamespaceAuditLogEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *NamespaceAuditLogEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *NamespaceAuditLogEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *NamespaceAuditLogEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
