...
func NewX509RsaEntity(client *core.CloudsmithSDK, entopts map[string]any) *X509RsaEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *X509RsaEntity) GetName() string { return e.name }
...
func (e *X509RsaEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *X509RsaEntity) Deleted() bool {
	return e.deleted
}


func (e *X509RsaEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewX509RsaEntity(e.client, opts)
}

func (e *X509RsaEntity) Data(args ...any) any {
...
func (e *X509RsaEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an X509Rsa; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *X509RsaEntity) DataTyped(data ...X509Rsa) X509Rsa {
	if len(data) > 0 {
		return typedFrom[X509Rsa](e.Data(asMap(data[0])))
	}
	return typedFrom[X509Rsa](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through X509Rsa (all fields
// optional at the wire level).
func (e *X509RsaEntity) MatchTyped(match ...X509Rsa) X509Rsa {
	if len(match) > 0 {
		return typedFrom[X509Rsa](e.Match(asMap(match[0])))
	}
	return typedFrom[X509Rsa](e.Match())
}
...
func (e *X509RsaEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *X509RsaEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *X509RsaEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *X509RsaEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *X509RsaEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *X509RsaEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *X509RsaEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
