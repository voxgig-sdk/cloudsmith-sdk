...
func NewUserBriefEntity(client *core.CloudsmithSDK, entopts map[string]any) *UserBriefEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *UserBriefEntity) GetName() string { return e.name }
...
func (e *UserBriefEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *UserBriefEntity) Deleted() bool {
	return e.deleted
}


func (e *UserBriefEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewUserBriefEntity(e.client, opts)
}

func (e *UserBriefEntity) Data(args ...any) any {
...
func (e *UserBriefEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an UserBrief; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *UserBriefEntity) DataTyped(data ...UserBrief) UserBrief {
	if len(data) > 0 {
		return typedFrom[UserBrief](e.Data(asMap(data[0])))
	}
	return typedFrom[UserBrief](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through UserBrief (all fields
// optional at the wire level).
func (e *UserBriefEntity) MatchTyped(match ...UserBrief) UserBrief {
	if len(match) > 0 {
		return typedFrom[UserBrief](e.Match(asMap(match[0])))
	}
	return typedFrom[UserBrief](e.Match())
}
...
func (e *UserBriefEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *UserBriefEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// UserBriefLoadMatch and returns an UserBrief. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *UserBriefEntity) LoadTyped(reqmatch UserBriefLoadMatch, ctrl map[string]any) (UserBrief, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return UserBrief{}, err
	}
	return typedFrom[UserBrief](res), nil
}



func (e *UserBriefEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *UserBriefEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *UserBriefEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *UserBriefEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *UserBriefEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
