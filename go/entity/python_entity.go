...
func NewPythonEntity(client *core.CloudsmithSDK, entopts map[string]any) *PythonEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *PythonEntity) GetName() string { return e.name }
...
func (e *PythonEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *PythonEntity) Deleted() bool {
	return e.deleted
}


func (e *PythonEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewPythonEntity(e.client, opts)
}

func (e *PythonEntity) Data(args ...any) any {
...
func (e *PythonEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Python; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *PythonEntity) DataTyped(data ...Python) Python {
	if len(data) > 0 {
		return typedFrom[Python](e.Data(asMap(data[0])))
	}
	return typedFrom[Python](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Python (all fields
// optional at the wire level).
func (e *PythonEntity) MatchTyped(match ...Python) Python {
	if len(match) > 0 {
		return typedFrom[Python](e.Match(asMap(match[0])))
	}
	return typedFrom[Python](e.Match())
}
...
func (e *PythonEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *PythonEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// PythonLoadMatch and returns an Python. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *PythonEntity) LoadTyped(reqmatch PythonLoadMatch, ctrl map[string]any) (Python, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Python{}, err
	}
	return typedFrom[Python](res), nil
}




func (e *PythonEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// PythonListMatch and returns []Python. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *PythonEntity) ListTyped(reqmatch PythonListMatch, ctrl map[string]any) ([]Python, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Python](res), nil
}




func (e *PythonEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// PythonCreateData and returns an Python. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *PythonEntity) CreateTyped(reqdata PythonCreateData, ctrl map[string]any) (Python, error) {
...
func (e *PythonEntity) Update(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "update",
		"ctrl":    ctrl,
...
// PythonUpdateData and returns an Python. It delegates to the untyped
// Update (identical runtime) and converts at the typed boundary.
func (e *PythonEntity) UpdateTyped(reqdata PythonUpdateData, ctrl map[string]any) (Python, error) {
...
func (e *PythonEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *PythonEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
