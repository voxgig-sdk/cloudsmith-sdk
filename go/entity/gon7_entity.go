...
func NewGon7Entity(client *core.CloudsmithSDK, entopts map[string]any) *Gon7Entity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *Gon7Entity) GetName() string { return e.name }

func (e *Gon7Entity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewGon7Entity(e.client, opts)
}

func (e *Gon7Entity) Data(args ...any) any {
...
func (e *Gon7Entity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Gon7; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *Gon7Entity) DataTyped(data ...Gon7) Gon7 {
	if len(data) > 0 {
		return typedFrom[Gon7](e.Data(asMap(data[0])))
	}
	return typedFrom[Gon7](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Gon7 (all fields
// optional at the wire level).
func (e *Gon7Entity) MatchTyped(match ...Gon7) Gon7 {
	if len(match) > 0 {
		return typedFrom[Gon7](e.Match(asMap(match[0])))
	}
	return typedFrom[Gon7](e.Match())
}
...
func (e *Gon7Entity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *Gon7Entity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *Gon7Entity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *Gon7Entity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *Gon7Entity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *Gon7Entity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *Gon7Entity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
