...
func NewDebEntity(client *core.CloudsmithSDK, entopts map[string]any) *DebEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *DebEntity) GetName() string { return e.name }
...
func (e *DebEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *DebEntity) Deleted() bool {
	return e.deleted
}


func (e *DebEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewDebEntity(e.client, opts)
}

func (e *DebEntity) Data(args ...any) any {
...
func (e *DebEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Deb; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *DebEntity) DataTyped(data ...Deb) Deb {
	if len(data) > 0 {
		return typedFrom[Deb](e.Data(asMap(data[0])))
	}
	return typedFrom[Deb](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Deb (all fields
// optional at the wire level).
func (e *DebEntity) MatchTyped(match ...Deb) Deb {
	if len(match) > 0 {
		return typedFrom[Deb](e.Match(asMap(match[0])))
	}
	return typedFrom[Deb](e.Match())
}
...
func (e *DebEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *DebEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// DebLoadMatch and returns an Deb. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *DebEntity) LoadTyped(reqmatch DebLoadMatch, ctrl map[string]any) (Deb, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Deb{}, err
	}
	return typedFrom[Deb](res), nil
}




func (e *DebEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// DebListMatch and returns []Deb. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *DebEntity) ListTyped(reqmatch DebListMatch, ctrl map[string]any) ([]Deb, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Deb](res), nil
}




func (e *DebEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// DebCreateData and returns an Deb. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *DebEntity) CreateTyped(reqdata DebCreateData, ctrl map[string]any) (Deb, error) {
...
func (e *DebEntity) Update(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "update",
		"ctrl":    ctrl,
...
// DebUpdateData and returns an Deb. It delegates to the untyped
// Update (identical runtime) and converts at the typed boundary.
func (e *DebEntity) UpdateTyped(reqdata DebUpdateData, ctrl map[string]any) (Deb, error) {
...
func (e *DebEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *DebEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
