...
type SamlGroupSyncEntity struct {
	name    string
...
func NewSamlGroupSyncEntity(client *core.CloudsmithSDK, entopts map[string]any) *SamlGroupSyncEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *SamlGroupSyncEntity) GetName() string { return e.name }
...
func (e *SamlGroupSyncEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *SamlGroupSyncEntity) Deleted() bool {
	return e.deleted
}


func (e *SamlGroupSyncEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewSamlGroupSyncEntity(e.client, opts)
}

func (e *SamlGroupSyncEntity) Data(args ...any) any {
...
func (e *SamlGroupSyncEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an SamlGroupSync; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *SamlGroupSyncEntity) DataTyped(data ...SamlGroupSync) SamlGroupSync {
	if len(data) > 0 {
		return typedFrom[SamlGroupSync](e.Data(asMap(data[0])))
	}
	return typedFrom[SamlGroupSync](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through SamlGroupSync (all fields
// optional at the wire level).
func (e *SamlGroupSyncEntity) MatchTyped(match ...SamlGroupSync) SamlGroupSync {
	if len(match) > 0 {
		return typedFrom[SamlGroupSync](e.Match(asMap(match[0])))
	}
	return typedFrom[SamlGroupSync](e.Match())
}
...
func (e *SamlGroupSyncEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *SamlGroupSyncEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *SamlGroupSyncEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *SamlGroupSyncEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *SamlGroupSyncEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *SamlGroupSyncEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *SamlGroupSyncEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
