...
func NewEcdsaEntity(client *core.CloudsmithSDK, entopts map[string]any) *EcdsaEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *EcdsaEntity) GetName() string { return e.name }
...
func (e *EcdsaEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *EcdsaEntity) Deleted() bool {
	return e.deleted
}


func (e *EcdsaEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewEcdsaEntity(e.client, opts)
}

func (e *EcdsaEntity) Data(args ...any) any {
...
func (e *EcdsaEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Ecdsa; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *EcdsaEntity) DataTyped(data ...Ecdsa) Ecdsa {
	if len(data) > 0 {
		return typedFrom[Ecdsa](e.Data(asMap(data[0])))
	}
	return typedFrom[Ecdsa](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Ecdsa (all fields
// optional at the wire level).
func (e *EcdsaEntity) MatchTyped(match ...Ecdsa) Ecdsa {
	if len(match) > 0 {
		return typedFrom[Ecdsa](e.Match(asMap(match[0])))
	}
	return typedFrom[Ecdsa](e.Match())
}
...
func (e *EcdsaEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *EcdsaEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *EcdsaEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *EcdsaEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *EcdsaEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *EcdsaEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *EcdsaEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
