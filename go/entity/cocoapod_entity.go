...
func NewCocoapodEntity(client *core.CloudsmithSDK, entopts map[string]any) *CocoapodEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CocoapodEntity) GetName() string { return e.name }
...
func (e *CocoapodEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CocoapodEntity) Deleted() bool {
	return e.deleted
}


func (e *CocoapodEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCocoapodEntity(e.client, opts)
}

func (e *CocoapodEntity) Data(args ...any) any {
...
func (e *CocoapodEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Cocoapod; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *CocoapodEntity) DataTyped(data ...Cocoapod) Cocoapod {
	if len(data) > 0 {
		return typedFrom[Cocoapod](e.Data(asMap(data[0])))
	}
	return typedFrom[Cocoapod](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Cocoapod (all fields
// optional at the wire level).
func (e *CocoapodEntity) MatchTyped(match ...Cocoapod) Cocoapod {
	if len(match) > 0 {
		return typedFrom[Cocoapod](e.Match(asMap(match[0])))
	}
	return typedFrom[Cocoapod](e.Match())
}
...
func (e *CocoapodEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CocoapodEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *CocoapodEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *CocoapodEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *CocoapodEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *CocoapodEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *CocoapodEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
