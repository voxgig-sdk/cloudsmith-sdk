...
func NewOrgEntity(client *core.CloudsmithSDK, entopts map[string]any) *OrgEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *OrgEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *OrgEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// OrgListMatch and returns []Org. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *OrgEntity) ListTyped(reqmatch OrgListMatch, ctrl map[string]any) ([]Org, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Org](res), nil
}




func (e *OrgEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// OrgCreateData and returns an Org. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *OrgEntity) CreateTyped(reqdata OrgCreateData, ctrl map[string]any) (Org, error) {
...
func (e *OrgEntity) Update(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "update",
		"ctrl":    ctrl,
...
// OrgUpdateData and returns an Org. It delegates to the untyped
// Update (identical runtime) and converts at the typed boundary.
func (e *OrgEntity) UpdateTyped(reqdata OrgUpdateData, ctrl map[string]any) (Org, error) {
...
func (e *OrgEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "remove",
		"ctrl":     ctrl,
...
// OrgRemoveMatch and returns an Org. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *OrgEntity) RemoveTyped(reqmatch OrgRemoveMatch, ctrl map[string]any) (Org, error) {
