...
func NewResetEntity(client *core.CloudsmithSDK, entopts map[string]any) *ResetEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ResetEntity) GetName() string { return e.name }
...
func (e *ResetEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ResetEntity) Deleted() bool {
	return e.deleted
}


func (e *ResetEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewResetEntity(e.client, opts)
}

func (e *ResetEntity) Data(args ...any) any {
...
func (e *ResetEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Reset; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ResetEntity) DataTyped(data ...Reset) Reset {
	if len(data) > 0 {
		return typedFrom[Reset](e.Data(asMap(data[0])))
	}
	return typedFrom[Reset](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Reset (all fields
// optional at the wire level).
func (e *ResetEntity) MatchTyped(match ...Reset) Reset {
	if len(match) > 0 {
		return typedFrom[Reset](e.Match(asMap(match[0])))
	}
	return typedFrom[Reset](e.Match())
}
...
func (e *ResetEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ResetEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *ResetEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *ResetEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ResetEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ResetEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ResetEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
