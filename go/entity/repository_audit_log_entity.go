...
type RepositoryAuditLogEntity struct {
	name    string
...
func NewRepositoryAuditLogEntity(client *core.CloudsmithSDK, entopts map[string]any) *RepositoryAuditLogEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *RepositoryAuditLogEntity) GetName() string { return e.name }
...
func (e *RepositoryAuditLogEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *RepositoryAuditLogEntity) Deleted() bool {
	return e.deleted
}


func (e *RepositoryAuditLogEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewRepositoryAuditLogEntity(e.client, opts)
}

func (e *RepositoryAuditLogEntity) Data(args ...any) any {
...
func (e *RepositoryAuditLogEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an RepositoryAuditLog; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *RepositoryAuditLogEntity) DataTyped(data ...RepositoryAuditLog) RepositoryAuditLog {
	if len(data) > 0 {
		return typedFrom[RepositoryAuditLog](e.Data(asMap(data[0])))
	}
	return typedFrom[RepositoryAuditLog](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through RepositoryAuditLog (all fields
// optional at the wire level).
func (e *RepositoryAuditLogEntity) MatchTyped(match ...RepositoryAuditLog) RepositoryAuditLog {
	if len(match) > 0 {
		return typedFrom[RepositoryAuditLog](e.Match(asMap(match[0])))
	}
	return typedFrom[RepositoryAuditLog](e.Match())
}
...
func (e *RepositoryAuditLogEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *RepositoryAuditLogEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *RepositoryAuditLogEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// RepositoryAuditLogListMatch and returns []RepositoryAuditLog. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *RepositoryAuditLogEntity) ListTyped(reqmatch RepositoryAuditLogListMatch, ctrl map[string]any) ([]RepositoryAuditLog, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[RepositoryAuditLog](res), nil
}



func (e *RepositoryAuditLogEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *RepositoryAuditLogEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *RepositoryAuditLogEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *RepositoryAuditLogEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
