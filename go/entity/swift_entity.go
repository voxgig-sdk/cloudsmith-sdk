...
func NewSwiftEntity(client *core.CloudsmithSDK, entopts map[string]any) *SwiftEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *SwiftEntity) GetName() string { return e.name }
...
func (e *SwiftEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *SwiftEntity) Deleted() bool {
	return e.deleted
}


func (e *SwiftEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewSwiftEntity(e.client, opts)
}

func (e *SwiftEntity) Data(args ...any) any {
...
func (e *SwiftEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Swift; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *SwiftEntity) DataTyped(data ...Swift) Swift {
	if len(data) > 0 {
		return typedFrom[Swift](e.Data(asMap(data[0])))
	}
	return typedFrom[Swift](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Swift (all fields
// optional at the wire level).
func (e *SwiftEntity) MatchTyped(match ...Swift) Swift {
	if len(match) > 0 {
		return typedFrom[Swift](e.Match(asMap(match[0])))
	}
	return typedFrom[Swift](e.Match())
}
...
func (e *SwiftEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *SwiftEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// SwiftLoadMatch and returns an Swift. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *SwiftEntity) LoadTyped(reqmatch SwiftLoadMatch, ctrl map[string]any) (Swift, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Swift{}, err
	}
	return typedFrom[Swift](res), nil
}




func (e *SwiftEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// SwiftListMatch and returns []Swift. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *SwiftEntity) ListTyped(reqmatch SwiftListMatch, ctrl map[string]any) ([]Swift, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Swift](res), nil
}




func (e *SwiftEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// SwiftCreateData and returns an Swift. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *SwiftEntity) CreateTyped(reqdata SwiftCreateData, ctrl map[string]any) (Swift, error) {
...
func (e *SwiftEntity) Update(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "update",
		"ctrl":    ctrl,
...
// SwiftUpdateData and returns an Swift. It delegates to the untyped
// Update (identical runtime) and converts at the typed boundary.
func (e *SwiftEntity) UpdateTyped(reqdata SwiftUpdateData, ctrl map[string]any) (Swift, error) {
...
func (e *SwiftEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *SwiftEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
