...
func NewX509EcdsaEntity(client *core.CloudsmithSDK, entopts map[string]any) *X509EcdsaEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *X509EcdsaEntity) GetName() string { return e.name }
...
func (e *X509EcdsaEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *X509EcdsaEntity) Deleted() bool {
	return e.deleted
}


func (e *X509EcdsaEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewX509EcdsaEntity(e.client, opts)
}

func (e *X509EcdsaEntity) Data(args ...any) any {
...
func (e *X509EcdsaEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an X509Ecdsa; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *X509EcdsaEntity) DataTyped(data ...X509Ecdsa) X509Ecdsa {
	if len(data) > 0 {
		return typedFrom[X509Ecdsa](e.Data(asMap(data[0])))
	}
	return typedFrom[X509Ecdsa](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through X509Ecdsa (all fields
// optional at the wire level).
func (e *X509EcdsaEntity) MatchTyped(match ...X509Ecdsa) X509Ecdsa {
	if len(match) > 0 {
		return typedFrom[X509Ecdsa](e.Match(asMap(match[0])))
	}
	return typedFrom[X509Ecdsa](e.Match())
}
...
func (e *X509EcdsaEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *X509EcdsaEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *X509EcdsaEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *X509EcdsaEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *X509EcdsaEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *X509EcdsaEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *X509EcdsaEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
