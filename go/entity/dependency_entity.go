...
func NewDependencyEntity(client *core.CloudsmithSDK, entopts map[string]any) *DependencyEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *DependencyEntity) GetName() string { return e.name }
...
func (e *DependencyEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *DependencyEntity) Deleted() bool {
	return e.deleted
}


func (e *DependencyEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewDependencyEntity(e.client, opts)
}

func (e *DependencyEntity) Data(args ...any) any {
...
func (e *DependencyEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Dependency; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *DependencyEntity) DataTyped(data ...Dependency) Dependency {
	if len(data) > 0 {
		return typedFrom[Dependency](e.Data(asMap(data[0])))
	}
	return typedFrom[Dependency](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Dependency (all fields
// optional at the wire level).
func (e *DependencyEntity) MatchTyped(match ...Dependency) Dependency {
	if len(match) > 0 {
		return typedFrom[Dependency](e.Match(asMap(match[0])))
	}
	return typedFrom[Dependency](e.Match())
}
...
func (e *DependencyEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *DependencyEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *DependencyEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *DependencyEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *DependencyEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *DependencyEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *DependencyEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
