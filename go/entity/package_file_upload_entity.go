...
type PackageFileUploadEntity struct {
	name    string
...
func NewPackageFileUploadEntity(client *core.CloudsmithSDK, entopts map[string]any) *PackageFileUploadEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *PackageFileUploadEntity) GetName() string { return e.name }
...
func (e *PackageFileUploadEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *PackageFileUploadEntity) Deleted() bool {
	return e.deleted
}


func (e *PackageFileUploadEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewPackageFileUploadEntity(e.client, opts)
}

func (e *PackageFileUploadEntity) Data(args ...any) any {
...
func (e *PackageFileUploadEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an PackageFileUpload; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *PackageFileUploadEntity) DataTyped(data ...PackageFileUpload) PackageFileUpload {
	if len(data) > 0 {
		return typedFrom[PackageFileUpload](e.Data(asMap(data[0])))
	}
	return typedFrom[PackageFileUpload](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through PackageFileUpload (all fields
// optional at the wire level).
func (e *PackageFileUploadEntity) MatchTyped(match ...PackageFileUpload) PackageFileUpload {
	if len(match) > 0 {
		return typedFrom[PackageFileUpload](e.Match(asMap(match[0])))
	}
	return typedFrom[PackageFileUpload](e.Match())
}
...
func (e *PackageFileUploadEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *PackageFileUploadEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *PackageFileUploadEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *PackageFileUploadEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// PackageFileUploadCreateData and returns an PackageFileUpload. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *PackageFileUploadEntity) CreateTyped(reqdata PackageFileUploadCreateData, ctrl map[string]any) (PackageFileUpload, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return PackageFileUpload{}, err
	}
	return typedFrom[PackageFileUpload](res), nil
}



func (e *PackageFileUploadEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *PackageFileUploadEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *PackageFileUploadEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
