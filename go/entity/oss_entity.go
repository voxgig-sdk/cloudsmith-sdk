...
func NewOssEntity(client *core.CloudsmithSDK, entopts map[string]any) *OssEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *OssEntity) GetName() string { return e.name }
...
func (e *OssEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *OssEntity) Deleted() bool {
	return e.deleted
}


func (e *OssEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewOssEntity(e.client, opts)
}

func (e *OssEntity) Data(args ...any) any {
...
func (e *OssEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Oss; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *OssEntity) DataTyped(data ...Oss) Oss {
	if len(data) > 0 {
		return typedFrom[Oss](e.Data(asMap(data[0])))
	}
	return typedFrom[Oss](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Oss (all fields
// optional at the wire level).
func (e *OssEntity) MatchTyped(match ...Oss) Oss {
	if len(match) > 0 {
		return typedFrom[Oss](e.Match(asMap(match[0])))
	}
	return typedFrom[Oss](e.Match())
}
...
func (e *OssEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *OssEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *OssEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *OssEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *OssEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *OssEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *OssEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
