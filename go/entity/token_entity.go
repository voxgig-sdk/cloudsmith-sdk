...
func NewTokenEntity(client *core.CloudsmithSDK, entopts map[string]any) *TokenEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *TokenEntity) GetName() string { return e.name }
...
func (e *TokenEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *TokenEntity) Deleted() bool {
	return e.deleted
}


func (e *TokenEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewTokenEntity(e.client, opts)
}

func (e *TokenEntity) Data(args ...any) any {
...
func (e *TokenEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Token; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *TokenEntity) DataTyped(data ...Token) Token {
	if len(data) > 0 {
		return typedFrom[Token](e.Data(asMap(data[0])))
	}
	return typedFrom[Token](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Token (all fields
// optional at the wire level).
func (e *TokenEntity) MatchTyped(match ...Token) Token {
	if len(match) > 0 {
		return typedFrom[Token](e.Match(asMap(match[0])))
	}
	return typedFrom[Token](e.Match())
}
...
func (e *TokenEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *TokenEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *TokenEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *TokenEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *TokenEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *TokenEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *TokenEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
