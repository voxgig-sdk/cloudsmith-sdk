...
func NewEntitlementEntity(client *core.CloudsmithSDK, entopts map[string]any) *EntitlementEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *EntitlementEntity) GetName() string { return e.name }
...
func (e *EntitlementEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *EntitlementEntity) Deleted() bool {
	return e.deleted
}


func (e *EntitlementEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewEntitlementEntity(e.client, opts)
}

func (e *EntitlementEntity) Data(args ...any) any {
...
func (e *EntitlementEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Entitlement; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *EntitlementEntity) DataTyped(data ...Entitlement) Entitlement {
	if len(data) > 0 {
		return typedFrom[Entitlement](e.Data(asMap(data[0])))
	}
	return typedFrom[Entitlement](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Entitlement (all fields
// optional at the wire level).
func (e *EntitlementEntity) MatchTyped(match ...Entitlement) Entitlement {
	if len(match) > 0 {
		return typedFrom[Entitlement](e.Match(asMap(match[0])))
	}
	return typedFrom[Entitlement](e.Match())
}
...
func (e *EntitlementEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *EntitlementEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// EntitlementLoadMatch and returns an Entitlement. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *EntitlementEntity) LoadTyped(reqmatch EntitlementLoadMatch, ctrl map[string]any) (Entitlement, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Entitlement{}, err
	}
	return typedFrom[Entitlement](res), nil
}



func (e *EntitlementEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *EntitlementEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// EntitlementCreateData and returns an Entitlement. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *EntitlementEntity) CreateTyped(reqdata EntitlementCreateData, ctrl map[string]any) (Entitlement, error) {
...
func (e *EntitlementEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}



func (e *EntitlementEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "remove",
		"ctrl":     ctrl,
...
// EntitlementRemoveMatch and returns an Entitlement. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *EntitlementEntity) RemoveTyped(reqmatch EntitlementRemoveMatch, ctrl map[string]any) (Entitlement, error) {
...
func (e *EntitlementEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
