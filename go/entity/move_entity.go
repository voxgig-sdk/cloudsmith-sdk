...
func NewMoveEntity(client *core.CloudsmithSDK, entopts map[string]any) *MoveEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *MoveEntity) GetName() string { return e.name }
...
func (e *MoveEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *MoveEntity) Deleted() bool {
	return e.deleted
}


func (e *MoveEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewMoveEntity(e.client, opts)
}

func (e *MoveEntity) Data(args ...any) any {
...
func (e *MoveEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Move; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *MoveEntity) DataTyped(data ...Move) Move {
	if len(data) > 0 {
		return typedFrom[Move](e.Data(asMap(data[0])))
	}
	return typedFrom[Move](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Move (all fields
// optional at the wire level).
func (e *MoveEntity) MatchTyped(match ...Move) Move {
	if len(match) > 0 {
		return typedFrom[Move](e.Match(asMap(match[0])))
	}
	return typedFrom[Move](e.Match())
}
...
func (e *MoveEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *MoveEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *MoveEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *MoveEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *MoveEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *MoveEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *MoveEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
