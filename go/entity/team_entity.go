...
func NewTeamEntity(client *core.CloudsmithSDK, entopts map[string]any) *TeamEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *TeamEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *TeamEntity) List(_ map[string]any, _ map[string]any) (any, error) {
