...
func (e *UserAuthenticationTokenEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *UserAuthenticationTokenEntity) Deleted() bool {
	return e.deleted
}
...
func (e *UserAuthenticationTokenEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
