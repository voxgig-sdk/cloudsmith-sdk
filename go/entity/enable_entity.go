...
func NewEnableEntity(client *core.CloudsmithSDK, entopts map[string]any) *EnableEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *EnableEntity) GetName() string { return e.name }
...
func (e *EnableEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *EnableEntity) Deleted() bool {
	return e.deleted
}


func (e *EnableEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewEnableEntity(e.client, opts)
}

func (e *EnableEntity) Data(args ...any) any {
...
func (e *EnableEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Enable; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *EnableEntity) DataTyped(data ...Enable) Enable {
	if len(data) > 0 {
		return typedFrom[Enable](e.Data(asMap(data[0])))
	}
	return typedFrom[Enable](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Enable (all fields
// optional at the wire level).
func (e *EnableEntity) MatchTyped(match ...Enable) Enable {
	if len(match) > 0 {
		return typedFrom[Enable](e.Match(asMap(match[0])))
	}
	return typedFrom[Enable](e.Match())
}
...
func (e *EnableEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *EnableEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *EnableEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *EnableEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *EnableEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *EnableEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *EnableEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
