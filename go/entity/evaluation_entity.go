...
func NewEvaluationEntity(client *core.CloudsmithSDK, entopts map[string]any) *EvaluationEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *EvaluationEntity) GetName() string { return e.name }
...
func (e *EvaluationEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *EvaluationEntity) Deleted() bool {
	return e.deleted
}


func (e *EvaluationEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewEvaluationEntity(e.client, opts)
}

func (e *EvaluationEntity) Data(args ...any) any {
...
func (e *EvaluationEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Evaluation; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *EvaluationEntity) DataTyped(data ...Evaluation) Evaluation {
	if len(data) > 0 {
		return typedFrom[Evaluation](e.Data(asMap(data[0])))
	}
	return typedFrom[Evaluation](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Evaluation (all fields
// optional at the wire level).
func (e *EvaluationEntity) MatchTyped(match ...Evaluation) Evaluation {
	if len(match) > 0 {
		return typedFrom[Evaluation](e.Match(asMap(match[0])))
	}
	return typedFrom[Evaluation](e.Match())
}
...
func (e *EvaluationEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *EvaluationEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *EvaluationEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *EvaluationEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *EvaluationEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *EvaluationEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *EvaluationEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
