...
type TransferRegionEntity struct {
	name    string
...
func NewTransferRegionEntity(client *core.CloudsmithSDK, entopts map[string]any) *TransferRegionEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *TransferRegionEntity) GetName() string { return e.name }
...
func (e *TransferRegionEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *TransferRegionEntity) Deleted() bool {
	return e.deleted
}


func (e *TransferRegionEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewTransferRegionEntity(e.client, opts)
}

func (e *TransferRegionEntity) Data(args ...any) any {
...
func (e *TransferRegionEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an TransferRegion; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *TransferRegionEntity) DataTyped(data ...TransferRegion) TransferRegion {
	if len(data) > 0 {
		return typedFrom[TransferRegion](e.Data(asMap(data[0])))
	}
	return typedFrom[TransferRegion](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through TransferRegion (all fields
// optional at the wire level).
func (e *TransferRegionEntity) MatchTyped(match ...TransferRegion) TransferRegion {
	if len(match) > 0 {
		return typedFrom[TransferRegion](e.Match(asMap(match[0])))
	}
	return typedFrom[TransferRegion](e.Match())
}
...
func (e *TransferRegionEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *TransferRegionEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *TransferRegionEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *TransferRegionEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *TransferRegionEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *TransferRegionEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *TransferRegionEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
