...
func NewUserProfileEntity(client *core.CloudsmithSDK, entopts map[string]any) *UserProfileEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *UserProfileEntity) GetName() string { return e.name }
...
func (e *UserProfileEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *UserProfileEntity) Deleted() bool {
	return e.deleted
}


func (e *UserProfileEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewUserProfileEntity(e.client, opts)
}

func (e *UserProfileEntity) Data(args ...any) any {
...
func (e *UserProfileEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an UserProfile; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *UserProfileEntity) DataTyped(data ...UserProfile) UserProfile {
	if len(data) > 0 {
		return typedFrom[UserProfile](e.Data(asMap(data[0])))
	}
	return typedFrom[UserProfile](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through UserProfile (all fields
// optional at the wire level).
func (e *UserProfileEntity) MatchTyped(match ...UserProfile) UserProfile {
	if len(match) > 0 {
		return typedFrom[UserProfile](e.Match(asMap(match[0])))
	}
	return typedFrom[UserProfile](e.Match())
}
...
func (e *UserProfileEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *UserProfileEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// UserProfileLoadMatch and returns an UserProfile. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *UserProfileEntity) LoadTyped(reqmatch UserProfileLoadMatch, ctrl map[string]any) (UserProfile, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return UserProfile{}, err
	}
	return typedFrom[UserProfile](res), nil
}



func (e *UserProfileEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *UserProfileEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *UserProfileEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *UserProfileEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *UserProfileEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
