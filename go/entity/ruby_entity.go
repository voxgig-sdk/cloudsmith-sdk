...
func NewRubyEntity(client *core.CloudsmithSDK, entopts map[string]any) *RubyEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *RubyEntity) GetName() string { return e.name }
...
func (e *RubyEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *RubyEntity) Deleted() bool {
	return e.deleted
}


func (e *RubyEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewRubyEntity(e.client, opts)
}

func (e *RubyEntity) Data(args ...any) any {
...
func (e *RubyEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Ruby; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *RubyEntity) DataTyped(data ...Ruby) Ruby {
	if len(data) > 0 {
		return typedFrom[Ruby](e.Data(asMap(data[0])))
	}
	return typedFrom[Ruby](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Ruby (all fields
// optional at the wire level).
func (e *RubyEntity) MatchTyped(match ...Ruby) Ruby {
	if len(match) > 0 {
		return typedFrom[Ruby](e.Match(asMap(match[0])))
	}
	return typedFrom[Ruby](e.Match())
}
...
func (e *RubyEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *RubyEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// RubyLoadMatch and returns an Ruby. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *RubyEntity) LoadTyped(reqmatch RubyLoadMatch, ctrl map[string]any) (Ruby, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Ruby{}, err
	}
	return typedFrom[Ruby](res), nil
}




func (e *RubyEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// RubyListMatch and returns []Ruby. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *RubyEntity) ListTyped(reqmatch RubyListMatch, ctrl map[string]any) ([]Ruby, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Ruby](res), nil
}




func (e *RubyEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// RubyCreateData and returns an Ruby. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *RubyEntity) CreateTyped(reqdata RubyCreateData, ctrl map[string]any) (Ruby, error) {
...
func (e *RubyEntity) Update(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "update",
		"ctrl":    ctrl,
...
// RubyUpdateData and returns an Ruby. It delegates to the untyped
// Update (identical runtime) and converts at the typed boundary.
func (e *RubyEntity) UpdateTyped(reqdata RubyUpdateData, ctrl map[string]any) (Ruby, error) {
...
func (e *RubyEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *RubyEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
