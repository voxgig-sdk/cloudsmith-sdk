...
func NewMavenEntity(client *core.CloudsmithSDK, entopts map[string]any) *MavenEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *MavenEntity) GetName() string { return e.name }
...
func (e *MavenEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *MavenEntity) Deleted() bool {
	return e.deleted
}


func (e *MavenEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewMavenEntity(e.client, opts)
}

func (e *MavenEntity) Data(args ...any) any {
...
func (e *MavenEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Maven; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *MavenEntity) DataTyped(data ...Maven) Maven {
	if len(data) > 0 {
		return typedFrom[Maven](e.Data(asMap(data[0])))
	}
	return typedFrom[Maven](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Maven (all fields
// optional at the wire level).
func (e *MavenEntity) MatchTyped(match ...Maven) Maven {
	if len(match) > 0 {
		return typedFrom[Maven](e.Match(asMap(match[0])))
	}
	return typedFrom[Maven](e.Match())
}
...
func (e *MavenEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *MavenEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// MavenLoadMatch and returns an Maven. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *MavenEntity) LoadTyped(reqmatch MavenLoadMatch, ctrl map[string]any) (Maven, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Maven{}, err
	}
	return typedFrom[Maven](res), nil
}




func (e *MavenEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// MavenListMatch and returns []Maven. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *MavenEntity) ListTyped(reqmatch MavenListMatch, ctrl map[string]any) ([]Maven, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Maven](res), nil
}




func (e *MavenEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// MavenCreateData and returns an Maven. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *MavenEntity) CreateTyped(reqdata MavenCreateData, ctrl map[string]any) (Maven, error) {
...
func (e *MavenEntity) Update(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "update",
		"ctrl":    ctrl,
...
// MavenUpdateData and returns an Maven. It delegates to the untyped
// Update (identical runtime) and converts at the typed boundary.
func (e *MavenEntity) UpdateTyped(reqdata MavenUpdateData, ctrl map[string]any) (Maven, error) {
...
func (e *MavenEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *MavenEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
