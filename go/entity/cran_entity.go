...
func NewCranEntity(client *core.CloudsmithSDK, entopts map[string]any) *CranEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CranEntity) GetName() string { return e.name }
...
func (e *CranEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CranEntity) Deleted() bool {
	return e.deleted
}


func (e *CranEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCranEntity(e.client, opts)
}

func (e *CranEntity) Data(args ...any) any {
...
func (e *CranEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Cran; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *CranEntity) DataTyped(data ...Cran) Cran {
	if len(data) > 0 {
		return typedFrom[Cran](e.Data(asMap(data[0])))
	}
	return typedFrom[Cran](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Cran (all fields
// optional at the wire level).
func (e *CranEntity) MatchTyped(match ...Cran) Cran {
	if len(match) > 0 {
		return typedFrom[Cran](e.Match(asMap(match[0])))
	}
	return typedFrom[Cran](e.Match())
}
...
func (e *CranEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CranEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// CranLoadMatch and returns an Cran. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *CranEntity) LoadTyped(reqmatch CranLoadMatch, ctrl map[string]any) (Cran, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Cran{}, err
	}
	return typedFrom[Cran](res), nil
}




func (e *CranEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// CranListMatch and returns []Cran. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *CranEntity) ListTyped(reqmatch CranListMatch, ctrl map[string]any) ([]Cran, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Cran](res), nil
}




func (e *CranEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// CranCreateData and returns an Cran. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *CranEntity) CreateTyped(reqdata CranCreateData, ctrl map[string]any) (Cran, error) {
...
func (e *CranEntity) Update(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "update",
		"ctrl":    ctrl,
...
// CranUpdateData and returns an Cran. It delegates to the untyped
// Update (identical runtime) and converts at the typed boundary.
func (e *CranEntity) UpdateTyped(reqdata CranUpdateData, ctrl map[string]any) (Cran, error) {
...
func (e *CranEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *CranEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
