...
func NewDenyPolicyEntity(client *core.CloudsmithSDK, entopts map[string]any) *DenyPolicyEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *DenyPolicyEntity) GetName() string { return e.name }
...
func (e *DenyPolicyEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *DenyPolicyEntity) Deleted() bool {
	return e.deleted
}


func (e *DenyPolicyEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewDenyPolicyEntity(e.client, opts)
}

func (e *DenyPolicyEntity) Data(args ...any) any {
...
func (e *DenyPolicyEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an DenyPolicy; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *DenyPolicyEntity) DataTyped(data ...DenyPolicy) DenyPolicy {
	if len(data) > 0 {
		return typedFrom[DenyPolicy](e.Data(asMap(data[0])))
	}
	return typedFrom[DenyPolicy](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through DenyPolicy (all fields
// optional at the wire level).
func (e *DenyPolicyEntity) MatchTyped(match ...DenyPolicy) DenyPolicy {
	if len(match) > 0 {
		return typedFrom[DenyPolicy](e.Match(asMap(match[0])))
	}
	return typedFrom[DenyPolicy](e.Match())
}
...
func (e *DenyPolicyEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *DenyPolicyEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *DenyPolicyEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *DenyPolicyEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *DenyPolicyEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *DenyPolicyEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *DenyPolicyEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
