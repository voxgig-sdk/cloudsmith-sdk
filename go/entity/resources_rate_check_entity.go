...
type ResourcesRateCheckEntity struct {
	name    string
...
func NewResourcesRateCheckEntity(client *core.CloudsmithSDK, entopts map[string]any) *ResourcesRateCheckEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ResourcesRateCheckEntity) GetName() string { return e.name }
...
func (e *ResourcesRateCheckEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ResourcesRateCheckEntity) Deleted() bool {
	return e.deleted
}


func (e *ResourcesRateCheckEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewResourcesRateCheckEntity(e.client, opts)
}

func (e *ResourcesRateCheckEntity) Data(args ...any) any {
...
func (e *ResourcesRateCheckEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an ResourcesRateCheck; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ResourcesRateCheckEntity) DataTyped(data ...ResourcesRateCheck) ResourcesRateCheck {
	if len(data) > 0 {
		return typedFrom[ResourcesRateCheck](e.Data(asMap(data[0])))
	}
	return typedFrom[ResourcesRateCheck](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through ResourcesRateCheck (all fields
// optional at the wire level).
func (e *ResourcesRateCheckEntity) MatchTyped(match ...ResourcesRateCheck) ResourcesRateCheck {
	if len(match) > 0 {
		return typedFrom[ResourcesRateCheck](e.Match(asMap(match[0])))
	}
	return typedFrom[ResourcesRateCheck](e.Match())
}
...
func (e *ResourcesRateCheckEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ResourcesRateCheckEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ResourcesRateCheckLoadMatch and returns an ResourcesRateCheck. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *ResourcesRateCheckEntity) LoadTyped(reqmatch ResourcesRateCheckLoadMatch, ctrl map[string]any) (ResourcesRateCheck, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return ResourcesRateCheck{}, err
	}
	return typedFrom[ResourcesRateCheck](res), nil
}



func (e *ResourcesRateCheckEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *ResourcesRateCheckEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ResourcesRateCheckEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ResourcesRateCheckEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ResourcesRateCheckEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
