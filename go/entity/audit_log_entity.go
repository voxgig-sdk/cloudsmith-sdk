...
func NewAuditLogEntity(client *core.CloudsmithSDK, entopts map[string]any) *AuditLogEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *AuditLogEntity) GetName() string { return e.name }
...
func (e *AuditLogEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *AuditLogEntity) Deleted() bool {
	return e.deleted
}


func (e *AuditLogEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewAuditLogEntity(e.client, opts)
}

func (e *AuditLogEntity) Data(args ...any) any {
...
func (e *AuditLogEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an AuditLog; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *AuditLogEntity) DataTyped(data ...AuditLog) AuditLog {
	if len(data) > 0 {
		return typedFrom[AuditLog](e.Data(asMap(data[0])))
	}
	return typedFrom[AuditLog](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through AuditLog (all fields
// optional at the wire level).
func (e *AuditLogEntity) MatchTyped(match ...AuditLog) AuditLog {
	if len(match) > 0 {
		return typedFrom[AuditLog](e.Match(asMap(match[0])))
	}
	return typedFrom[AuditLog](e.Match())
}
...
func (e *AuditLogEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *AuditLogEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *AuditLogEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *AuditLogEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *AuditLogEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *AuditLogEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *AuditLogEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
