...
func NewPackageEntity(client *core.CloudsmithSDK, entopts map[string]any) *PackageEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *PackageEntity) GetName() string { return e.name }
...
func (e *PackageEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *PackageEntity) Deleted() bool {
	return e.deleted
}


func (e *PackageEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewPackageEntity(e.client, opts)
}

func (e *PackageEntity) Data(args ...any) any {
...
func (e *PackageEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Package; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *PackageEntity) DataTyped(data ...Package) Package {
	if len(data) > 0 {
		return typedFrom[Package](e.Data(asMap(data[0])))
	}
	return typedFrom[Package](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Package (all fields
// optional at the wire level).
func (e *PackageEntity) MatchTyped(match ...Package) Package {
	if len(match) > 0 {
		return typedFrom[Package](e.Match(asMap(match[0])))
	}
	return typedFrom[Package](e.Match())
}
...
func (e *PackageEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *PackageEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// PackageLoadMatch and returns an Package. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *PackageEntity) LoadTyped(reqmatch PackageLoadMatch, ctrl map[string]any) (Package, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Package{}, err
	}
	return typedFrom[Package](res), nil
}




func (e *PackageEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// PackageListMatch and returns []Package. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *PackageEntity) ListTyped(reqmatch PackageListMatch, ctrl map[string]any) ([]Package, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Package](res), nil
}




func (e *PackageEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// PackageCreateData and returns an Package. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *PackageEntity) CreateTyped(reqdata PackageCreateData, ctrl map[string]any) (Package, error) {
...
func (e *PackageEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}



func (e *PackageEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "remove",
		"ctrl":     ctrl,
...
// PackageRemoveMatch and returns an Package. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *PackageEntity) RemoveTyped(reqmatch PackageRemoveMatch, ctrl map[string]any) (Package, error) {
...
func (e *PackageEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
