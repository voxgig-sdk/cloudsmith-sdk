...
func NewRsaEntity(client *core.CloudsmithSDK, entopts map[string]any) *RsaEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *RsaEntity) GetName() string { return e.name }
...
func (e *RsaEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *RsaEntity) Deleted() bool {
	return e.deleted
}


func (e *RsaEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewRsaEntity(e.client, opts)
}

func (e *RsaEntity) Data(args ...any) any {
...
func (e *RsaEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Rsa; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *RsaEntity) DataTyped(data ...Rsa) Rsa {
	if len(data) > 0 {
		return typedFrom[Rsa](e.Data(asMap(data[0])))
	}
	return typedFrom[Rsa](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Rsa (all fields
// optional at the wire level).
func (e *RsaEntity) MatchTyped(match ...Rsa) Rsa {
	if len(match) > 0 {
		return typedFrom[Rsa](e.Match(asMap(match[0])))
	}
	return typedFrom[Rsa](e.Match())
}
...
func (e *RsaEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *RsaEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *RsaEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *RsaEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *RsaEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *RsaEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *RsaEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
