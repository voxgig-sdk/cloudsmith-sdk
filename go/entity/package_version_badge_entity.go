...
type PackageVersionBadgeEntity struct {
	name    string
...
func NewPackageVersionBadgeEntity(client *core.CloudsmithSDK, entopts map[string]any) *PackageVersionBadgeEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *PackageVersionBadgeEntity) GetName() string { return e.name }
...
func (e *PackageVersionBadgeEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *PackageVersionBadgeEntity) Deleted() bool {
	return e.deleted
}


func (e *PackageVersionBadgeEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewPackageVersionBadgeEntity(e.client, opts)
}

func (e *PackageVersionBadgeEntity) Data(args ...any) any {
...
func (e *PackageVersionBadgeEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an PackageVersionBadge; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *PackageVersionBadgeEntity) DataTyped(data ...PackageVersionBadge) PackageVersionBadge {
	if len(data) > 0 {
		return typedFrom[PackageVersionBadge](e.Data(asMap(data[0])))
	}
	return typedFrom[PackageVersionBadge](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through PackageVersionBadge (all fields
// optional at the wire level).
func (e *PackageVersionBadgeEntity) MatchTyped(match ...PackageVersionBadge) PackageVersionBadge {
	if len(match) > 0 {
		return typedFrom[PackageVersionBadge](e.Match(asMap(match[0])))
	}
	return typedFrom[PackageVersionBadge](e.Match())
}
...
func (e *PackageVersionBadgeEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *PackageVersionBadgeEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// PackageVersionBadgeLoadMatch and returns an PackageVersionBadge. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *PackageVersionBadgeEntity) LoadTyped(reqmatch PackageVersionBadgeLoadMatch, ctrl map[string]any) (PackageVersionBadge, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return PackageVersionBadge{}, err
	}
	return typedFrom[PackageVersionBadge](res), nil
}



func (e *PackageVersionBadgeEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *PackageVersionBadgeEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *PackageVersionBadgeEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *PackageVersionBadgeEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *PackageVersionBadgeEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
