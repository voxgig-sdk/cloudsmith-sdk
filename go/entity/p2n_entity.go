...
func NewP2nEntity(client *core.CloudsmithSDK, entopts map[string]any) *P2nEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *P2nEntity) GetName() string { return e.name }
...
func (e *P2nEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *P2nEntity) Deleted() bool {
	return e.deleted
}


func (e *P2nEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewP2nEntity(e.client, opts)
}

func (e *P2nEntity) Data(args ...any) any {
...
func (e *P2nEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an P2n; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *P2nEntity) DataTyped(data ...P2n) P2n {
	if len(data) > 0 {
		return typedFrom[P2n](e.Data(asMap(data[0])))
	}
	return typedFrom[P2n](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through P2n (all fields
// optional at the wire level).
func (e *P2nEntity) MatchTyped(match ...P2n) P2n {
	if len(match) > 0 {
		return typedFrom[P2n](e.Match(asMap(match[0])))
	}
	return typedFrom[P2n](e.Match())
}
...
func (e *P2nEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *P2nEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *P2nEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *P2nEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *P2nEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *P2nEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *P2nEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
