...
func NewAbortEntity(client *core.CloudsmithSDK, entopts map[string]any) *AbortEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *AbortEntity) GetName() string { return e.name }
...
func (e *AbortEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *AbortEntity) Deleted() bool {
	return e.deleted
}


func (e *AbortEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewAbortEntity(e.client, opts)
}

func (e *AbortEntity) Data(args ...any) any {
...
func (e *AbortEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Abort; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *AbortEntity) DataTyped(data ...Abort) Abort {
	if len(data) > 0 {
		return typedFrom[Abort](e.Data(asMap(data[0])))
	}
	return typedFrom[Abort](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Abort (all fields
// optional at the wire level).
func (e *AbortEntity) MatchTyped(match ...Abort) Abort {
	if len(match) > 0 {
		return typedFrom[Abort](e.Match(asMap(match[0])))
	}
	return typedFrom[Abort](e.Match())
}
...
func (e *AbortEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *AbortEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *AbortEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *AbortEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *AbortEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *AbortEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *AbortEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
