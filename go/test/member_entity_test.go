...
func memberBasicSetup(extra map[string]any) *entityTestSetup {
	...
	idmap := vs.Transform(
		[]any{"member01", "member02", "member03", "org01", "org02", "org03"},
		map[string]any{
	...
	entidEnvRaw := os.Getenv("CLOUDSMITH_TEST_MEMBER_ENTID")
	...
	idmapResolved := core.ToMapAny(env["CLOUDSMITH_TEST_MEMBER_ENTID"])
