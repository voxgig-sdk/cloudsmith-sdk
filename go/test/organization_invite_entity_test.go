...
func TestOrganizationInviteEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		organizationInviteRef01Data := core.ToMapAny(vs.GetProp(
			vs.GetPath(setup.data, []any{"new", "organization_invite"}), "organization_invite_ref01"))
		...
		organizationInviteRef01Data = core.ToMapAny(entityData(organizationInviteRef01DataResult))
