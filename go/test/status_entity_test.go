...
func statusBasicSetup(extra map[string]any) *entityTestSetup {
	...
	idmap := vs.Transform(
		[]any{"status01", "status02", "status03", "org01", "org02", "org03", "package01", "package02", "package03", "repo01", "repo02", "repo03"},
		map[string]any{
	...
	entidEnvRaw := os.Getenv("CLOUDSMITH_TEST_STATUS_ENTID")
	...
	idmapResolved := core.ToMapAny(env["CLOUDSMITH_TEST_STATUS_ENTID"])
