...
func TestOrganizationMembershipVisibilityUpdateEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		organizationMembershipVisibilityUpdateRef01DataRaw := vs.Items(core.ToMapAny(vs.GetPath(setup.data, "existing.organization_membership_visibility_update")))
		...
		organizationMembershipVisibilityUpdateRef01ResdataUp0 := core.ToMapAny(entityData(organizationMembershipVisibilityUpdateRef01ResdataUp0Result))
