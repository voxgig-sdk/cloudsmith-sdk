...
func TestPackageLicensePolicyEvaluationEntity(t *testing.T) {
	...
	t.Run("stream", func(t *testing.T) {
		...
		var seen []any
		for item := range base.PackageLicensePolicyEvaluation(nil).Stream("list", nil, nil) {
		...
		if hasStreaming {
			...
			var got []any
			for item := range streamSdk.PackageLicensePolicyEvaluation(nil).Stream("list", nil, nil) {
