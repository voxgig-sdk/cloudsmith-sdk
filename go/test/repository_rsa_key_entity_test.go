...
func TestRepositoryRsaKeyEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		repositoryRsaKeyRef01Data := core.ToMapAny(vs.GetProp(
			vs.GetPath(setup.data, []any{"new", "repository_rsa_key"}), "repository_rsa_key_ref01"))
		...
		repositoryRsaKeyRef01Data = core.ToMapAny(entityData(repositoryRsaKeyRef01DataResult))
