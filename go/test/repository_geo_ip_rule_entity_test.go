...
func TestRepositoryGeoIpRuleEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		repositoryGeoIpRuleRef01DataRaw := vs.Items(core.ToMapAny(vs.GetPath(setup.data, "existing.repository_geo_ip_rule")))
		...
		repositoryGeoIpRuleRef01ResdataUp0 := core.ToMapAny(entityData(repositoryGeoIpRuleRef01ResdataUp0Result))
