...
func TestOrganizationSamlAuthEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		organizationSamlAuthRef01DataRaw := vs.Items(core.ToMapAny(vs.GetPath(setup.data, "existing.organization_saml_auth")))
		...
		organizationSamlAuthRef01ResdataUp0 := core.ToMapAny(entityData(organizationSamlAuthRef01ResdataUp0Result))
