...
func TestOrganizationTeamMemberEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		organizationTeamMemberRef01Data := core.ToMapAny(vs.GetProp(
			vs.GetPath(setup.data, []any{"new", "organization_team_member"}), "organization_team_member_ref01"))
		...
		organizationTeamMemberRef01Data = core.ToMapAny(entityData(organizationTeamMemberRef01DataResult))
		...
		_, organizationTeamMemberRef01ListOk := organizationTeamMemberRef01ListResult.([]any)
