// Command Cloudsmith-mcp is an MCP server exposing the Cloudsmith
// SDK as MCP tools.
//
// Two tools are registered:
//
//	Cloudsmith_list  — list records of an entity
//	Cloudsmith_load  — load a single record of an entity
//
