...
class EntitlementDirectTest extends TestCase
{
    public function test_direct_load_entitlement(): void
    {
        $setup = entitlement_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-entitlement", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
