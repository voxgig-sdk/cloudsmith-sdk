...
class OrganizationInviteDirectTest extends TestCase
{
    public function test_direct_list_organization_invite(): void
    {
        $setup = organization_invite_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-organization_invite", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
