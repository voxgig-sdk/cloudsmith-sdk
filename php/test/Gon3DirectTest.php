...
class Gon3DirectTest extends TestCase
{
    public function test_direct_list_gon3(): void
    {
        $setup = gon3_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-gon3", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
