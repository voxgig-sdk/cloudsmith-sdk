...
class ServiceEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        $this->assertNotNull($service_ref01_data["id"]);
        ...
        $this->assertEquals($service_ref01_resdata_up0["id"], $service_ref01_data_up0_up["id"]);
        ...
        $service_ref01_data_dt0_load_result = Helpers::to_map(is_object($service_ref01_data_dt0_loaded) && method_exists($service_ref01_data_dt0_loaded, 'data_get') ? $service_ref01_data_dt0_loaded->data_get() : $service_ref01_data_dt0_loaded);
