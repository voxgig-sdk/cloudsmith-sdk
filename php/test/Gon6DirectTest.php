...
class Gon6DirectTest extends TestCase
{
    public function test_direct_load_gon6(): void
    {
        $setup = gon6_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-gon6", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
