...
class RepositoryWebhookEntityTest extends TestCase
{
    ...
    public function test_stream(): void
    {
        ...
        $seen = iterator_to_array($base->RepositoryWebhook(null)->stream("list", null, null), false);
        ...
        if (isset($cfg["feature"]) && is_array($cfg["feature"]) && isset($cfg["feature"]["streaming"])) {
            ...
            $got = [];
            foreach ($sdk->RepositoryWebhook(null)->stream("list", null, null) as $item) {
    ...
    public function test_basic_flow(): void
    {
        ...
        $this->assertNotNull($repository_webhook_ref01_data["id"]);
        ...
        $this->assertEquals($repository_webhook_ref01_resdata_up0["id"], $repository_webhook_ref01_data_up0_up["id"]);
        ...
        $repository_webhook_ref01_data_dt0_load_result = Helpers::to_map(is_object($repository_webhook_ref01_data_dt0_loaded) && method_exists($repository_webhook_ref01_data_dt0_loaded, 'data_get') ? $repository_webhook_ref01_data_dt0_loaded->data_get() : $repository_webhook_ref01_data_dt0_loaded);
        $this->assertNotNull($repository_webhook_ref01_data_dt0_load_result);
        $this->assertEquals($repository_webhook_ref01_data_dt0_load_result["id"], $repository_webhook_ref01_data["id"]);
