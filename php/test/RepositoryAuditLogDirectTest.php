...
class RepositoryAuditLogDirectTest extends TestCase
{
    public function test_direct_list_repository_audit_log(): void
    {
        $setup = repository_audit_log_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-repository_audit_log", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
