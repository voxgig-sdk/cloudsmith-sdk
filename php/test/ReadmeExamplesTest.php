...
// Cloudsmith SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (CloudsmithSDK::test)
...
{
    private const SDK_CLASS = 'CloudsmithSDK';
    ...
    private const SDK_BASE = 'cloudsmith_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../cloudsmith_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
