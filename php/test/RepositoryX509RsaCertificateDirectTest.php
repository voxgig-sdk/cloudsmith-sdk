...
class RepositoryX509RsaCertificateDirectTest extends TestCase
{
    public function test_direct_load_repository_x509_rsa_certificate(): void
    {
        $setup = repository_x509_rsa_certificate_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-repository_x509_rsa_certificate", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
