...
class CloudsmithTestRunner
{
    ...
    {
        $live = self::getenv('CLOUDSMITH_TEST_LIVE');
        $override = self::getenv('CLOUDSMITH_TEST_OVERRIDE');
        ...
        $explain = self::getenv('CLOUDSMITH_TEST_EXPLAIN');
...
class_alias('CloudsmithTestRunner', 'Runner');
class_alias('CloudsmithHelpers', 'Helpers');
