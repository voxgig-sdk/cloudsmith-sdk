...
class OrganizationGroupSyncDirectTest extends TestCase
{
    public function test_direct_list_organization_group_sync(): void
    {
        $setup = organization_group_sync_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-organization_group_sync", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
