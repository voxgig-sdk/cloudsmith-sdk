...
class CloudsmithRbacFeature extends CloudsmithBaseFeature
{
    ...
    private function _required(CloudsmithContext $ctx): ?string
    {
    ...
    private function _reject(CloudsmithContext $ctx, string $required): void
    {
    ...
    private function _track(CloudsmithContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
