...
class CloudsmithProxyFeature extends CloudsmithBaseFeature
{
    ...
    public function init(CloudsmithContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (CloudsmithContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
