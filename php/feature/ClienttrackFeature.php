...
class CloudsmithClienttrackFeature extends CloudsmithBaseFeature
{
    ...
    public function PostConstruct(CloudsmithContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Cloudsmith-SDK';
