...
class CloudsmithPagingFeature extends CloudsmithBaseFeature
{
    ...
    private function _graphql_pre_request(CloudsmithContext $ctx, array $paging): void
    {
        $body = $ctx->spec->body;
        if (!is_array($body)) {
            return;
    ...
    private function _is_list(CloudsmithContext $ctx): bool
    {
