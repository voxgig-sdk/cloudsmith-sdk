...
// Cloudsmith SDK streaming feature
...
class CloudsmithStreamingFeature extends CloudsmithBaseFeature
{
    ...
    private function _iterate(CloudsmithResult $result): \Generator
    {
    ...
    private function _streamable(CloudsmithContext $ctx): bool
    {
