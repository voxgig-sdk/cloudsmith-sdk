...
// Cloudsmith SDK ratelimit feature
...
class CloudsmithRatelimitFeature extends CloudsmithBaseFeature
{
    ...
    private function _acquire(CloudsmithContext $ctx): void
    {
    ...
    private function _track(CloudsmithContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
