...
// Cloudsmith SDK timeout feature
...
class CloudsmithTimeoutFeature extends CloudsmithBaseFeature
{
    ...
    private function _with_timeout(CloudsmithContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(CloudsmithContext $_ctx, float $ms): void
    {
        $client = $this->client;
