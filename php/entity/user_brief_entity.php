...
class UserBriefEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new UserBriefEntity($this->_client, $opts);
    }

    /**
     * @param UserBrief|array $args UserBrief data (assoc-array) to store.
     */
    ...
    /**
     * @return UserBrief|array The current UserBrief data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of UserBrief fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of UserBrief fields).
     */
    ...
    /**
     * Load a single UserBrief.
     *
     * @param UserBriefLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed UserBriefLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return UserBrief|array The loaded UserBrief as an assoc-array at the
