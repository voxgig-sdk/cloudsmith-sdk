...
class SelfEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new SelfEntity($this->_client, $opts);
    }

    /**
     * @param Self|array $args Self data (assoc-array) to store.
     */
    ...
    /**
     * @return Self|array The current Self data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Self fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Self fields).
     */
