...
class P2n2Entity
{
    ...
    {
        $opts = $this->_entopts;
        return new P2n2Entity($this->_client, $opts);
    }

    /**
     * @param P2n2|array $args P2n2 data (assoc-array) to store.
     */
    ...
    /**
     * @return P2n2|array The current P2n2 data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of P2n2 fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of P2n2 fields).
     */
