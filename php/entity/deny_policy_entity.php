...
class DenyPolicyEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new DenyPolicyEntity($this->_client, $opts);
    }

    /**
     * @param DenyPolicy|array $args DenyPolicy data (assoc-array) to store.
     */
    ...
    /**
     * @return DenyPolicy|array The current DenyPolicy data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of DenyPolicy fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of DenyPolicy fields).
     */
