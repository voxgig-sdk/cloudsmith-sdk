...
class P2nEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new P2nEntity($this->_client, $opts);
    }

    /**
     * @param P2n|array $args P2n data (assoc-array) to store.
     */
    ...
    /**
     * @return P2n|array The current P2n data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of P2n fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of P2n fields).
     */
