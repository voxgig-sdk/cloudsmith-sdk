...
class RefreshEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new RefreshEntity($this->_client, $opts);
    }

    /**
     * @param Refresh|array $args Refresh data (assoc-array) to store.
     */
    ...
    /**
     * @return Refresh|array The current Refresh data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Refresh fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Refresh fields).
     */
