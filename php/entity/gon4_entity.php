...
class Gon4Entity
{
    ...
    {
        $opts = $this->_entopts;
        return new Gon4Entity($this->_client, $opts);
    }

    /**
     * @param Gon4|array $args Gon4 data (assoc-array) to store.
     */
    ...
    /**
     * @return Gon4|array The current Gon4 data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Gon4 fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Gon4 fields).
     */
