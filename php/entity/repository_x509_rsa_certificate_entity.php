...
class RepositoryX509RsaCertificateEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "repository_x509_rsa_certificate";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new RepositoryX509RsaCertificateEntity($this->_client, $opts);
    }

    /**
     * @param RepositoryX509RsaCertificate|array $args RepositoryX509RsaCertificate data (assoc-array) to store.
     */
    ...
    /**
     * @return RepositoryX509RsaCertificate|array The current RepositoryX509RsaCertificate data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of RepositoryX509RsaCertificate fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of RepositoryX509RsaCertificate fields).
     */
    ...
    /**
     * Load a single RepositoryX509RsaCertificate.
     *
     * @param RepositoryX509RsaCertificateLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed RepositoryX509RsaCertificateLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return RepositoryX509RsaCertificate|array The loaded RepositoryX509RsaCertificate as an assoc-array at the
