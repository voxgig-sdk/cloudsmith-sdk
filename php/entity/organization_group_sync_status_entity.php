...
class OrganizationGroupSyncStatusEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "organization_group_sync_status";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new OrganizationGroupSyncStatusEntity($this->_client, $opts);
    }

    /**
     * @param OrganizationGroupSyncStatus|array $args OrganizationGroupSyncStatus data (assoc-array) to store.
     */
    ...
    /**
     * @return OrganizationGroupSyncStatus|array The current OrganizationGroupSyncStatus data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of OrganizationGroupSyncStatus fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of OrganizationGroupSyncStatus fields).
     */
    ...
    /**
     * Load a single OrganizationGroupSyncStatus.
     *
     * @param OrganizationGroupSyncStatusLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed OrganizationGroupSyncStatusLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return OrganizationGroupSyncStatus|array The loaded OrganizationGroupSyncStatus as an assoc-array at the
