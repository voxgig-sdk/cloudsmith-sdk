...
class UserProfileEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new UserProfileEntity($this->_client, $opts);
    }

    /**
     * @param UserProfile|array $args UserProfile data (assoc-array) to store.
     */
    ...
    /**
     * @return UserProfile|array The current UserProfile data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of UserProfile fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of UserProfile fields).
     */
    ...
    /**
     * Load a single UserProfile.
     *
     * @param UserProfileLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed UserProfileLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return UserProfile|array The loaded UserProfile as an assoc-array at the
