...
class RepositoryRsaKeyEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new RepositoryRsaKeyEntity($this->_client, $opts);
    }

    /**
     * @param RepositoryRsaKey|array $args RepositoryRsaKey data (assoc-array) to store.
     */
    ...
    /**
     * @return RepositoryRsaKey|array The current RepositoryRsaKey data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of RepositoryRsaKey fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of RepositoryRsaKey fields).
     */
    ...
    /**
     * Load a single RepositoryRsaKey.
     *
     * @param RepositoryRsaKeyLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed RepositoryRsaKeyLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return RepositoryRsaKey|array The loaded RepositoryRsaKey as an assoc-array at the
    ...
    /**
     * Create a new RepositoryRsaKey.
     *
     * @param RepositoryRsaKeyCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed RepositoryRsaKeyCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return RepositoryRsaKey|array The created RepositoryRsaKey as an assoc-array at the
     *   SDK boundary; throws CloudsmithError on failure (item-5 convention).
     */
