...
class AlpineEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new AlpineEntity($this->_client, $opts);
    }

    /**
     * @param Alpine|array $args Alpine data (assoc-array) to store.
     */
    ...
    /**
     * @return Alpine|array The current Alpine data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Alpine fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Alpine fields).
     */
