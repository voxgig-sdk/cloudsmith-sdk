...
// Cloudsmith SDK DynamicMapping entity
...
class DynamicMappingEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new DynamicMappingEntity($this->_client, $opts);
    }

    /**
     * @param DynamicMapping|array $args DynamicMapping data (assoc-array) to store.
     */
    ...
    /**
     * @return DynamicMapping|array The current DynamicMapping data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of DynamicMapping fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of DynamicMapping fields).
     */
    ...
    /**
     * Load a single DynamicMapping.
     *
     * @param DynamicMappingLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed DynamicMappingLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return DynamicMapping|array The loaded DynamicMapping as an assoc-array at the
    ...
    /**
     * List DynamicMapping items matching the given filter.
     *
     * @param DynamicMappingListMatch|array|null $reqmatch Match filter (any subset
     *   of DynamicMapping fields) as an assoc-array; DynamicMappingListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return DynamicMapping[]|array A list of DynamicMapping items as assoc-arrays at
