...
class X509RsaEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new X509RsaEntity($this->_client, $opts);
    }

    /**
     * @param X509Rsa|array $args X509Rsa data (assoc-array) to store.
     */
    ...
    /**
     * @return X509Rsa|array The current X509Rsa data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of X509Rsa fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of X509Rsa fields).
     */
