...
class PackageVersionBadgeEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "package_version_badge";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new PackageVersionBadgeEntity($this->_client, $opts);
    }

    /**
     * @param PackageVersionBadge|array $args PackageVersionBadge data (assoc-array) to store.
     */
    ...
    /**
     * @return PackageVersionBadge|array The current PackageVersionBadge data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of PackageVersionBadge fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of PackageVersionBadge fields).
     */
    ...
    /**
     * Load a single PackageVersionBadge.
     *
     * @param PackageVersionBadgeLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed PackageVersionBadgeLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return PackageVersionBadge|array The loaded PackageVersionBadge as an assoc-array at the
