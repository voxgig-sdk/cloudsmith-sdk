...
class OpenidConnectEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new OpenidConnectEntity($this->_client, $opts);
    }

    /**
     * @param OpenidConnect|array $args OpenidConnect data (assoc-array) to store.
     */
    ...
    /**
     * @return OpenidConnect|array The current OpenidConnect data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of OpenidConnect fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of OpenidConnect fields).
     */
