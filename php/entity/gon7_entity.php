...
class Gon7Entity
{
    ...
    {
        $opts = $this->_entopts;
        return new Gon7Entity($this->_client, $opts);
    }

    /**
     * @param Gon7|array $args Gon7 data (assoc-array) to store.
     */
    ...
    /**
     * @return Gon7|array The current Gon7 data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Gon7 fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Gon7 fields).
     */
