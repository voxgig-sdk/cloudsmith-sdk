...
class RepositoryWebhookEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new RepositoryWebhookEntity($this->_client, $opts);
    }

    /**
     * @param RepositoryWebhook|array $args RepositoryWebhook data (assoc-array) to store.
     */
    ...
    /**
     * @return RepositoryWebhook|array The current RepositoryWebhook data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of RepositoryWebhook fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of RepositoryWebhook fields).
     */
     ...
     *
     * @param RepositoryWebhookListMatch|array|null $reqmatch Match filter (any subset
     *   of RepositoryWebhook fields) as an assoc-array; RepositoryWebhookListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return RepositoryWebhook[]|array A list of RepositoryWebhook items as assoc-arrays at
     ...
     *
     * @param RepositoryWebhookCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed RepositoryWebhookCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return RepositoryWebhook|array The created RepositoryWebhook as an assoc-array at the
     ...
     *
     * @param RepositoryWebhookUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed RepositoryWebhookUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return RepositoryWebhook|array The updated RepositoryWebhook as an assoc-array at the
     *   SDK boundary; throws CloudsmithError on failure (item-5 convention).
     */
