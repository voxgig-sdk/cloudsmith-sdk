...
class PackageFilePartsUploadEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "package_file_parts_upload";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new PackageFilePartsUploadEntity($this->_client, $opts);
    }

    /**
     * @param PackageFilePartsUpload|array $args PackageFilePartsUpload data (assoc-array) to store.
     */
    ...
    /**
     * @return PackageFilePartsUpload|array The current PackageFilePartsUpload data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of PackageFilePartsUpload fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of PackageFilePartsUpload fields).
     */
    ...
    /**
     * Load a single PackageFilePartsUpload.
     *
     * @param PackageFilePartsUploadLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed PackageFilePartsUploadLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return PackageFilePartsUpload|array The loaded PackageFilePartsUpload as an assoc-array at the
