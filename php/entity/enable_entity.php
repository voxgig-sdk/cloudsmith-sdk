...
class EnableEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new EnableEntity($this->_client, $opts);
    }

    /**
     * @param Enable|array $args Enable data (assoc-array) to store.
     */
    ...
    /**
     * @return Enable|array The current Enable data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Enable fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Enable fields).
     */
