...
class NamespaceAuditLogEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "namespace_audit_log";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new NamespaceAuditLogEntity($this->_client, $opts);
    }

    /**
     * @param NamespaceAuditLog|array $args NamespaceAuditLog data (assoc-array) to store.
     */
    ...
    /**
     * @return NamespaceAuditLog|array The current NamespaceAuditLog data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of NamespaceAuditLog fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of NamespaceAuditLog fields).
     */
    ...
    /**
     * Load a single NamespaceAuditLog.
     *
     * @param NamespaceAuditLogLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed NamespaceAuditLogLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return NamespaceAuditLog|array The loaded NamespaceAuditLog as an assoc-array at the
