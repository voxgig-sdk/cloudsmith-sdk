...
class RegenerateEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new RegenerateEntity($this->_client, $opts);
    }

    /**
     * @param Regenerate|array $args Regenerate data (assoc-array) to store.
     */
    ...
    /**
     * @return Regenerate|array The current Regenerate data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Regenerate fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Regenerate fields).
     */
