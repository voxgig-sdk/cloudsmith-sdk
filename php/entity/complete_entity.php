...
class CompleteEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new CompleteEntity($this->_client, $opts);
    }

    /**
     * @param Complete|array $args Complete data (assoc-array) to store.
     */
    ...
    /**
     * @return Complete|array The current Complete data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Complete fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Complete fields).
     */
