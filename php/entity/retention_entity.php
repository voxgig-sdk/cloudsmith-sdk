...
class RetentionEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new RetentionEntity($this->_client, $opts);
    }

    /**
     * @param Retention|array $args Retention data (assoc-array) to store.
     */
    ...
    /**
     * @return Retention|array The current Retention data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Retention fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Retention fields).
     */
