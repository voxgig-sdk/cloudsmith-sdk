...
class TransferRegionEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new TransferRegionEntity($this->_client, $opts);
    }

    /**
     * @param TransferRegion|array $args TransferRegion data (assoc-array) to store.
     */
    ...
    /**
     * @return TransferRegion|array The current TransferRegion data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of TransferRegion fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of TransferRegion fields).
     */
