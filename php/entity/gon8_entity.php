...
class Gon8Entity
{
    ...
    {
        $opts = $this->_entopts;
        return new Gon8Entity($this->_client, $opts);
    }

    /**
     * @param Gon8|array $args Gon8 data (assoc-array) to store.
     */
    ...
    /**
     * @return Gon8|array The current Gon8 data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Gon8 fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Gon8 fields).
     */
    ...
    /**
     * Update an existing Gon8.
     *
     * @param Gon8UpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed Gon8UpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Gon8|array The updated Gon8 as an assoc-array at the
