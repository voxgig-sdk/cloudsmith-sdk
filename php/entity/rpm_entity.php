...
class RpmEntity
{
     ...
     * Load a single Rpm.
     *
     * @param RpmLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed RpmLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Rpm|array The loaded Rpm as an assoc-array at the
     ...
     *
     * @param RpmListMatch|array|null $reqmatch Match filter (any subset
     *   of Rpm fields) as an assoc-array; RpmListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Rpm[]|array A list of Rpm items as assoc-arrays at
     ...
     *
     * @param RpmUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed RpmUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Rpm|array The updated Rpm as an assoc-array at the
     *   SDK boundary; throws CloudsmithError on failure (item-5 convention).
     */
