...
class DistroEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new DistroEntity($this->_client, $opts);
    }

    /**
     * @param Distro|array $args Distro data (assoc-array) to store.
     */
    ...
    /**
     * @return Distro|array The current Distro data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Distro fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Distro fields).
     */
