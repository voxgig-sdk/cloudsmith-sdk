...
class ServiceEntity
{
     ...
     *
     * @param ServiceLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ServiceLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Service|array The loaded Service as an assoc-array at the
     ...
     *
     * @param ServiceCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ServiceCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Service|array The created Service as an assoc-array at the
     *   SDK boundary; throws CloudsmithError on failure (item-5 convention).
     */
     ...
     *
     * @param ServiceUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ServiceUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Service|array The updated Service as an assoc-array at the
     *   SDK boundary; throws CloudsmithError on failure (item-5 convention).
     */
