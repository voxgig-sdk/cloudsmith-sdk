...
class ComposerEntity
{
     ...
     *
     * @param ComposerLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ComposerLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Composer|array The loaded Composer as an assoc-array at the
     ...
     *
     * @param ComposerListMatch|array|null $reqmatch Match filter (any subset
     *   of Composer fields) as an assoc-array; ComposerListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Composer[]|array A list of Composer items as assoc-arrays at
     ...
     *
     * @param ComposerUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ComposerUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Composer|array The updated Composer as an assoc-array at the
     *   SDK boundary; throws CloudsmithError on failure (item-5 convention).
     */
