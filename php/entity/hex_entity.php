...
class HexEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new HexEntity($this->_client, $opts);
    }

    /**
     * @param Hex|array $args Hex data (assoc-array) to store.
     */
    ...
    /**
     * @return Hex|array The current Hex data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Hex fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Hex fields).
     */
     ...
     * Load a single Hex.
     *
     * @param HexLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed HexLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Hex|array The loaded Hex as an assoc-array at the
    ...
    /**
     * List Hex items matching the given filter.
     *
     * @param HexListMatch|array|null $reqmatch Match filter (any subset
     *   of Hex fields) as an assoc-array; HexListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Hex[]|array A list of Hex items as assoc-arrays at
     ...
     * Create a new Hex.
     *
     * @param HexCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed HexCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Hex|array The created Hex as an assoc-array at the
     *   SDK boundary; throws CloudsmithError on failure (item-5 convention).
     */
     ...
     *
     * @param HexUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed HexUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Hex|array The updated Hex as an assoc-array at the
     *   SDK boundary; throws CloudsmithError on failure (item-5 convention).
     */
