...
class DependencyEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new DependencyEntity($this->_client, $opts);
    }

    /**
     * @param Dependency|array $args Dependency data (assoc-array) to store.
     */
    ...
    /**
     * @return Dependency|array The current Dependency data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Dependency fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Dependency fields).
     */
