...
class OrganizationMembershipRoleUpdateEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "organization_membership_role_update";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new OrganizationMembershipRoleUpdateEntity($this->_client, $opts);
    }

    /**
     * @param OrganizationMembershipRoleUpdate|array $args OrganizationMembershipRoleUpdate data (assoc-array) to store.
     */
    ...
    /**
     * @return OrganizationMembershipRoleUpdate|array The current OrganizationMembershipRoleUpdate data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of OrganizationMembershipRoleUpdate fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of OrganizationMembershipRoleUpdate fields).
     */
    ...
    /**
     * Update an existing OrganizationMembershipRoleUpdate.
     *
     * @param OrganizationMembershipRoleUpdateUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed OrganizationMembershipRoleUpdateUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return OrganizationMembershipRoleUpdate|array The updated OrganizationMembershipRoleUpdate as an assoc-array at the
