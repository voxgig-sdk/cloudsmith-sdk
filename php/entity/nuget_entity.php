...
class NugetEntity
{
     ...
     * Load a single Nuget.
     *
     * @param NugetLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed NugetLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Nuget|array The loaded Nuget as an assoc-array at the
     ...
     *
     * @param NugetListMatch|array|null $reqmatch Match filter (any subset
     *   of Nuget fields) as an assoc-array; NugetListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Nuget[]|array A list of Nuget items as assoc-arrays at
     ...
     * Create a new Nuget.
     *
     * @param NugetCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed NugetCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Nuget|array The created Nuget as an assoc-array at the
     *   SDK boundary; throws CloudsmithError on failure (item-5 convention).
     */
