...
// Cloudsmith SDK StorageRegion entity
...
class StorageRegionEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new StorageRegionEntity($this->_client, $opts);
    }

    /**
     * @param StorageRegion|array $args StorageRegion data (assoc-array) to store.
     */
    ...
    /**
     * @return StorageRegion|array The current StorageRegion data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of StorageRegion fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of StorageRegion fields).
     */
    ...
    /**
     * Load a single StorageRegion.
     *
     * @param StorageRegionLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed StorageRegionLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return StorageRegion|array The loaded StorageRegion as an assoc-array at the
    ...
    /**
     * List StorageRegion items matching the given filter.
     *
     * @param StorageRegionListMatch|array|null $reqmatch Match filter (any subset
     *   of StorageRegion fields) as an assoc-array; StorageRegionListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return StorageRegion[]|array A list of StorageRegion items as assoc-arrays at
