...
class RepositoryX509EcdsaCertificateEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "repository_x509_ecdsa_certificate";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new RepositoryX509EcdsaCertificateEntity($this->_client, $opts);
    }

    /**
     * @param RepositoryX509EcdsaCertificate|array $args RepositoryX509EcdsaCertificate data (assoc-array) to store.
     */
    ...
    /**
     * @return RepositoryX509EcdsaCertificate|array The current RepositoryX509EcdsaCertificate data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of RepositoryX509EcdsaCertificate fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of RepositoryX509EcdsaCertificate fields).
     */
    ...
    /**
     * Load a single RepositoryX509EcdsaCertificate.
     *
     * @param RepositoryX509EcdsaCertificateLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed RepositoryX509EcdsaCertificateLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return RepositoryX509EcdsaCertificate|array The loaded RepositoryX509EcdsaCertificate as an assoc-array at the
