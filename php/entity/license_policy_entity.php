...
class LicensePolicyEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new LicensePolicyEntity($this->_client, $opts);
    }

    /**
     * @param LicensePolicy|array $args LicensePolicy data (assoc-array) to store.
     */
    ...
    /**
     * @return LicensePolicy|array The current LicensePolicy data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of LicensePolicy fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of LicensePolicy fields).
     */
