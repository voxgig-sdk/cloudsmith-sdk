...
class RepositoryGpgKeyEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new RepositoryGpgKeyEntity($this->_client, $opts);
    }

    /**
     * @param RepositoryGpgKey|array $args RepositoryGpgKey data (assoc-array) to store.
     */
    ...
    /**
     * @return RepositoryGpgKey|array The current RepositoryGpgKey data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of RepositoryGpgKey fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of RepositoryGpgKey fields).
     */
    ...
    /**
     * Load a single RepositoryGpgKey.
     *
     * @param RepositoryGpgKeyLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed RepositoryGpgKeyLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return RepositoryGpgKey|array The loaded RepositoryGpgKey as an assoc-array at the
    ...
    /**
     * Create a new RepositoryGpgKey.
     *
     * @param RepositoryGpgKeyCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed RepositoryGpgKeyCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return RepositoryGpgKey|array The created RepositoryGpgKey as an assoc-array at the
     *   SDK boundary; throws CloudsmithError on failure (item-5 convention).
     */
