...
class ResetEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ResetEntity($this->_client, $opts);
    }

    /**
     * @param Reset|array $args Reset data (assoc-array) to store.
     */
    ...
    /**
     * @return Reset|array The current Reset data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Reset fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Reset fields).
     */
