...
class CondaEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new CondaEntity($this->_client, $opts);
    }

    /**
     * @param Conda|array $args Conda data (assoc-array) to store.
     */
    ...
    /**
     * @return Conda|array The current Conda data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Conda fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Conda fields).
     */
     ...
     * Load a single Conda.
     *
     * @param CondaLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed CondaLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Conda|array The loaded Conda as an assoc-array at the
    ...
    /**
     * List Conda items matching the given filter.
     *
     * @param CondaListMatch|array|null $reqmatch Match filter (any subset
     *   of Conda fields) as an assoc-array; CondaListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Conda[]|array A list of Conda items as assoc-arrays at
     ...
     * Create a new Conda.
     *
     * @param CondaCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed CondaCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Conda|array The created Conda as an assoc-array at the
     *   SDK boundary; throws CloudsmithError on failure (item-5 convention).
     */
    ...
    /**
     * Update an existing Conda.
     *
     * @param CondaUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed CondaUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Conda|array The updated Conda as an assoc-array at the
     *   SDK boundary; throws CloudsmithError on failure (item-5 convention).
     */
