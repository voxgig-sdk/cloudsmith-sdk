...
class StatusBasicEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new StatusBasicEntity($this->_client, $opts);
    }

    /**
     * @param StatusBasic|array $args StatusBasic data (assoc-array) to store.
     */
    ...
    /**
     * @return StatusBasic|array The current StatusBasic data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of StatusBasic fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of StatusBasic fields).
     */
    ...
    /**
     * Load a single StatusBasic.
     *
     * @param StatusBasicLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed StatusBasicLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return StatusBasic|array The loaded StatusBasic as an assoc-array at the
