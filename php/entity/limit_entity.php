...
class LimitEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new LimitEntity($this->_client, $opts);
    }

    /**
     * @param Limit|array $args Limit data (assoc-array) to store.
     */
    ...
    /**
     * @return Limit|array The current Limit data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Limit fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Limit fields).
     */
