...
// Cloudsmith SDK ProviderSetting entity
...
class ProviderSettingEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ProviderSettingEntity($this->_client, $opts);
    }

    /**
     * @param ProviderSetting|array $args ProviderSetting data (assoc-array) to store.
     */
    ...
    /**
     * @return ProviderSetting|array The current ProviderSetting data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ProviderSetting fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ProviderSetting fields).
     */
    ...
    /**
     * Load a single ProviderSetting.
     *
     * @param ProviderSettingLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ProviderSettingLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ProviderSetting|array The loaded ProviderSetting as an assoc-array at the
    ...
    /**
     * List ProviderSetting items matching the given filter.
     *
     * @param ProviderSettingListMatch|array|null $reqmatch Match filter (any subset
     *   of ProviderSetting fields) as an assoc-array; ProviderSettingListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ProviderSetting[]|array A list of ProviderSetting items as assoc-arrays at
