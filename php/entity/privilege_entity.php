...
class PrivilegeEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new PrivilegeEntity($this->_client, $opts);
    }

    /**
     * @param Privilege|array $args Privilege data (assoc-array) to store.
     */
    ...
    /**
     * @return Privilege|array The current Privilege data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Privilege fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Privilege fields).
     */
