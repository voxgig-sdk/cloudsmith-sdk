...
class CargoEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new CargoEntity($this->_client, $opts);
    }

    /**
     * @param Cargo|array $args Cargo data (assoc-array) to store.
     */
    ...
    /**
     * @return Cargo|array The current Cargo data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Cargo fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Cargo fields).
     */
     ...
     * Load a single Cargo.
     *
     * @param CargoLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed CargoLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Cargo|array The loaded Cargo as an assoc-array at the
    ...
    /**
     * List Cargo items matching the given filter.
     *
     * @param CargoListMatch|array|null $reqmatch Match filter (any subset
     *   of Cargo fields) as an assoc-array; CargoListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Cargo[]|array A list of Cargo items as assoc-arrays at
     ...
     * Create a new Cargo.
     *
     * @param CargoCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed CargoCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Cargo|array The created Cargo as an assoc-array at the
     *   SDK boundary; throws CloudsmithError on failure (item-5 convention).
     */
     ...
     *
     * @param CargoUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed CargoUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Cargo|array The updated Cargo as an assoc-array at the
     *   SDK boundary; throws CloudsmithError on failure (item-5 convention).
     */
