...
class EvaluationEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new EvaluationEntity($this->_client, $opts);
    }

    /**
     * @param Evaluation|array $args Evaluation data (assoc-array) to store.
     */
    ...
    /**
     * @return Evaluation|array The current Evaluation data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Evaluation fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Evaluation fields).
     */
