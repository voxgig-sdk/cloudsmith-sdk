...
// Cloudsmith SDK OrganizationPackageLicensePolicy entity
...
class OrganizationPackageLicensePolicyEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "organization_package_license_policy";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new OrganizationPackageLicensePolicyEntity($this->_client, $opts);
    }

    /**
     * @param OrganizationPackageLicensePolicy|array $args OrganizationPackageLicensePolicy data (assoc-array) to store.
     */
    ...
    /**
     * @return OrganizationPackageLicensePolicy|array The current OrganizationPackageLicensePolicy data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of OrganizationPackageLicensePolicy fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of OrganizationPackageLicensePolicy fields).
     */
    ...
    /**
     * Load a single OrganizationPackageLicensePolicy.
     *
     * @param OrganizationPackageLicensePolicyLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed OrganizationPackageLicensePolicyLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return OrganizationPackageLicensePolicy|array The loaded OrganizationPackageLicensePolicy as an assoc-array at the
    ...
    /**
     * List OrganizationPackageLicensePolicy items matching the given filter.
     *
     * @param OrganizationPackageLicensePolicyListMatch|array|null $reqmatch Match filter (any subset
     *   of OrganizationPackageLicensePolicy fields) as an assoc-array; OrganizationPackageLicensePolicyListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return OrganizationPackageLicensePolicy[]|array A list of OrganizationPackageLicensePolicy items as assoc-arrays at
    ...
    /**
     * Create a new OrganizationPackageLicensePolicy.
     *
     * @param OrganizationPackageLicensePolicyCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed OrganizationPackageLicensePolicyCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return OrganizationPackageLicensePolicy|array The created OrganizationPackageLicensePolicy as an assoc-array at the
     *   SDK boundary; throws CloudsmithError on failure (item-5 convention).
     */
    ...
    /**
     * Update an existing OrganizationPackageLicensePolicy.
     *
     * @param OrganizationPackageLicensePolicyUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed OrganizationPackageLicensePolicyUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return OrganizationPackageLicensePolicy|array The updated OrganizationPackageLicensePolicy as an assoc-array at the
     *   SDK boundary; throws CloudsmithError on failure (item-5 convention).
     */
