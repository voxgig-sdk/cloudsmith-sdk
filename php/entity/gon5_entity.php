...
class Gon5Entity
{
    ...
    {
        $opts = $this->_entopts;
        return new Gon5Entity($this->_client, $opts);
    }

    /**
     * @param Gon5|array $args Gon5 data (assoc-array) to store.
     */
    ...
    /**
     * @return Gon5|array The current Gon5 data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Gon5 fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Gon5 fields).
     */
     ...
     * Create a new Gon5.
     *
     * @param Gon5CreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed Gon5CreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Gon5|array The created Gon5 as an assoc-array at the
