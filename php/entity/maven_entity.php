...
class MavenEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new MavenEntity($this->_client, $opts);
    }

    /**
     * @param Maven|array $args Maven data (assoc-array) to store.
     */
    ...
    /**
     * @return Maven|array The current Maven data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Maven fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Maven fields).
     */
     ...
     * Load a single Maven.
     *
     * @param MavenLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed MavenLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Maven|array The loaded Maven as an assoc-array at the
    ...
    /**
     * List Maven items matching the given filter.
     *
     * @param MavenListMatch|array|null $reqmatch Match filter (any subset
     *   of Maven fields) as an assoc-array; MavenListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Maven[]|array A list of Maven items as assoc-arrays at
     ...
     * Create a new Maven.
     *
     * @param MavenCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed MavenCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Maven|array The created Maven as an assoc-array at the
     *   SDK boundary; throws CloudsmithError on failure (item-5 convention).
     */
    ...
    /**
     * Update an existing Maven.
     *
     * @param MavenUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed MavenUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Maven|array The updated Maven as an assoc-array at the
     *   SDK boundary; throws CloudsmithError on failure (item-5 convention).
     */
