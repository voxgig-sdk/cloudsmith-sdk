...
class LuarockEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new LuarockEntity($this->_client, $opts);
    }

    /**
     * @param Luarock|array $args Luarock data (assoc-array) to store.
     */
    ...
    /**
     * @return Luarock|array The current Luarock data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Luarock fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Luarock fields).
     */
