...
// Cloudsmith SDK PackageLicensePolicyEvaluation entity
...
class PackageLicensePolicyEvaluationEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "package_license_policy_evaluation";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new PackageLicensePolicyEvaluationEntity($this->_client, $opts);
    }

    /**
     * @param PackageLicensePolicyEvaluation|array $args PackageLicensePolicyEvaluation data (assoc-array) to store.
     */
    ...
    /**
     * @return PackageLicensePolicyEvaluation|array The current PackageLicensePolicyEvaluation data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of PackageLicensePolicyEvaluation fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of PackageLicensePolicyEvaluation fields).
     */
    ...
    /**
     * Load a single PackageLicensePolicyEvaluation.
     *
     * @param PackageLicensePolicyEvaluationLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed PackageLicensePolicyEvaluationLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return PackageLicensePolicyEvaluation|array The loaded PackageLicensePolicyEvaluation as an assoc-array at the
    ...
    /**
     * List PackageLicensePolicyEvaluation items matching the given filter.
     *
     * @param PackageLicensePolicyEvaluationListMatch|array|null $reqmatch Match filter (any subset
     *   of PackageLicensePolicyEvaluation fields) as an assoc-array; PackageLicensePolicyEvaluationListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return PackageLicensePolicyEvaluation[]|array A list of PackageLicensePolicyEvaluation items as assoc-arrays at
    ...
    /**
     * Create a new PackageLicensePolicyEvaluation.
     *
     * @param PackageLicensePolicyEvaluationCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed PackageLicensePolicyEvaluationCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return PackageLicensePolicyEvaluation|array The created PackageLicensePolicyEvaluation as an assoc-array at the
     *   SDK boundary; throws CloudsmithError on failure (item-5 convention).
     */
