...
class UserAuthTokenEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new UserAuthTokenEntity($this->_client, $opts);
    }

    /**
     * @param UserAuthToken|array $args UserAuthToken data (assoc-array) to store.
     */
    ...
    /**
     * @return UserAuthToken|array The current UserAuthToken data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of UserAuthToken fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of UserAuthToken fields).
     */
     ...
     *
     * @param UserAuthTokenCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed UserAuthTokenCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return UserAuthToken|array The created UserAuthToken as an assoc-array at the
