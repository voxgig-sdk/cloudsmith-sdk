...
class PackageFileUploadEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "package_file_upload";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new PackageFileUploadEntity($this->_client, $opts);
    }

    /**
     * @param PackageFileUpload|array $args PackageFileUpload data (assoc-array) to store.
     */
    ...
    /**
     * @return PackageFileUpload|array The current PackageFileUpload data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of PackageFileUpload fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of PackageFileUpload fields).
     */
    ...
    /**
     * Create a new PackageFileUpload.
     *
     * @param PackageFileUploadCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed PackageFileUploadCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return PackageFileUpload|array The created PackageFileUpload as an assoc-array at the
