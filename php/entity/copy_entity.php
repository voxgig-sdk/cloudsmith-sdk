...
class CopyEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new CopyEntity($this->_client, $opts);
    }

    /**
     * @param Copy|array $args Copy data (assoc-array) to store.
     */
    ...
    /**
     * @return Copy|array The current Copy data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Copy fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Copy fields).
     */
