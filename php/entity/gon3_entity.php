...
class Gon3Entity
{
    ...
    {
        $opts = $this->_entopts;
        return new Gon3Entity($this->_client, $opts);
    }

    /**
     * @param Gon3|array $args Gon3 data (assoc-array) to store.
     */
    ...
    /**
     * @return Gon3|array The current Gon3 data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Gon3 fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Gon3 fields).
     */
     ...
     *
     * @param Gon3ListMatch|array|null $reqmatch Match filter (any subset
     *   of Gon3 fields) as an assoc-array; Gon3ListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Gon3[]|array A list of Gon3 items as assoc-arrays at
