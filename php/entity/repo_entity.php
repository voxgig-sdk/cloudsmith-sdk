...
class RepoEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new RepoEntity($this->_client, $opts);
    }

    /**
     * @param Repo|array $args Repo data (assoc-array) to store.
     */
    ...
    /**
     * @return Repo|array The current Repo data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Repo fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Repo fields).
     */
     ...
     * Load a single Repo.
     *
     * @param RepoLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed RepoLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Repo|array The loaded Repo as an assoc-array at the
    ...
    /**
     * List Repo items matching the given filter.
     *
     * @param RepoListMatch|array|null $reqmatch Match filter (any subset
     *   of Repo fields) as an assoc-array; RepoListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Repo[]|array A list of Repo items as assoc-arrays at
     ...
     * Create a new Repo.
     *
     * @param RepoCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed RepoCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Repo|array The created Repo as an assoc-array at the
     *   SDK boundary; throws CloudsmithError on failure (item-5 convention).
     */
     ...
     *
     * @param RepoUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed RepoUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Repo|array The updated Repo as an assoc-array at the
     *   SDK boundary; throws CloudsmithError on failure (item-5 convention).
     */
    ...
    /**
     * Remove an Repo matching the given criteria.
     *
     * @param RepoRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; RepoRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Repo|array The removed Repo as an assoc-array at the
     *   SDK boundary; throws CloudsmithError on failure (item-5 convention).
     */
