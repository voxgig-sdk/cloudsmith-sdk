...
class AbortEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new AbortEntity($this->_client, $opts);
    }

    /**
     * @param Abort|array $args Abort data (assoc-array) to store.
     */
    ...
    /**
     * @return Abort|array The current Abort data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Abort fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Abort fields).
     */
