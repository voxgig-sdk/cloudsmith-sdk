...
class InviteEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new InviteEntity($this->_client, $opts);
    }

    /**
     * @param Invite|array $args Invite data (assoc-array) to store.
     */
    ...
    /**
     * @return Invite|array The current Invite data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Invite fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Invite fields).
     */
