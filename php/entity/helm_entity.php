...
class HelmEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new HelmEntity($this->_client, $opts);
    }

    /**
     * @param Helm|array $args Helm data (assoc-array) to store.
     */
    ...
    /**
     * @return Helm|array The current Helm data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Helm fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Helm fields).
     */
     ...
     * Load a single Helm.
     *
     * @param HelmLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed HelmLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Helm|array The loaded Helm as an assoc-array at the
    ...
    /**
     * List Helm items matching the given filter.
     *
     * @param HelmListMatch|array|null $reqmatch Match filter (any subset
     *   of Helm fields) as an assoc-array; HelmListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Helm[]|array A list of Helm items as assoc-arrays at
     ...
     * Create a new Helm.
     *
     * @param HelmCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed HelmCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Helm|array The created Helm as an assoc-array at the
     *   SDK boundary; throws CloudsmithError on failure (item-5 convention).
     */
    ...
    /**
     * Update an existing Helm.
     *
     * @param HelmUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed HelmUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Helm|array The updated Helm as an assoc-array at the
     *   SDK boundary; throws CloudsmithError on failure (item-5 convention).
     */
