...
class SamlGroupSyncEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new SamlGroupSyncEntity($this->_client, $opts);
    }

    /**
     * @param SamlGroupSync|array $args SamlGroupSync data (assoc-array) to store.
     */
    ...
    /**
     * @return SamlGroupSync|array The current SamlGroupSync data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of SamlGroupSync fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of SamlGroupSync fields).
     */
