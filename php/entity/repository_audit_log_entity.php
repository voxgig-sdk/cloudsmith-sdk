...
class RepositoryAuditLogEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "repository_audit_log";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new RepositoryAuditLogEntity($this->_client, $opts);
    }

    /**
     * @param RepositoryAuditLog|array $args RepositoryAuditLog data (assoc-array) to store.
     */
    ...
    /**
     * @return RepositoryAuditLog|array The current RepositoryAuditLog data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of RepositoryAuditLog fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of RepositoryAuditLog fields).
     */
    ...
    /**
     * List RepositoryAuditLog items matching the given filter.
     *
     * @param RepositoryAuditLogListMatch|array|null $reqmatch Match filter (any subset
     *   of RepositoryAuditLog fields) as an assoc-array; RepositoryAuditLogListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return RepositoryAuditLog[]|array A list of RepositoryAuditLog items as assoc-arrays at
