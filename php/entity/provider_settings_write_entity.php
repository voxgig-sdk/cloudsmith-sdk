...
class ProviderSettingsWriteEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "provider_settings_write";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ProviderSettingsWriteEntity($this->_client, $opts);
    }

    /**
     * @param ProviderSettingsWrite|array $args ProviderSettingsWrite data (assoc-array) to store.
     */
    ...
    /**
     * @return ProviderSettingsWrite|array The current ProviderSettingsWrite data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ProviderSettingsWrite fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ProviderSettingsWrite fields).
     */
    ...
    /**
     * Create a new ProviderSettingsWrite.
     *
     * @param ProviderSettingsWriteCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ProviderSettingsWriteCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ProviderSettingsWrite|array The created ProviderSettingsWrite as an assoc-array at the
    ...
    /**
     * Update an existing ProviderSettingsWrite.
     *
     * @param ProviderSettingsWriteUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ProviderSettingsWriteUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ProviderSettingsWrite|array The updated ProviderSettingsWrite as an assoc-array at the
     *   SDK boundary; throws CloudsmithError on failure (item-5 convention).
     */
