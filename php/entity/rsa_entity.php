...
class RsaEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new RsaEntity($this->_client, $opts);
    }

    /**
     * @param Rsa|array $args Rsa data (assoc-array) to store.
     */
    ...
    /**
     * @return Rsa|array The current Rsa data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Rsa fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Rsa fields).
     */
