...
class EcdsaEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new EcdsaEntity($this->_client, $opts);
    }

    /**
     * @param Ecdsa|array $args Ecdsa data (assoc-array) to store.
     */
    ...
    /**
     * @return Ecdsa|array The current Ecdsa data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Ecdsa fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Ecdsa fields).
     */
