...
class X509EcdsaEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new X509EcdsaEntity($this->_client, $opts);
    }

    /**
     * @param X509Ecdsa|array $args X509Ecdsa data (assoc-array) to store.
     */
    ...
    /**
     * @return X509Ecdsa|array The current X509Ecdsa data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of X509Ecdsa fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of X509Ecdsa fields).
     */
