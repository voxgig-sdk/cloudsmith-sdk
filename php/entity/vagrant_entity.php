...
class VagrantEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new VagrantEntity($this->_client, $opts);
    }

    /**
     * @param Vagrant|array $args Vagrant data (assoc-array) to store.
     */
    ...
    /**
     * @return Vagrant|array The current Vagrant data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Vagrant fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Vagrant fields).
     */
