...
class GeoipEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new GeoipEntity($this->_client, $opts);
    }

    /**
     * @param Geoip|array $args Geoip data (assoc-array) to store.
     */
    ...
    /**
     * @return Geoip|array The current Geoip data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Geoip fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Geoip fields).
     */
