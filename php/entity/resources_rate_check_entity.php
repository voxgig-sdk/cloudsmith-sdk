...
class ResourcesRateCheckEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "resources_rate_check";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ResourcesRateCheckEntity($this->_client, $opts);
    }

    /**
     * @param ResourcesRateCheck|array $args ResourcesRateCheck data (assoc-array) to store.
     */
    ...
    /**
     * @return ResourcesRateCheck|array The current ResourcesRateCheck data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ResourcesRateCheck fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ResourcesRateCheck fields).
     */
    ...
    /**
     * Load a single ResourcesRateCheck.
     *
     * @param ResourcesRateCheckLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ResourcesRateCheckLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ResourcesRateCheck|array The loaded ResourcesRateCheck as an assoc-array at the
