...
class GonEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new GonEntity($this->_client, $opts);
    }

    /**
     * @param Gon|array $args Gon data (assoc-array) to store.
     */
    ...
    /**
     * @return Gon|array The current Gon data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Gon fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Gon fields).
     */
