...
class ValidateEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ValidateEntity($this->_client, $opts);
    }

    /**
     * @param Validate|array $args Validate data (assoc-array) to store.
     */
    ...
    /**
     * @return Validate|array The current Validate data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Validate fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Validate fields).
     */
