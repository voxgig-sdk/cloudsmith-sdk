...
class Gon6Entity
{
    ...
    {
        $opts = $this->_entopts;
        return new Gon6Entity($this->_client, $opts);
    }

    /**
     * @param Gon6|array $args Gon6 data (assoc-array) to store.
     */
    ...
    /**
     * @return Gon6|array The current Gon6 data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Gon6 fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Gon6 fields).
     */
     ...
     * Load a single Gon6.
     *
     * @param Gon6LoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed Gon6LoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Gon6|array The loaded Gon6 as an assoc-array at the
