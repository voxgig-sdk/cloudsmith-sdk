...
class GpgEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new GpgEntity($this->_client, $opts);
    }

    /**
     * @param Gpg|array $args Gpg data (assoc-array) to store.
     */
    ...
    /**
     * @return Gpg|array The current Gpg data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Gpg fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Gpg fields).
     */
