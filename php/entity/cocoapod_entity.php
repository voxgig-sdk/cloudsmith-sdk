...
class CocoapodEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new CocoapodEntity($this->_client, $opts);
    }

    /**
     * @param Cocoapod|array $args Cocoapod data (assoc-array) to store.
     */
    ...
    /**
     * @return Cocoapod|array The current Cocoapod data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Cocoapod fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Cocoapod fields).
     */
