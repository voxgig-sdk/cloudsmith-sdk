...
class DisableEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new DisableEntity($this->_client, $opts);
    }

    /**
     * @param Disable|array $args Disable data (assoc-array) to store.
     */
    ...
    /**
     * @return Disable|array The current Disable data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Disable fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Disable fields).
     */
