...
// Cloudsmith SDK Entitlement entity
...
class EntitlementEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new EntitlementEntity($this->_client, $opts);
    }

    /**
     * @param Entitlement|array $args Entitlement data (assoc-array) to store.
     */
    ...
    /**
     * @return Entitlement|array The current Entitlement data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Entitlement fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Entitlement fields).
     */
    ...
    /**
     * Load a single Entitlement.
     *
     * @param EntitlementLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed EntitlementLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Entitlement|array The loaded Entitlement as an assoc-array at the
     ...
     *
     * @param EntitlementCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed EntitlementCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Entitlement|array The created Entitlement as an assoc-array at the
     *   SDK boundary; throws CloudsmithError on failure (item-5 convention).
     */
    ...
    /**
     * Remove an Entitlement matching the given criteria.
     *
     * @param EntitlementRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; EntitlementRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Entitlement|array The removed Entitlement as an assoc-array at the
     *   SDK boundary; throws CloudsmithError on failure (item-5 convention).
     */
