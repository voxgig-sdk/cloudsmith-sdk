...
class TerraformEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new TerraformEntity($this->_client, $opts);
    }

    /**
     * @param Terraform|array $args Terraform data (assoc-array) to store.
     */
    ...
    /**
     * @return Terraform|array The current Terraform data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Terraform fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Terraform fields).
     */
