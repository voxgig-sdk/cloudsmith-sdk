...
class RepositoryGeoIpTestAddressEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "repository_geo_ip_test_address";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new RepositoryGeoIpTestAddressEntity($this->_client, $opts);
    }

    /**
     * @param RepositoryGeoIpTestAddress|array $args RepositoryGeoIpTestAddress data (assoc-array) to store.
     */
    ...
    /**
     * @return RepositoryGeoIpTestAddress|array The current RepositoryGeoIpTestAddress data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of RepositoryGeoIpTestAddress fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of RepositoryGeoIpTestAddress fields).
     */
    ...
    /**
     * Create a new RepositoryGeoIpTestAddress.
     *
     * @param RepositoryGeoIpTestAddressCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed RepositoryGeoIpTestAddressCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return RepositoryGeoIpTestAddress|array The created RepositoryGeoIpTestAddress as an assoc-array at the
