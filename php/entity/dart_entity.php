...
class DartEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new DartEntity($this->_client, $opts);
    }

    /**
     * @param Dart|array $args Dart data (assoc-array) to store.
     */
    ...
    /**
     * @return Dart|array The current Dart data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Dart fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Dart fields).
     */
     ...
     * Load a single Dart.
     *
     * @param DartLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed DartLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Dart|array The loaded Dart as an assoc-array at the
    ...
    /**
     * List Dart items matching the given filter.
     *
     * @param DartListMatch|array|null $reqmatch Match filter (any subset
     *   of Dart fields) as an assoc-array; DartListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Dart[]|array A list of Dart items as assoc-arrays at
     ...
     * Create a new Dart.
     *
     * @param DartCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed DartCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Dart|array The created Dart as an assoc-array at the
     *   SDK boundary; throws CloudsmithError on failure (item-5 convention).
     */
    ...
    /**
     * Update an existing Dart.
     *
     * @param DartUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed DartUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Dart|array The updated Dart as an assoc-array at the
     *   SDK boundary; throws CloudsmithError on failure (item-5 convention).
     */
