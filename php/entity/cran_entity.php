...
class CranEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new CranEntity($this->_client, $opts);
    }

    /**
     * @param Cran|array $args Cran data (assoc-array) to store.
     */
    ...
    /**
     * @return Cran|array The current Cran data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Cran fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Cran fields).
     */
     ...
     * Load a single Cran.
     *
     * @param CranLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed CranLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Cran|array The loaded Cran as an assoc-array at the
    ...
    /**
     * List Cran items matching the given filter.
     *
     * @param CranListMatch|array|null $reqmatch Match filter (any subset
     *   of Cran fields) as an assoc-array; CranListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Cran[]|array A list of Cran items as assoc-arrays at
     ...
     * Create a new Cran.
     *
     * @param CranCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed CranCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Cran|array The created Cran as an assoc-array at the
     *   SDK boundary; throws CloudsmithError on failure (item-5 convention).
     */
    ...
    /**
     * Update an existing Cran.
     *
     * @param CranUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed CranUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Cran|array The updated Cran as an assoc-array at the
     *   SDK boundary; throws CloudsmithError on failure (item-5 convention).
     */
