...
class OssEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new OssEntity($this->_client, $opts);
    }

    /**
     * @param Oss|array $args Oss data (assoc-array) to store.
     */
    ...
    /**
     * @return Oss|array The current Oss data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Oss fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Oss fields).
     */
