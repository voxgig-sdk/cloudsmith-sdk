...
class OrganizationInviteExtendEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "organization_invite_extend";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new OrganizationInviteExtendEntity($this->_client, $opts);
    }

    /**
     * @param OrganizationInviteExtend|array $args OrganizationInviteExtend data (assoc-array) to store.
     */
    ...
    /**
     * @return OrganizationInviteExtend|array The current OrganizationInviteExtend data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of OrganizationInviteExtend fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of OrganizationInviteExtend fields).
     */
    ...
    /**
     * Create a new OrganizationInviteExtend.
     *
     * @param OrganizationInviteExtendCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed OrganizationInviteExtendCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return OrganizationInviteExtend|array The created OrganizationInviteExtend as an assoc-array at the
