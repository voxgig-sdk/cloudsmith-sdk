...
// Cloudsmith SDK OrganizationInvite entity
...
class OrganizationInviteEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "organization_invite";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new OrganizationInviteEntity($this->_client, $opts);
    }

    /**
     * @param OrganizationInvite|array $args OrganizationInvite data (assoc-array) to store.
     */
    ...
    /**
     * @return OrganizationInvite|array The current OrganizationInvite data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of OrganizationInvite fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of OrganizationInvite fields).
     */
    ...
    /**
     * List OrganizationInvite items matching the given filter.
     *
     * @param OrganizationInviteListMatch|array|null $reqmatch Match filter (any subset
     *   of OrganizationInvite fields) as an assoc-array; OrganizationInviteListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return OrganizationInvite[]|array A list of OrganizationInvite items as assoc-arrays at
    ...
    /**
     * Create a new OrganizationInvite.
     *
     * @param OrganizationInviteCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed OrganizationInviteCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return OrganizationInvite|array The created OrganizationInvite as an assoc-array at the
    ...
    /**
     * Update an existing OrganizationInvite.
     *
     * @param OrganizationInviteUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed OrganizationInviteUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return OrganizationInvite|array The updated OrganizationInvite as an assoc-array at the
     *   SDK boundary; throws CloudsmithError on failure (item-5 convention).
     */
