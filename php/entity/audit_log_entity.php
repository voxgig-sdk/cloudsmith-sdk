...
class AuditLogEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new AuditLogEntity($this->_client, $opts);
    }

    /**
     * @param AuditLog|array $args AuditLog data (assoc-array) to store.
     */
    ...
    /**
     * @return AuditLog|array The current AuditLog data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of AuditLog fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of AuditLog fields).
     */
