...
class ResyncEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ResyncEntity($this->_client, $opts);
    }

    /**
     * @param Resync|array $args Resync data (assoc-array) to store.
     */
    ...
    /**
     * @return Resync|array The current Resync data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Resync fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Resync fields).
     */
