...
class RepositoryTokenSyncEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "repository_token_sync";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new RepositoryTokenSyncEntity($this->_client, $opts);
    }

    /**
     * @param RepositoryTokenSync|array $args RepositoryTokenSync data (assoc-array) to store.
     */
    ...
    /**
     * @return RepositoryTokenSync|array The current RepositoryTokenSync data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of RepositoryTokenSync fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of RepositoryTokenSync fields).
     */
    ...
    /**
     * Create a new RepositoryTokenSync.
     *
     * @param RepositoryTokenSyncCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed RepositoryTokenSyncCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return RepositoryTokenSync|array The created RepositoryTokenSync as an assoc-array at the
