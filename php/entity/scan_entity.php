...
class ScanEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ScanEntity($this->_client, $opts);
    }

    /**
     * @param Scan|array $args Scan data (assoc-array) to store.
     */
    ...
    /**
     * @return Scan|array The current Scan data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Scan fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Scan fields).
     */
