...
class FormatEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new FormatEntity($this->_client, $opts);
    }

    /**
     * @param Format|array $args Format data (assoc-array) to store.
     */
    ...
    /**
     * @return Format|array The current Format data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Format fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Format fields).
     */
    ...
    /**
     * Load a single Format.
     *
     * @param FormatLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed FormatLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Format|array The loaded Format as an assoc-array at the
    ...
    /**
     * List Format items matching the given filter.
     *
     * @param FormatListMatch|array|null $reqmatch Match filter (any subset
     *   of Format fields) as an assoc-array; FormatListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Format[]|array A list of Format items as assoc-arrays at
