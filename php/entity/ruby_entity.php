...
class RubyEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new RubyEntity($this->_client, $opts);
    }

    /**
     * @param Ruby|array $args Ruby data (assoc-array) to store.
     */
    ...
    /**
     * @return Ruby|array The current Ruby data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Ruby fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Ruby fields).
     */
     ...
     * Load a single Ruby.
     *
     * @param RubyLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed RubyLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Ruby|array The loaded Ruby as an assoc-array at the
    ...
    /**
     * List Ruby items matching the given filter.
     *
     * @param RubyListMatch|array|null $reqmatch Match filter (any subset
     *   of Ruby fields) as an assoc-array; RubyListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Ruby[]|array A list of Ruby items as assoc-arrays at
     ...
     * Create a new Ruby.
     *
     * @param RubyCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed RubyCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Ruby|array The created Ruby as an assoc-array at the
     *   SDK boundary; throws CloudsmithError on failure (item-5 convention).
     */
    ...
    /**
     * Update an existing Ruby.
     *
     * @param RubyUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed RubyUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Ruby|array The updated Ruby as an assoc-array at the
     *   SDK boundary; throws CloudsmithError on failure (item-5 convention).
     */
