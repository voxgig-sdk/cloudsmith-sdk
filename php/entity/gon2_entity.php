...
class Gon2Entity
{
    ...
    {
        $opts = $this->_entopts;
        return new Gon2Entity($this->_client, $opts);
    }

    /**
     * @param Gon2|array $args Gon2 data (assoc-array) to store.
     */
    ...
    /**
     * @return Gon2|array The current Gon2 data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Gon2 fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Gon2 fields).
     */
