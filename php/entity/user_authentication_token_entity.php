...
class UserAuthenticationTokenEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "user_authentication_token";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new UserAuthenticationTokenEntity($this->_client, $opts);
    }

    /**
     * @param UserAuthenticationToken|array $args UserAuthenticationToken data (assoc-array) to store.
     */
    ...
    /**
     * @return UserAuthenticationToken|array The current UserAuthenticationToken data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of UserAuthenticationToken fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of UserAuthenticationToken fields).
     */
     ...
     *
     * @param UserAuthenticationTokenCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed UserAuthenticationTokenCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return UserAuthenticationToken|array The created UserAuthenticationToken as an assoc-array at the
    ...
    /**
     * Update an existing UserAuthenticationToken.
     *
     * @param UserAuthenticationTokenUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed UserAuthenticationTokenUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return UserAuthenticationToken|array The updated UserAuthenticationToken as an assoc-array at the
     *   SDK boundary; throws CloudsmithError on failure (item-5 convention).
     */
