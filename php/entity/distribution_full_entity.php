...
// Cloudsmith SDK DistributionFull entity
...
class DistributionFullEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new DistributionFullEntity($this->_client, $opts);
    }

    /**
     * @param DistributionFull|array $args DistributionFull data (assoc-array) to store.
     */
    ...
    /**
     * @return DistributionFull|array The current DistributionFull data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of DistributionFull fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of DistributionFull fields).
     */
    ...
    /**
     * Load a single DistributionFull.
     *
     * @param DistributionFullLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed DistributionFullLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return DistributionFull|array The loaded DistributionFull as an assoc-array at the
    ...
    /**
     * List DistributionFull items matching the given filter.
     *
     * @param DistributionFullListMatch|array|null $reqmatch Match filter (any subset
     *   of DistributionFull fields) as an assoc-array; DistributionFullListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return DistributionFull[]|array A list of DistributionFull items as assoc-arrays at
