...
class NamespaceEntity
{
     ...
     *
     * @param NamespaceLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed NamespaceLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Namespace|array The loaded Namespace as an assoc-array at the
     ...
     *
     * @param NamespaceListMatch|array|null $reqmatch Match filter (any subset
     *   of Namespace fields) as an assoc-array; NamespaceListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Namespace[]|array A list of Namespace items as assoc-arrays at
