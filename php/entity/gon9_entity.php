...
class Gon9Entity
{
    ...
    {
        $opts = $this->_entopts;
        return new Gon9Entity($this->_client, $opts);
    }

    /**
     * @param Gon9|array $args Gon9 data (assoc-array) to store.
     */
    ...
    /**
     * @return Gon9|array The current Gon9 data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Gon9 fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Gon9 fields).
     */
    ...
    /**
     * Update an existing Gon9.
     *
     * @param Gon9UpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed Gon9UpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Gon9|array The updated Gon9 as an assoc-array at the
