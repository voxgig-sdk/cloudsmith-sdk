...
class DockerEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new DockerEntity($this->_client, $opts);
    }

    /**
     * @param Docker|array $args Docker data (assoc-array) to store.
     */
    ...
    /**
     * @return Docker|array The current Docker data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Docker fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Docker fields).
     */
    ...
    /**
     * Load a single Docker.
     *
     * @param DockerLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed DockerLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Docker|array The loaded Docker as an assoc-array at the
    ...
    /**
     * List Docker items matching the given filter.
     *
     * @param DockerListMatch|array|null $reqmatch Match filter (any subset
     *   of Docker fields) as an assoc-array; DockerListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Docker[]|array A list of Docker items as assoc-arrays at
     ...
     * Create a new Docker.
     *
     * @param DockerCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed DockerCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Docker|array The created Docker as an assoc-array at the
     *   SDK boundary; throws CloudsmithError on failure (item-5 convention).
     */
    ...
    /**
     * Update an existing Docker.
     *
     * @param DockerUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed DockerUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Docker|array The updated Docker as an assoc-array at the
     *   SDK boundary; throws CloudsmithError on failure (item-5 convention).
     */
