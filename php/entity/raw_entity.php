...
class RawEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new RawEntity($this->_client, $opts);
    }

    /**
     * @param Raw|array $args Raw data (assoc-array) to store.
     */
    ...
    /**
     * @return Raw|array The current Raw data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Raw fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Raw fields).
     */
