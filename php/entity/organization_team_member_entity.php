...
// Cloudsmith SDK OrganizationTeamMember entity
...
class OrganizationTeamMemberEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "organization_team_member";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new OrganizationTeamMemberEntity($this->_client, $opts);
    }

    /**
     * @param OrganizationTeamMember|array $args OrganizationTeamMember data (assoc-array) to store.
     */
    ...
    /**
     * @return OrganizationTeamMember|array The current OrganizationTeamMember data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of OrganizationTeamMember fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of OrganizationTeamMember fields).
     */
    ...
    /**
     * List OrganizationTeamMember items matching the given filter.
     *
     * @param OrganizationTeamMemberListMatch|array|null $reqmatch Match filter (any subset
     *   of OrganizationTeamMember fields) as an assoc-array; OrganizationTeamMemberListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return OrganizationTeamMember[]|array A list of OrganizationTeamMember items as assoc-arrays at
    ...
    /**
     * Create a new OrganizationTeamMember.
     *
     * @param OrganizationTeamMemberCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed OrganizationTeamMemberCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return OrganizationTeamMember|array The created OrganizationTeamMember as an assoc-array at the
