...
class MoveEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new MoveEntity($this->_client, $opts);
    }

    /**
     * @param Move|array $args Move data (assoc-array) to store.
     */
    ...
    /**
     * @return Move|array The current Move data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Move fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Move fields).
     */
