...
class RepositoryGeoIpStatusEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "repository_geo_ip_status";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new RepositoryGeoIpStatusEntity($this->_client, $opts);
    }

    /**
     * @param RepositoryGeoIpStatus|array $args RepositoryGeoIpStatus data (assoc-array) to store.
     */
    ...
    /**
     * @return RepositoryGeoIpStatus|array The current RepositoryGeoIpStatus data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of RepositoryGeoIpStatus fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of RepositoryGeoIpStatus fields).
     */
    ...
    /**
     * Load a single RepositoryGeoIpStatus.
     *
     * @param RepositoryGeoIpStatusLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed RepositoryGeoIpStatusLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return RepositoryGeoIpStatus|array The loaded RepositoryGeoIpStatus as an assoc-array at the
