...
class QuarantineEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new QuarantineEntity($this->_client, $opts);
    }

    /**
     * @param Quarantine|array $args Quarantine data (assoc-array) to store.
     */
    ...
    /**
     * @return Quarantine|array The current Quarantine data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Quarantine fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Quarantine fields).
     */
