...
class NpmEntity
{
     ...
     * Load a single Npm.
     *
     * @param NpmLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed NpmLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Npm|array The loaded Npm as an assoc-array at the
     ...
     *
     * @param NpmListMatch|array|null $reqmatch Match filter (any subset
     *   of Npm fields) as an assoc-array; NpmListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Npm[]|array A list of Npm items as assoc-arrays at
     ...
     * Create a new Npm.
     *
     * @param NpmCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed NpmCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Npm|array The created Npm as an assoc-array at the
     *   SDK boundary; throws CloudsmithError on failure (item-5 convention).
     */
