...
class RepositoryTokenRefreshEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "repository_token_refresh";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new RepositoryTokenRefreshEntity($this->_client, $opts);
    }

    /**
     * @param RepositoryTokenRefresh|array $args RepositoryTokenRefresh data (assoc-array) to store.
     */
    ...
    /**
     * @return RepositoryTokenRefresh|array The current RepositoryTokenRefresh data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of RepositoryTokenRefresh fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of RepositoryTokenRefresh fields).
     */
    ...
    /**
     * Create a new RepositoryTokenRefresh.
     *
     * @param RepositoryTokenRefreshCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed RepositoryTokenRefreshCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return RepositoryTokenRefresh|array The created RepositoryTokenRefresh as an assoc-array at the
