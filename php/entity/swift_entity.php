...
class SwiftEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new SwiftEntity($this->_client, $opts);
    }

    /**
     * @param Swift|array $args Swift data (assoc-array) to store.
     */
    ...
    /**
     * @return Swift|array The current Swift data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Swift fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Swift fields).
     */
     ...
     * Load a single Swift.
     *
     * @param SwiftLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed SwiftLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Swift|array The loaded Swift as an assoc-array at the
    ...
    /**
     * List Swift items matching the given filter.
     *
     * @param SwiftListMatch|array|null $reqmatch Match filter (any subset
     *   of Swift fields) as an assoc-array; SwiftListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Swift[]|array A list of Swift items as assoc-arrays at
     ...
     * Create a new Swift.
     *
     * @param SwiftCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed SwiftCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Swift|array The created Swift as an assoc-array at the
     *   SDK boundary; throws CloudsmithError on failure (item-5 convention).
     */
    ...
    /**
     * Update an existing Swift.
     *
     * @param SwiftUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed SwiftUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Swift|array The updated Swift as an assoc-array at the
     *   SDK boundary; throws CloudsmithError on failure (item-5 convention).
     */
