...
class Gon3Entity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return Gon3Entity(self._client, opts)
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[Gon3]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.Gon3().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
