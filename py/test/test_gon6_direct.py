...
class TestGon6Direct:

    def test_should_direct_load_gon6(self):
        setup = _gon6_direct_setup({"id": "direct01"})
        _skip, _reason = runner.is_control_skipped("direct", "direct-load-gon6", "live" if setup["live"] else "unit")
        if _skip:
...
def _gon6_direct_setup(mockres):
