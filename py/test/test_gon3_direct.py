...
class TestGon3Direct:

    def test_should_direct_list_gon3(self):
        setup = _gon3_direct_setup([
            {"id": "direct01"},
            {"id": "direct02"},
        ])
        _skip, _reason = runner.is_control_skipped("direct", "direct-list-gon3", "live" if setup["live"] else "unit")
        if _skip:
...
def _gon3_direct_setup(mockres):
