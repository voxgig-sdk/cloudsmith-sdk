...
class TestCondaEntity:
    ...
    def test_should_run_basic_flow(self):
        ...
        conda_ref01_data = helpers.to_map(conda_ref01_ent.create(conda_ref01_data, None))
        ...
        conda_ref01_resdata_up0 = helpers.to_map(conda_ref01_ent.update(conda_ref01_data_up0_up, None))
