...
class TestRepositoryTokenRefreshEntity:
    ...
    def test_should_run_basic_flow(self):
        ...
        repository_token_refresh_ref01_data = helpers.to_map(runner.entity_data(repository_token_refresh_ref01_ent.create(repository_token_refresh_ref01_data, None)))
