# Cloudsmith SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions CloudsmithSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both CloudsmithSDK(...) and CloudsmithSDK.test(...) become
#      CloudsmithSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "cloudsmith_sdk"
_SDK_CLASS = "CloudsmithSDK"
...
_ENTITIES = {
    ...
    "Disable": "disable",
    "DistributionFull": "distribution_full",
    "Distro": "distro",
    "Docker": "docker",
    "DynamicMapping": "dynamic_mapping",
    "Ecdsa": "ecdsa",
    "Enable": "enable",
    ...
    "Move": "move",
    "Namespace": "namespace",
    "NamespaceAuditLog": "namespace_audit_log",
    "Npm": "npm",
    "Nuget": "nuget",
    "OpenidConnect": "openid_connect",
    "Org": "org",
    "OrganizationGroupSync": "organization_group_sync",
    "OrganizationGroupSyncStatus": "organization_group_sync_status",
    "OrganizationInvite": "organization_invite",
    "OrganizationInviteExtend": "organization_invite_extend",
    "OrganizationMembership": "organization_membership",
    "OrganizationMembershipRoleUpdate": "organization_membership_role_update",
    "OrganizationMembershipVisibilityUpdate": "organization_membership_visibility_update",
    "OrganizationPackageLicensePolicy": "organization_package_license_policy",
    "OrganizationPackageVulnerabilityPolicy": "organization_package_vulnerability_policy",
    "OrganizationSamlAuth": "organization_saml_auth",
    "OrganizationTeam": "organization_team",
    "OrganizationTeamMember": "organization_team_member",
    "Oss": "oss",
    "P2n": "p2n",
    "P2n2": "p2n2",
    "Package": "package",
    "PackageDenyPolicy": "package_deny_policy",
    "PackageFilePartsUpload": "package_file_parts_upload",
    "PackageFileUpload": "package_file_upload",
    "PackageLicensePolicyEvaluation": "package_license_policy_evaluation",
    "PackageVersionBadge": "package_version_badge",
    "PackageVulnerabilityPolicyEvaluation": "package_vulnerability_policy_evaluation",
    "Privilege": "privilege",
    "Profile": "profile",
    "ProviderSetting": "provider_setting",
    "ProviderSettingsWrite": "provider_settings_write",
    "Python": "python",
    ...
    "Repo": "repo",
    "RepositoryAuditLog": "repository_audit_log",
    "RepositoryEcdsaKey": "repository_ecdsa_key",
    "RepositoryGeoIpRule": "repository_geo_ip_rule",
    "RepositoryGeoIpStatus": "repository_geo_ip_status",
    "RepositoryGeoIpTestAddress": "repository_geo_ip_test_address",
    "RepositoryGpgKey": "repository_gpg_key",
    "RepositoryPrivilegeInput": "repository_privilege_input",
    "RepositoryRetentionRule": "repository_retention_rule",
    "RepositoryRsaKey": "repository_rsa_key",
    "RepositoryToken": "repository_token",
    "RepositoryTokenRefresh": "repository_token_refresh",
    "RepositoryTokenSync": "repository_token_sync",
    "RepositoryWebhook": "repository_webhook",
    "RepositoryX509EcdsaCertificate": "repository_x509_ecdsa_certificate",
    "RepositoryX509RsaCertificate": "repository_x509_rsa_certificate",
    "Reset": "reset",
    "ResourcesRateCheck": "resources_rate_check",
    "Resync": "resync",
    "Retention": "retention",
    "Rpm": "rpm",
    "Rsa": "rsa",
    "Ruby": "ruby",
    "SamlGroupSync": "saml_group_sync",
    "Scan": "scan",
    "Self": "self",
    "Service": "service",
    "Status": "status",
    "StatusBasic": "status_basic",
    ...
    "Test": "test",
    "Token": "token",
    "TransferRegion": "transfer_region",
    "User": "user",
    "UserAuthToken": "user_auth_token",
    "UserAuthenticationToken": "user_authentication_token",
