...
class ResourcesRateCheckEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ResourcesRateCheckEntity(self._client, opts)
    ...
    def data_get(self) -> ResourcesRateCheck:
    ...
    def match_get(self) -> ResourcesRateCheck:
    ...
    def load(self, reqmatch=None, ctrl=None) -> ResourcesRateCheck:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.ResourcesRateCheck().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
