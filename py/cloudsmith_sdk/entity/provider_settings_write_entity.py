...
class ProviderSettingsWriteEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ProviderSettingsWriteEntity(self._client, opts)
    ...
    def data_get(self) -> ProviderSettingsWrite:
    ...
    def match_get(self) -> ProviderSettingsWrite:
    ...
    def create(self, reqdata: ProviderSettingsWriteCreateData, ctrl=None) -> ProviderSettingsWrite:
        utility = self._utility
    ...
    def update(self, reqdata: ProviderSettingsWriteUpdateData, ctrl=None) -> ProviderSettingsWrite:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "update",
            "ctrl": ctrl,
