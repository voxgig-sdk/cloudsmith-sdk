...
class OrganizationMembershipRoleUpdateEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return OrganizationMembershipRoleUpdateEntity(self._client, opts)
    ...
    def data_get(self) -> OrganizationMembershipRoleUpdate:
    ...
    def match_get(self) -> OrganizationMembershipRoleUpdate:
    ...
    def update(self, reqdata: OrganizationMembershipRoleUpdateUpdateData, ctrl=None) -> OrganizationMembershipRoleUpdate:
        utility = self._utility
