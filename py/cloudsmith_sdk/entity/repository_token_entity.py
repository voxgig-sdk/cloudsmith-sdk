...
from cloudsmith_sdk.cloudsmith_types import (
    RepositoryToken,
    RepositoryTokenLoadMatch,
    RepositoryTokenListMatch,
    RepositoryTokenCreateData,
    RepositoryTokenUpdateData,
)
...
class RepositoryTokenEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return RepositoryTokenEntity(self._client, opts)
    ...
    def data_get(self) -> RepositoryToken:
    ...
    def match_get(self) -> RepositoryToken:
    ...
    def load(self, reqmatch=None, ctrl=None) -> RepositoryToken:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.RepositoryToken().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[RepositoryToken]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.RepositoryToken().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
        ctx = utility.make_context({
            "opname": "list",
    ...
    def create(self, reqdata: RepositoryTokenCreateData, ctrl=None) -> RepositoryToken:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "create",
            "ctrl": ctrl,
    ...
    def update(self, reqdata: RepositoryTokenUpdateData, ctrl=None) -> RepositoryToken:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "update",
            "ctrl": ctrl,
