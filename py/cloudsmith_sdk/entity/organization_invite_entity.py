...
class OrganizationInviteEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return OrganizationInviteEntity(self._client, opts)
    ...
    def data_get(self) -> OrganizationInvite:
    ...
    def match_get(self) -> OrganizationInvite:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[OrganizationInvite]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.OrganizationInvite().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
    ...
    def create(self, reqdata: OrganizationInviteCreateData, ctrl=None) -> OrganizationInvite:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "create",
            "ctrl": ctrl,
    ...
    def update(self, reqdata: OrganizationInviteUpdateData, ctrl=None) -> OrganizationInvite:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "update",
            "ctrl": ctrl,
