...
class RepositoryAuditLogEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return RepositoryAuditLogEntity(self._client, opts)
    ...
    def data_get(self) -> RepositoryAuditLog:
    ...
    def match_get(self) -> RepositoryAuditLog:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[RepositoryAuditLog]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.RepositoryAuditLog().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
