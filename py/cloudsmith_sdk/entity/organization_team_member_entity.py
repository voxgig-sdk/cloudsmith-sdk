...
class OrganizationTeamMemberEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return OrganizationTeamMemberEntity(self._client, opts)
    ...
    def data_get(self) -> OrganizationTeamMember:
    ...
    def match_get(self) -> OrganizationTeamMember:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[OrganizationTeamMember]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.OrganizationTeamMember().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
    ...
    def create(self, reqdata: OrganizationTeamMemberCreateData, ctrl=None) -> OrganizationTeamMember:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "create",
            "ctrl": ctrl,
