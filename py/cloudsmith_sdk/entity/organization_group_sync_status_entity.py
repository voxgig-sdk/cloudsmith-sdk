...
class OrganizationGroupSyncStatusEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return OrganizationGroupSyncStatusEntity(self._client, opts)
    ...
    def data_get(self) -> OrganizationGroupSyncStatus:
    ...
    def match_get(self) -> OrganizationGroupSyncStatus:
    ...
    def load(self, reqmatch=None, ctrl=None) -> OrganizationGroupSyncStatus:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.OrganizationGroupSyncStatus().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
