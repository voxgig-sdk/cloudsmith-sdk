...
class RepositoryGeoIpStatusEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return RepositoryGeoIpStatusEntity(self._client, opts)
    ...
    def data_get(self) -> RepositoryGeoIpStatus:
    ...
    def match_get(self) -> RepositoryGeoIpStatus:
    ...
    def load(self, reqmatch=None, ctrl=None) -> RepositoryGeoIpStatus:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.RepositoryGeoIpStatus().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
