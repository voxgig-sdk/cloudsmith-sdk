...
class UserAuthenticationTokenEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return UserAuthenticationTokenEntity(self._client, opts)
    ...
    def data_get(self) -> UserAuthenticationToken:
    ...
    def match_get(self) -> UserAuthenticationToken:
    ...
    def create(self, reqdata: UserAuthenticationTokenCreateData, ctrl=None) -> UserAuthenticationToken:
        utility = self._utility
    ...
    def update(self, reqdata: UserAuthenticationTokenUpdateData, ctrl=None) -> UserAuthenticationToken:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "update",
            "ctrl": ctrl,
