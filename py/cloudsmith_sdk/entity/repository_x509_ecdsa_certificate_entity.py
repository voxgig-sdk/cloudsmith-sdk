...
class RepositoryX509EcdsaCertificateEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return RepositoryX509EcdsaCertificateEntity(self._client, opts)
    ...
    def data_get(self) -> RepositoryX509EcdsaCertificate:
    ...
    def match_get(self) -> RepositoryX509EcdsaCertificate:
    ...
    def load(self, reqmatch=None, ctrl=None) -> RepositoryX509EcdsaCertificate:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.RepositoryX509EcdsaCertificate().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
