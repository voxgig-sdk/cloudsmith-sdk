...
class RepositoryGeoIpTestAddressEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return RepositoryGeoIpTestAddressEntity(self._client, opts)
    ...
    def data_get(self) -> RepositoryGeoIpTestAddress:
    ...
    def match_get(self) -> RepositoryGeoIpTestAddress:
    ...
    def create(self, reqdata: RepositoryGeoIpTestAddressCreateData, ctrl=None) -> RepositoryGeoIpTestAddress:
        utility = self._utility
