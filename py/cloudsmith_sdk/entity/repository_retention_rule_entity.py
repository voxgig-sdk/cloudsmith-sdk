...
class RepositoryRetentionRuleEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return RepositoryRetentionRuleEntity(self._client, opts)
    ...
    def data_get(self) -> RepositoryRetentionRule:
    ...
    def match_get(self) -> RepositoryRetentionRule:
    ...
    def load(self, reqmatch=None, ctrl=None) -> RepositoryRetentionRule:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.RepositoryRetentionRule().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
    ...
    def update(self, reqdata: RepositoryRetentionRuleUpdateData, ctrl=None) -> RepositoryRetentionRule:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "update",
            "ctrl": ctrl,
