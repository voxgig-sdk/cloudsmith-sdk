...
class OrganizationInviteExtendEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return OrganizationInviteExtendEntity(self._client, opts)
    ...
    def data_get(self) -> OrganizationInviteExtend:
    ...
    def match_get(self) -> OrganizationInviteExtend:
    ...
    def create(self, reqdata: OrganizationInviteExtendCreateData, ctrl=None) -> OrganizationInviteExtend:
        utility = self._utility
