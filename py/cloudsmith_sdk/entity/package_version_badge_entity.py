...
class PackageVersionBadgeEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return PackageVersionBadgeEntity(self._client, opts)
    ...
    def data_get(self) -> PackageVersionBadge:
    ...
    def match_get(self) -> PackageVersionBadge:
    ...
    def load(self, reqmatch=None, ctrl=None) -> PackageVersionBadge:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.PackageVersionBadge().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
