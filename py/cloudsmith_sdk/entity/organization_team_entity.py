...
class OrganizationTeamEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return OrganizationTeamEntity(self._client, opts)
    ...
    def data_get(self) -> OrganizationTeam:
    ...
    def match_get(self) -> OrganizationTeam:
    ...
    def load(self, reqmatch=None, ctrl=None) -> OrganizationTeam:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.OrganizationTeam().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[OrganizationTeam]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.OrganizationTeam().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
        ctx = utility.make_context({
            "opname": "list",
    ...
    def create(self, reqdata: OrganizationTeamCreateData, ctrl=None) -> OrganizationTeam:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "create",
            "ctrl": ctrl,
    ...
    def update(self, reqdata: OrganizationTeamUpdateData, ctrl=None) -> OrganizationTeam:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "update",
            "ctrl": ctrl,
