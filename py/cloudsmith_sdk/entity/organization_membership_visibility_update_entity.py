...
class OrganizationMembershipVisibilityUpdateEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return OrganizationMembershipVisibilityUpdateEntity(self._client, opts)
    ...
    def data_get(self) -> OrganizationMembershipVisibilityUpdate:
    ...
    def match_get(self) -> OrganizationMembershipVisibilityUpdate:
    ...
    def update(self, reqdata: OrganizationMembershipVisibilityUpdateUpdateData, ctrl=None) -> OrganizationMembershipVisibilityUpdate:
        utility = self._utility
