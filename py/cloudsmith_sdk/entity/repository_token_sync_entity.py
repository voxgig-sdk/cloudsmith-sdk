...
class RepositoryTokenSyncEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return RepositoryTokenSyncEntity(self._client, opts)
    ...
    def data_get(self) -> RepositoryTokenSync:
    ...
    def match_get(self) -> RepositoryTokenSync:
    ...
    def create(self, reqdata: RepositoryTokenSyncCreateData, ctrl=None) -> RepositoryTokenSync:
        utility = self._utility
