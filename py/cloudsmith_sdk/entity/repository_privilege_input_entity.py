...
from cloudsmith_sdk.cloudsmith_types import (
    ...
    RepositoryPrivilegeInputListMatch,
)
...
class RepositoryPrivilegeInputEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return RepositoryPrivilegeInputEntity(self._client, opts)
    ...
    def data_get(self) -> RepositoryPrivilegeInput:
    ...
    def match_get(self) -> RepositoryPrivilegeInput:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[RepositoryPrivilegeInput]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.RepositoryPrivilegeInput().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
