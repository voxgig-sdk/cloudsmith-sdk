...
class OrganizationGroupSyncEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return OrganizationGroupSyncEntity(self._client, opts)
    ...
    def data_get(self) -> OrganizationGroupSync:
    ...
    def match_get(self) -> OrganizationGroupSync:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[OrganizationGroupSync]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.OrganizationGroupSync().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
    ...
    def create(self, reqdata: OrganizationGroupSyncCreateData, ctrl=None) -> OrganizationGroupSync:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "create",
            "ctrl": ctrl,
