...
class PackageFilePartsUploadEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return PackageFilePartsUploadEntity(self._client, opts)
    ...
    def data_get(self) -> PackageFilePartsUpload:
    ...
    def match_get(self) -> PackageFilePartsUpload:
    ...
    def load(self, reqmatch=None, ctrl=None) -> PackageFilePartsUpload:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.PackageFilePartsUpload().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
