...
class UserAuthTokenEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return UserAuthTokenEntity(self._client, opts)
    ...
    def data_get(self) -> UserAuthToken:
    ...
    def match_get(self) -> UserAuthToken:
    ...
    def create(self, reqdata: UserAuthTokenCreateData, ctrl=None) -> UserAuthToken:
        utility = self._utility
