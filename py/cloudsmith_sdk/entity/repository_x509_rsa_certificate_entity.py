...
class RepositoryX509RsaCertificateEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return RepositoryX509RsaCertificateEntity(self._client, opts)
    ...
    def data_get(self) -> RepositoryX509RsaCertificate:
    ...
    def match_get(self) -> RepositoryX509RsaCertificate:
    ...
    def load(self, reqmatch=None, ctrl=None) -> RepositoryX509RsaCertificate:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.RepositoryX509RsaCertificate().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
