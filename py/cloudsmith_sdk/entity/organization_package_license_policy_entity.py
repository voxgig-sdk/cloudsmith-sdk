...
from cloudsmith_sdk.cloudsmith_types import (
...
class OrganizationPackageLicensePolicyEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return OrganizationPackageLicensePolicyEntity(self._client, opts)
    ...
    def data_get(self) -> OrganizationPackageLicensePolicy:
    ...
    def match_get(self) -> OrganizationPackageLicensePolicy:
    ...
    def load(self, reqmatch=None, ctrl=None) -> OrganizationPackageLicensePolicy:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.OrganizationPackageLicensePolicy().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[OrganizationPackageLicensePolicy]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.OrganizationPackageLicensePolicy().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
        ctx = utility.make_context({
            "opname": "list",
    ...
    def create(self, reqdata: OrganizationPackageLicensePolicyCreateData, ctrl=None) -> OrganizationPackageLicensePolicy:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "create",
            "ctrl": ctrl,
    ...
    def update(self, reqdata: OrganizationPackageLicensePolicyUpdateData, ctrl=None) -> OrganizationPackageLicensePolicy:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "update",
            "ctrl": ctrl,
