...
class StatusBasicEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return StatusBasicEntity(self._client, opts)
    ...
    def match_get(self) -> StatusBasic:
    ...
    def load(self, reqmatch=None, ctrl=None) -> StatusBasic:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.StatusBasic().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
