...
class PackageFileUploadEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return PackageFileUploadEntity(self._client, opts)
    ...
    def data_get(self) -> PackageFileUpload:
    ...
    def match_get(self) -> PackageFileUpload:
    ...
    def create(self, reqdata: PackageFileUploadCreateData, ctrl=None) -> PackageFileUpload:
        utility = self._utility
