...
class RepositoryTokenRefreshEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return RepositoryTokenRefreshEntity(self._client, opts)
    ...
    def data_get(self) -> RepositoryTokenRefresh:
    ...
    def match_get(self) -> RepositoryTokenRefresh:
    ...
    def create(self, reqdata: RepositoryTokenRefreshCreateData, ctrl=None) -> RepositoryTokenRefresh:
        utility = self._utility
