...
class NamespaceAuditLogEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return NamespaceAuditLogEntity(self._client, opts)
    ...
    def data_get(self) -> NamespaceAuditLog:
    ...
    def match_get(self) -> NamespaceAuditLog:
    ...
    def load(self, reqmatch=None, ctrl=None) -> NamespaceAuditLog:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.NamespaceAuditLog().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
