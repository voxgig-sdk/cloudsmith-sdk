...
class RepositoryEcdsaKeyEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return RepositoryEcdsaKeyEntity(self._client, opts)
    ...
    def data_get(self) -> RepositoryEcdsaKey:
    ...
    def match_get(self) -> RepositoryEcdsaKey:
    ...
    def load(self, reqmatch=None, ctrl=None) -> RepositoryEcdsaKey:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.RepositoryEcdsaKey().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
    ...
    def create(self, reqdata: RepositoryEcdsaKeyCreateData, ctrl=None) -> RepositoryEcdsaKey:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "create",
            "ctrl": ctrl,
