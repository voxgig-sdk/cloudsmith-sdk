...
class DistributionFullEntity
  ...
  def make
    opts = @_entopts.dup
    DistributionFullEntity.new(@_client, opts)
  end
  ...
  # @return [DistributionFull, Hash] the current DistributionFull data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of DistributionFull fields)
  def match_get
  ...
  #
  # @param reqmatch [DistributionFullLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.DistributionFull.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [DistributionFull, Hash] the loaded DistributionFull; raises CloudsmithError on failure
  ...
  #
  # @param reqmatch [DistributionFullListMatch, Hash, nil] match filter (any subset of
  #   DistributionFull fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<DistributionFull>, Array] the matching DistributionFull items; raises CloudsmithError on failure
