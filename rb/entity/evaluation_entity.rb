...
class EvaluationEntity
  ...
  def make
    opts = @_entopts.dup
    EvaluationEntity.new(@_client, opts)
  end
  ...
  # @return [Evaluation, Hash] the current Evaluation data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Evaluation fields)
  def match_get
