...
class DartEntity
  ...
  # @return [Dart, Hash] the current Dart data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Dart fields)
  def match_get
  ...
  # Load a single Dart.
  #
  # @param reqmatch [DartLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Dart.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Dart, Hash] the loaded Dart; raises CloudsmithError on failure
  ...
  #
  # @param reqmatch [DartListMatch, Hash, nil] match filter (any subset of
  #   Dart fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Dart>, Array] the matching Dart items; raises CloudsmithError on failure
  ...
  # Create a new Dart.
  #
  # @param reqdata [DartCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Dart, Hash] the created Dart; raises CloudsmithError on failure
  ...
  #
  # @param reqdata [DartUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Dart, Hash] the updated Dart; raises CloudsmithError on failure
