# Cloudsmith SDK Namespace entity
...
class NamespaceEntity
  ...
  #
  # @param reqmatch [NamespaceLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Namespace.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Namespace, Hash] the loaded Namespace; raises CloudsmithError on failure
  ...
  # List Namespace items matching the given filter.
  #
  # @param reqmatch [NamespaceListMatch, Hash, nil] match filter (any subset of
  #   Namespace fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Namespace>, Array] the matching Namespace items; raises CloudsmithError on failure
