...
class RepositoryGeoIpRuleEntity
  ...
  def make
    opts = @_entopts.dup
    RepositoryGeoIpRuleEntity.new(@_client, opts)
  end
  ...
  # @return [RepositoryGeoIpRule, Hash] the current RepositoryGeoIpRule data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of RepositoryGeoIpRule fields)
  def match_get
  ...
  #
  # @param reqmatch [RepositoryGeoIpRuleLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.RepositoryGeoIpRule.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [RepositoryGeoIpRule, Hash] the loaded RepositoryGeoIpRule; raises CloudsmithError on failure
  ...
  #
  # @param reqdata [RepositoryGeoIpRuleUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [RepositoryGeoIpRule, Hash] the updated RepositoryGeoIpRule; raises CloudsmithError on failure
