...
class RegenerateEntity
  ...
  def make
    opts = @_entopts.dup
    RegenerateEntity.new(@_client, opts)
  end
  ...
  # @return [Regenerate, Hash] the current Regenerate data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Regenerate fields)
  def match_get
