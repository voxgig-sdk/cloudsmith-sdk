...
class FormatEntity
  ...
  # @return [Format, Hash] the current Format data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Format fields)
  def match_get
  ...
  #
  # @param reqmatch [FormatLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Format.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Format, Hash] the loaded Format; raises CloudsmithError on failure
  ...
  #
  # @param reqmatch [FormatListMatch, Hash, nil] match filter (any subset of
  #   Format fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Format>, Array] the matching Format items; raises CloudsmithError on failure
