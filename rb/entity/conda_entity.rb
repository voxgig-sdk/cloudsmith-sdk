...
class CondaEntity
  ...
  # @return [Conda, Hash] the current Conda data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Conda fields)
  def match_get
  ...
  # Load a single Conda.
  #
  # @param reqmatch [CondaLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Conda.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Conda, Hash] the loaded Conda; raises CloudsmithError on failure
  ...
  #
  # @param reqmatch [CondaListMatch, Hash, nil] match filter (any subset of
  #   Conda fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Conda>, Array] the matching Conda items; raises CloudsmithError on failure
  ...
  # Create a new Conda.
  #
  # @param reqdata [CondaCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Conda, Hash] the created Conda; raises CloudsmithError on failure
  ...
  #
  # @param reqdata [CondaUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Conda, Hash] the updated Conda; raises CloudsmithError on failure
