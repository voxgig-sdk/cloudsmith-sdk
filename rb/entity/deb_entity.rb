...
class DebEntity
  ...
  # @return [Deb, Hash] the current Deb data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Deb fields)
  def match_get
  ...
  # Load a single Deb.
  #
  # @param reqmatch [DebLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Deb.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Deb, Hash] the loaded Deb; raises CloudsmithError on failure
  ...
  #
  # @param reqmatch [DebListMatch, Hash, nil] match filter (any subset of
  #   Deb fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Deb>, Array] the matching Deb items; raises CloudsmithError on failure
  ...
  # Create a new Deb.
  #
  # @param reqdata [DebCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Deb, Hash] the created Deb; raises CloudsmithError on failure
  ...
  #
  # @param reqdata [DebUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Deb, Hash] the updated Deb; raises CloudsmithError on failure
