...
class RepositoryGpgKeyEntity
  ...
  def make
    opts = @_entopts.dup
    RepositoryGpgKeyEntity.new(@_client, opts)
  end
  ...
  # @return [RepositoryGpgKey, Hash] the current RepositoryGpgKey data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of RepositoryGpgKey fields)
  def match_get
  ...
  #
  # @param reqmatch [RepositoryGpgKeyLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.RepositoryGpgKey.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [RepositoryGpgKey, Hash] the loaded RepositoryGpgKey; raises CloudsmithError on failure
  ...
  #
  # @param reqdata [RepositoryGpgKeyCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [RepositoryGpgKey, Hash] the created RepositoryGpgKey; raises CloudsmithError on failure
