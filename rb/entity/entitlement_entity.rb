...
class EntitlementEntity
  ...
  def make
    opts = @_entopts.dup
    EntitlementEntity.new(@_client, opts)
  end
  ...
  # @return [Entitlement, Hash] the current Entitlement data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Entitlement fields)
  def match_get
  ...
  #
  # @param reqmatch [EntitlementLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Entitlement.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Entitlement, Hash] the loaded Entitlement; raises CloudsmithError on failure
  ...
  #
  # @param reqdata [EntitlementCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Entitlement, Hash] the created Entitlement; raises CloudsmithError on failure
  ...
  #
  # @param reqmatch [EntitlementRemoveMatch, Hash, nil] match criteria (id/query fields)
  # @param ctrl [Object, nil] optional per-call control
  # @return [Entitlement, Hash] the removed Entitlement; raises CloudsmithError on failure
