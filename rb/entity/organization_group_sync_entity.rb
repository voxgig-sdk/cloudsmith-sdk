...
class OrganizationGroupSyncEntity
  ...
  def make
    opts = @_entopts.dup
    OrganizationGroupSyncEntity.new(@_client, opts)
  end
  ...
  # @return [OrganizationGroupSync, Hash] the current OrganizationGroupSync data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of OrganizationGroupSync fields)
  def match_get
  ...
  #
  # @param reqmatch [OrganizationGroupSyncListMatch, Hash, nil] match filter (any subset of
  #   OrganizationGroupSync fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<OrganizationGroupSync>, Array] the matching OrganizationGroupSync items; raises CloudsmithError on failure
  ...
  #
  # @param reqdata [OrganizationGroupSyncCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [OrganizationGroupSync, Hash] the created OrganizationGroupSync; raises CloudsmithError on failure
