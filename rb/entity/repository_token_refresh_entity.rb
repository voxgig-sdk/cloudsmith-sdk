...
class RepositoryTokenRefreshEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "repository_token_refresh"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    RepositoryTokenRefreshEntity.new(@_client, opts)
  end
  ...
  # @return [RepositoryTokenRefresh, Hash] the current RepositoryTokenRefresh data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of RepositoryTokenRefresh fields)
  def match_get
  ...
  #
  # @param reqdata [RepositoryTokenRefreshCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [RepositoryTokenRefresh, Hash] the created RepositoryTokenRefresh; raises CloudsmithError on failure
