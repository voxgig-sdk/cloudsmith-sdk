...
class SamlGroupSyncEntity
  ...
  def make
    opts = @_entopts.dup
    SamlGroupSyncEntity.new(@_client, opts)
  end
  ...
  # @return [SamlGroupSync, Hash] the current SamlGroupSync data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of SamlGroupSync fields)
  def match_get
