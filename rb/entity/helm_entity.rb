...
class HelmEntity
  ...
  # @return [Helm, Hash] the current Helm data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Helm fields)
  def match_get
  ...
  # Load a single Helm.
  #
  # @param reqmatch [HelmLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Helm.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Helm, Hash] the loaded Helm; raises CloudsmithError on failure
  ...
  #
  # @param reqmatch [HelmListMatch, Hash, nil] match filter (any subset of
  #   Helm fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Helm>, Array] the matching Helm items; raises CloudsmithError on failure
  ...
  # Create a new Helm.
  #
  # @param reqdata [HelmCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Helm, Hash] the created Helm; raises CloudsmithError on failure
  ...
  #
  # @param reqdata [HelmUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Helm, Hash] the updated Helm; raises CloudsmithError on failure
