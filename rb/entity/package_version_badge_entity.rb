...
class PackageVersionBadgeEntity
  ...
  def make
    opts = @_entopts.dup
    PackageVersionBadgeEntity.new(@_client, opts)
  end
  ...
  # @return [PackageVersionBadge, Hash] the current PackageVersionBadge data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of PackageVersionBadge fields)
  def match_get
  ...
  #
  # @param reqmatch [PackageVersionBadgeLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.PackageVersionBadge.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [PackageVersionBadge, Hash] the loaded PackageVersionBadge; raises CloudsmithError on failure
