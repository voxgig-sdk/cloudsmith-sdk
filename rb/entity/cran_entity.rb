...
class CranEntity
  ...
  # @return [Cran, Hash] the current Cran data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Cran fields)
  def match_get
  ...
  # Load a single Cran.
  #
  # @param reqmatch [CranLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Cran.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Cran, Hash] the loaded Cran; raises CloudsmithError on failure
  ...
  #
  # @param reqmatch [CranListMatch, Hash, nil] match filter (any subset of
  #   Cran fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Cran>, Array] the matching Cran items; raises CloudsmithError on failure
  ...
  # Create a new Cran.
  #
  # @param reqdata [CranCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Cran, Hash] the created Cran; raises CloudsmithError on failure
  ...
  #
  # @param reqdata [CranUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Cran, Hash] the updated Cran; raises CloudsmithError on failure
