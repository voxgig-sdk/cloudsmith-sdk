...
class OrganizationTeamEntity
  ...
  def make
    opts = @_entopts.dup
    OrganizationTeamEntity.new(@_client, opts)
  end
  ...
  # @return [OrganizationTeam, Hash] the current OrganizationTeam data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of OrganizationTeam fields)
  def match_get
  ...
  #
  # @param reqmatch [OrganizationTeamLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.OrganizationTeam.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [OrganizationTeam, Hash] the loaded OrganizationTeam; raises CloudsmithError on failure
  ...
  #
  # @param reqmatch [OrganizationTeamListMatch, Hash, nil] match filter (any subset of
  #   OrganizationTeam fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<OrganizationTeam>, Array] the matching OrganizationTeam items; raises CloudsmithError on failure
  ...
  #
  # @param reqdata [OrganizationTeamCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [OrganizationTeam, Hash] the created OrganizationTeam; raises CloudsmithError on failure
  ...
  #
  # @param reqdata [OrganizationTeamUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [OrganizationTeam, Hash] the updated OrganizationTeam; raises CloudsmithError on failure
