...
class RepositoryAuditLogEntity
  ...
  def make
    opts = @_entopts.dup
    RepositoryAuditLogEntity.new(@_client, opts)
  end
  ...
  # @return [RepositoryAuditLog, Hash] the current RepositoryAuditLog data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of RepositoryAuditLog fields)
  def match_get
  ...
  #
  # @param reqmatch [RepositoryAuditLogListMatch, Hash, nil] match filter (any subset of
  #   RepositoryAuditLog fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<RepositoryAuditLog>, Array] the matching RepositoryAuditLog items; raises CloudsmithError on failure
