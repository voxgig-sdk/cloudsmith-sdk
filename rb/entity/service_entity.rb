...
class ServiceEntity
  ...
  #
  # @param reqmatch [ServiceLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Service.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Service, Hash] the loaded Service; raises CloudsmithError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Service>, Array] the matching Service items; raises CloudsmithError on failure
  ...
  #
  # @param reqdata [ServiceCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Service, Hash] the created Service; raises CloudsmithError on failure
  ...
  #
  # @param reqdata [ServiceUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Service, Hash] the updated Service; raises CloudsmithError on failure
