...
class PythonEntity
  ...
  # @return [Python, Hash] the current Python data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Python fields)
  def match_get
  ...
  #
  # @param reqmatch [PythonLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Python.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Python, Hash] the loaded Python; raises CloudsmithError on failure
  ...
  #
  # @param reqmatch [PythonListMatch, Hash, nil] match filter (any subset of
  #   Python fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Python>, Array] the matching Python items; raises CloudsmithError on failure
  ...
  # Create a new Python.
  #
  # @param reqdata [PythonCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Python, Hash] the created Python; raises CloudsmithError on failure
  ...
  #
  # @param reqdata [PythonUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Python, Hash] the updated Python; raises CloudsmithError on failure
