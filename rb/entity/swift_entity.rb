...
class SwiftEntity
  ...
  # @return [Swift, Hash] the current Swift data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Swift fields)
  def match_get
  ...
  # Load a single Swift.
  #
  # @param reqmatch [SwiftLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Swift.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Swift, Hash] the loaded Swift; raises CloudsmithError on failure
  ...
  #
  # @param reqmatch [SwiftListMatch, Hash, nil] match filter (any subset of
  #   Swift fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Swift>, Array] the matching Swift items; raises CloudsmithError on failure
  ...
  # Create a new Swift.
  #
  # @param reqdata [SwiftCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Swift, Hash] the created Swift; raises CloudsmithError on failure
  ...
  #
  # @param reqdata [SwiftUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Swift, Hash] the updated Swift; raises CloudsmithError on failure
