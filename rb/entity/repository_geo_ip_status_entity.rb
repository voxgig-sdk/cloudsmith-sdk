...
class RepositoryGeoIpStatusEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "repository_geo_ip_status"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    RepositoryGeoIpStatusEntity.new(@_client, opts)
  end
  ...
  # @return [RepositoryGeoIpStatus, Hash] the current RepositoryGeoIpStatus data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of RepositoryGeoIpStatus fields)
  def match_get
  ...
  #
  # @param reqmatch [RepositoryGeoIpStatusLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.RepositoryGeoIpStatus.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [RepositoryGeoIpStatus, Hash] the loaded RepositoryGeoIpStatus; raises CloudsmithError on failure
