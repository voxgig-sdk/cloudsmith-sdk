...
class HexEntity
  ...
  # @return [Hex, Hash] the current Hex data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Hex fields)
  def match_get
  ...
  # Load a single Hex.
  #
  # @param reqmatch [HexLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Hex.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Hex, Hash] the loaded Hex; raises CloudsmithError on failure
  ...
  #
  # @param reqmatch [HexListMatch, Hash, nil] match filter (any subset of
  #   Hex fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Hex>, Array] the matching Hex items; raises CloudsmithError on failure
  ...
  # Create a new Hex.
  #
  # @param reqdata [HexCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Hex, Hash] the created Hex; raises CloudsmithError on failure
  ...
  #
  # @param reqdata [HexUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Hex, Hash] the updated Hex; raises CloudsmithError on failure
