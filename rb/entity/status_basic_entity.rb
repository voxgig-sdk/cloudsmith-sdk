...
class StatusBasicEntity
  ...
  def make
    opts = @_entopts.dup
    StatusBasicEntity.new(@_client, opts)
  end
  ...
  # @return [StatusBasic, Hash] the current StatusBasic data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of StatusBasic fields)
  def match_get
  ...
  #
  # @param reqmatch [StatusBasicLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.StatusBasic.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [StatusBasic, Hash] the loaded StatusBasic; raises CloudsmithError on failure
