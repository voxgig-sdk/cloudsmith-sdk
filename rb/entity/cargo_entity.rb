...
class CargoEntity
  ...
  # @return [Cargo, Hash] the current Cargo data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Cargo fields)
  def match_get
  ...
  # Load a single Cargo.
  #
  # @param reqmatch [CargoLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Cargo.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Cargo, Hash] the loaded Cargo; raises CloudsmithError on failure
  ...
  #
  # @param reqmatch [CargoListMatch, Hash, nil] match filter (any subset of
  #   Cargo fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Cargo>, Array] the matching Cargo items; raises CloudsmithError on failure
  ...
  # Create a new Cargo.
  #
  # @param reqdata [CargoCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Cargo, Hash] the created Cargo; raises CloudsmithError on failure
  ...
  #
  # @param reqdata [CargoUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Cargo, Hash] the updated Cargo; raises CloudsmithError on failure
