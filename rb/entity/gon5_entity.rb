...
class Gon5Entity
  ...
  # @return [Gon5, Hash] the current Gon5 data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Gon5 fields)
  def match_get
  ...
  # Create a new Gon5.
  #
  # @param reqdata [Gon5CreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Gon5, Hash] the created Gon5; raises CloudsmithError on failure
