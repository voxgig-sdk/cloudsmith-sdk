...
class LicensePolicyEntity
  ...
  def make
    opts = @_entopts.dup
    LicensePolicyEntity.new(@_client, opts)
  end
  ...
  # @return [LicensePolicy, Hash] the current LicensePolicy data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of LicensePolicy fields)
  def match_get
