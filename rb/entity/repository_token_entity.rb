...
class RepositoryTokenEntity
  ...
  def make
    opts = @_entopts.dup
    RepositoryTokenEntity.new(@_client, opts)
  end
  ...
  # @return [RepositoryToken, Hash] the current RepositoryToken data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of RepositoryToken fields)
  def match_get
  ...
  #
  # @param reqmatch [RepositoryTokenLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.RepositoryToken.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [RepositoryToken, Hash] the loaded RepositoryToken; raises CloudsmithError on failure
  ...
  #
  # @param reqmatch [RepositoryTokenListMatch, Hash, nil] match filter (any subset of
  #   RepositoryToken fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<RepositoryToken>, Array] the matching RepositoryToken items; raises CloudsmithError on failure
  ...
  #
  # @param reqdata [RepositoryTokenCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [RepositoryToken, Hash] the created RepositoryToken; raises CloudsmithError on failure
  ...
  #
  # @param reqdata [RepositoryTokenUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [RepositoryToken, Hash] the updated RepositoryToken; raises CloudsmithError on failure
