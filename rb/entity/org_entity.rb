...
class OrgEntity
  ...
  # @return [Org, Hash] the current Org data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Org fields)
  def match_get
  ...
  # Load a single Org.
  #
  # @param reqmatch [OrgLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Org.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Org, Hash] the loaded Org; raises CloudsmithError on failure
  ...
  #
  # @param reqmatch [OrgListMatch, Hash, nil] match filter (any subset of
  #   Org fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Org>, Array] the matching Org items; raises CloudsmithError on failure
  ...
  # Create a new Org.
  #
  # @param reqdata [OrgCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Org, Hash] the created Org; raises CloudsmithError on failure
  ...
  #
  # @param reqdata [OrgUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Org, Hash] the updated Org; raises CloudsmithError on failure
  ...
  #
  # @param reqmatch [OrgRemoveMatch, Hash, nil] match criteria (id/query fields)
  # @param ctrl [Object, nil] optional per-call control
  # @return [Org, Hash] the removed Org; raises CloudsmithError on failure
