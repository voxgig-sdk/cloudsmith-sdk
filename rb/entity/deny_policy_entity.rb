...
class DenyPolicyEntity
  ...
  def make
    opts = @_entopts.dup
    DenyPolicyEntity.new(@_client, opts)
  end
  ...
  # @return [DenyPolicy, Hash] the current DenyPolicy data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of DenyPolicy fields)
  def match_get
