...
class Gon6Entity
  ...
  # @return [Gon6, Hash] the current Gon6 data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Gon6 fields)
  def match_get
  ...
  # Load a single Gon6.
  #
  # @param reqmatch [Gon6LoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Gon6.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Gon6, Hash] the loaded Gon6; raises CloudsmithError on failure
