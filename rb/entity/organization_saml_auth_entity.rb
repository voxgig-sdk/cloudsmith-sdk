...
class OrganizationSamlAuthEntity
  ...
  def make
    opts = @_entopts.dup
    OrganizationSamlAuthEntity.new(@_client, opts)
  end
  ...
  # @return [OrganizationSamlAuth, Hash] the current OrganizationSamlAuth data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of OrganizationSamlAuth fields)
  def match_get
  ...
  #
  # @param reqmatch [OrganizationSamlAuthLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.OrganizationSamlAuth.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [OrganizationSamlAuth, Hash] the loaded OrganizationSamlAuth; raises CloudsmithError on failure
  ...
  #
  # @param reqdata [OrganizationSamlAuthUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [OrganizationSamlAuth, Hash] the updated OrganizationSamlAuth; raises CloudsmithError on failure
