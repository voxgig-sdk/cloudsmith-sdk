...
class RepositoryEcdsaKeyEntity
  ...
  def make
    opts = @_entopts.dup
    RepositoryEcdsaKeyEntity.new(@_client, opts)
  end
  ...
  # @return [RepositoryEcdsaKey, Hash] the current RepositoryEcdsaKey data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of RepositoryEcdsaKey fields)
  def match_get
  ...
  #
  # @param reqmatch [RepositoryEcdsaKeyLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.RepositoryEcdsaKey.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [RepositoryEcdsaKey, Hash] the loaded RepositoryEcdsaKey; raises CloudsmithError on failure
  ...
  #
  # @param reqdata [RepositoryEcdsaKeyCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [RepositoryEcdsaKey, Hash] the created RepositoryEcdsaKey; raises CloudsmithError on failure
