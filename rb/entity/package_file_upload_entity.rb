...
class PackageFileUploadEntity
  ...
  def make
    opts = @_entopts.dup
    PackageFileUploadEntity.new(@_client, opts)
  end
  ...
  # @return [PackageFileUpload, Hash] the current PackageFileUpload data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of PackageFileUpload fields)
  def match_get
  ...
  #
  # @param reqdata [PackageFileUploadCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [PackageFileUpload, Hash] the created PackageFileUpload; raises CloudsmithError on failure
