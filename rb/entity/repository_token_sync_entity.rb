...
class RepositoryTokenSyncEntity
  ...
  def make
    opts = @_entopts.dup
    RepositoryTokenSyncEntity.new(@_client, opts)
  end
  ...
  # @return [RepositoryTokenSync, Hash] the current RepositoryTokenSync data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of RepositoryTokenSync fields)
  def match_get
  ...
  #
  # @param reqdata [RepositoryTokenSyncCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [RepositoryTokenSync, Hash] the created RepositoryTokenSync; raises CloudsmithError on failure
