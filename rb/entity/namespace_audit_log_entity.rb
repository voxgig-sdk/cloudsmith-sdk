...
class NamespaceAuditLogEntity
  ...
  def make
    opts = @_entopts.dup
    NamespaceAuditLogEntity.new(@_client, opts)
  end
  ...
  # @return [NamespaceAuditLog, Hash] the current NamespaceAuditLog data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of NamespaceAuditLog fields)
  def match_get
  ...
  #
  # @param reqmatch [NamespaceAuditLogLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.NamespaceAuditLog.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [NamespaceAuditLog, Hash] the loaded NamespaceAuditLog; raises CloudsmithError on failure
