...
class Gon8Entity
  ...
  # @return [Gon8, Hash] the current Gon8 data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Gon8 fields)
  def match_get
  ...
  #
  # @param reqdata [Gon8UpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Gon8, Hash] the updated Gon8; raises CloudsmithError on failure
