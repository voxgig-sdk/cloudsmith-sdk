...
class DockerEntity
  ...
  # @return [Docker, Hash] the current Docker data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Docker fields)
  def match_get
  ...
  #
  # @param reqmatch [DockerLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Docker.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Docker, Hash] the loaded Docker; raises CloudsmithError on failure
  ...
  #
  # @param reqmatch [DockerListMatch, Hash, nil] match filter (any subset of
  #   Docker fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Docker>, Array] the matching Docker items; raises CloudsmithError on failure
  ...
  # Create a new Docker.
  #
  # @param reqdata [DockerCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Docker, Hash] the created Docker; raises CloudsmithError on failure
  ...
  #
  # @param reqdata [DockerUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Docker, Hash] the updated Docker; raises CloudsmithError on failure
