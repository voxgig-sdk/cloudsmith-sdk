...
class RepoEntity
  ...
  # @return [Repo, Hash] the current Repo data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Repo fields)
  def match_get
  ...
  # Load a single Repo.
  #
  # @param reqmatch [RepoLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Repo.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Repo, Hash] the loaded Repo; raises CloudsmithError on failure
  ...
  #
  # @param reqmatch [RepoListMatch, Hash, nil] match filter (any subset of
  #   Repo fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Repo>, Array] the matching Repo items; raises CloudsmithError on failure
  ...
  # Create a new Repo.
  #
  # @param reqdata [RepoCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Repo, Hash] the created Repo; raises CloudsmithError on failure
  ...
  #
  # @param reqdata [RepoUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Repo, Hash] the updated Repo; raises CloudsmithError on failure
  ...
  #
  # @param reqmatch [RepoRemoveMatch, Hash, nil] match criteria (id/query fields)
  # @param ctrl [Object, nil] optional per-call control
  # @return [Repo, Hash] the removed Repo; raises CloudsmithError on failure
