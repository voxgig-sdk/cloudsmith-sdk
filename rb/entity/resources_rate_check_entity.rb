...
class ResourcesRateCheckEntity
  ...
  def make
    opts = @_entopts.dup
    ResourcesRateCheckEntity.new(@_client, opts)
  end
  ...
  # @return [ResourcesRateCheck, Hash] the current ResourcesRateCheck data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ResourcesRateCheck fields)
  def match_get
  ...
  #
  # @param reqmatch [ResourcesRateCheckLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.ResourcesRateCheck.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [ResourcesRateCheck, Hash] the loaded ResourcesRateCheck; raises CloudsmithError on failure
