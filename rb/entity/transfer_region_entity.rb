...
class TransferRegionEntity
  ...
  def make
    opts = @_entopts.dup
    TransferRegionEntity.new(@_client, opts)
  end
  ...
  # @return [TransferRegion, Hash] the current TransferRegion data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of TransferRegion fields)
  def match_get
