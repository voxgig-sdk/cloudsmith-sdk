...
class BasicEntity
  ...
  # @return [Basic, Hash] the current Basic data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Basic fields)
  def match_get
