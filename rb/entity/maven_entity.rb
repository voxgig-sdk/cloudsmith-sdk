...
class MavenEntity
  ...
  # @return [Maven, Hash] the current Maven data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Maven fields)
  def match_get
  ...
  # Load a single Maven.
  #
  # @param reqmatch [MavenLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Maven.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Maven, Hash] the loaded Maven; raises CloudsmithError on failure
  ...
  #
  # @param reqmatch [MavenListMatch, Hash, nil] match filter (any subset of
  #   Maven fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Maven>, Array] the matching Maven items; raises CloudsmithError on failure
  ...
  # Create a new Maven.
  #
  # @param reqdata [MavenCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Maven, Hash] the created Maven; raises CloudsmithError on failure
  ...
  #
  # @param reqdata [MavenUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Maven, Hash] the updated Maven; raises CloudsmithError on failure
