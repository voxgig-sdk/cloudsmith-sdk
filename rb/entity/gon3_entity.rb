...
class Gon3Entity
  ...
  # @return [Gon3, Hash] the current Gon3 data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Gon3 fields)
  def match_get
  ...
  # List Gon3 items matching the given filter.
  #
  # @param reqmatch [Gon3ListMatch, Hash, nil] match filter (any subset of
  #   Gon3 fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Gon3>, Array] the matching Gon3 items; raises CloudsmithError on failure
