...
class NugetEntity
  ...
  # Load a single Nuget.
  #
  # @param reqmatch [NugetLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Nuget.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Nuget, Hash] the loaded Nuget; raises CloudsmithError on failure
  ...
  # List Nuget items matching the given filter.
  #
  # @param reqmatch [NugetListMatch, Hash, nil] match filter (any subset of
  #   Nuget fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Nuget>, Array] the matching Nuget items; raises CloudsmithError on failure
  ...
  # Create a new Nuget.
  #
  # @param reqdata [NugetCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Nuget, Hash] the created Nuget; raises CloudsmithError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Nuget, Hash] the updated Nuget; raises CloudsmithError on failure
