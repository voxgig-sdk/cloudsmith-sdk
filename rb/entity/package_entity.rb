...
class PackageEntity
  ...
  def make
    opts = @_entopts.dup
    PackageEntity.new(@_client, opts)
  end
  ...
  # @return [Package, Hash] the current Package data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Package fields)
  def match_get
  ...
  #
  # @param reqmatch [PackageLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Package.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Package, Hash] the loaded Package; raises CloudsmithError on failure
  ...
  #
  # @param reqmatch [PackageListMatch, Hash, nil] match filter (any subset of
  #   Package fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Package>, Array] the matching Package items; raises CloudsmithError on failure
  ...
  #
  # @param reqdata [PackageCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Package, Hash] the created Package; raises CloudsmithError on failure
  ...
  #
  # @param reqmatch [PackageRemoveMatch, Hash, nil] match criteria (id/query fields)
  # @param ctrl [Object, nil] optional per-call control
  # @return [Package, Hash] the removed Package; raises CloudsmithError on failure
