...
class UserBriefEntity
  ...
  def make
    opts = @_entopts.dup
    UserBriefEntity.new(@_client, opts)
  end
  ...
  # @return [UserBrief, Hash] the current UserBrief data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of UserBrief fields)
  def match_get
  ...
  #
  # @param reqmatch [UserBriefLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.UserBrief.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [UserBrief, Hash] the loaded UserBrief; raises CloudsmithError on failure
