...
class OrganizationMembershipRoleUpdateEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "organization_membership_role_update"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    OrganizationMembershipRoleUpdateEntity.new(@_client, opts)
  end
  ...
  # @return [OrganizationMembershipRoleUpdate, Hash] the current OrganizationMembershipRoleUpdate data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of OrganizationMembershipRoleUpdate fields)
  def match_get
  ...
  #
  # @param reqdata [OrganizationMembershipRoleUpdateUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [OrganizationMembershipRoleUpdate, Hash] the updated OrganizationMembershipRoleUpdate; raises CloudsmithError on failure
