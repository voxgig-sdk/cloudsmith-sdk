...
class OpenidConnectEntity
  ...
  def make
    opts = @_entopts.dup
    OpenidConnectEntity.new(@_client, opts)
  end
  ...
  # @return [OpenidConnect, Hash] the current OpenidConnect data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of OpenidConnect fields)
  def match_get
