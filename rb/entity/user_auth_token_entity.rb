...
class UserAuthTokenEntity
  ...
  def make
    opts = @_entopts.dup
    UserAuthTokenEntity.new(@_client, opts)
  end
  ...
  # @return [UserAuthToken, Hash] the current UserAuthToken data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of UserAuthToken fields)
  def match_get
  ...
  #
  # @param reqdata [UserAuthTokenCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [UserAuthToken, Hash] the created UserAuthToken; raises CloudsmithError on failure
