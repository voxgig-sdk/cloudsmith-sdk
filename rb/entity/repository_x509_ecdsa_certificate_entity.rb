...
class RepositoryX509EcdsaCertificateEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "repository_x509_ecdsa_certificate"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    RepositoryX509EcdsaCertificateEntity.new(@_client, opts)
  end
  ...
  # @return [RepositoryX509EcdsaCertificate, Hash] the current RepositoryX509EcdsaCertificate data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of RepositoryX509EcdsaCertificate fields)
  def match_get
  ...
  #
  # @param reqmatch [RepositoryX509EcdsaCertificateLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.RepositoryX509EcdsaCertificate.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [RepositoryX509EcdsaCertificate, Hash] the loaded RepositoryX509EcdsaCertificate; raises CloudsmithError on failure
