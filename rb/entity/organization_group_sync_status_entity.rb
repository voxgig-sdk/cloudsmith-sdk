...
class OrganizationGroupSyncStatusEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "organization_group_sync_status"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    OrganizationGroupSyncStatusEntity.new(@_client, opts)
  end
  ...
  # @return [OrganizationGroupSyncStatus, Hash] the current OrganizationGroupSyncStatus data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of OrganizationGroupSyncStatus fields)
  def match_get
  ...
  #
  # @param reqmatch [OrganizationGroupSyncStatusLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.OrganizationGroupSyncStatus.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [OrganizationGroupSyncStatus, Hash] the loaded OrganizationGroupSyncStatus; raises CloudsmithError on failure
