...
class NpmEntity
  ...
  # Load a single Npm.
  #
  # @param reqmatch [NpmLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Npm.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Npm, Hash] the loaded Npm; raises CloudsmithError on failure
  ...
  # List Npm items matching the given filter.
  #
  # @param reqmatch [NpmListMatch, Hash, nil] match filter (any subset of
  #   Npm fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Npm>, Array] the matching Npm items; raises CloudsmithError on failure
  ...
  # Create a new Npm.
  #
  # @param reqdata [NpmCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Npm, Hash] the created Npm; raises CloudsmithError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Npm, Hash] the updated Npm; raises CloudsmithError on failure
