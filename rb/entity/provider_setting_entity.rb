...
class ProviderSettingEntity
  ...
  def make
    opts = @_entopts.dup
    ProviderSettingEntity.new(@_client, opts)
  end
  ...
  # @return [ProviderSetting, Hash] the current ProviderSetting data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ProviderSetting fields)
  def match_get
  ...
  #
  # @param reqmatch [ProviderSettingLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.ProviderSetting.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [ProviderSetting, Hash] the loaded ProviderSetting; raises CloudsmithError on failure
  ...
  #
  # @param reqmatch [ProviderSettingListMatch, Hash, nil] match filter (any subset of
  #   ProviderSetting fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<ProviderSetting>, Array] the matching ProviderSetting items; raises CloudsmithError on failure
