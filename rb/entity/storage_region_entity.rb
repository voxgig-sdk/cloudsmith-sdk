...
class StorageRegionEntity
  ...
  def make
    opts = @_entopts.dup
    StorageRegionEntity.new(@_client, opts)
  end
  ...
  # @return [StorageRegion, Hash] the current StorageRegion data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of StorageRegion fields)
  def match_get
  ...
  #
  # @param reqmatch [StorageRegionLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.StorageRegion.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [StorageRegion, Hash] the loaded StorageRegion; raises CloudsmithError on failure
  ...
  #
  # @param reqmatch [StorageRegionListMatch, Hash, nil] match filter (any subset of
  #   StorageRegion fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<StorageRegion>, Array] the matching StorageRegion items; raises CloudsmithError on failure
