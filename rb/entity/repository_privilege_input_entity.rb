...
class RepositoryPrivilegeInputEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "repository_privilege_input"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    RepositoryPrivilegeInputEntity.new(@_client, opts)
  end
  ...
  # @return [RepositoryPrivilegeInput, Hash] the current RepositoryPrivilegeInput data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of RepositoryPrivilegeInput fields)
  def match_get
  ...
  #
  # @param reqmatch [RepositoryPrivilegeInputListMatch, Hash, nil] match filter (any subset of
  #   RepositoryPrivilegeInput fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<RepositoryPrivilegeInput>, Array] the matching RepositoryPrivilegeInput items; raises CloudsmithError on failure
