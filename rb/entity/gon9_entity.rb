...
class Gon9Entity
  ...
  # @return [Gon9, Hash] the current Gon9 data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Gon9 fields)
  def match_get
  ...
  #
  # @param reqdata [Gon9UpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Gon9, Hash] the updated Gon9; raises CloudsmithError on failure
