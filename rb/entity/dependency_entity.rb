...
class DependencyEntity
  ...
  def make
    opts = @_entopts.dup
    DependencyEntity.new(@_client, opts)
  end
  ...
  # @return [Dependency, Hash] the current Dependency data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Dependency fields)
  def match_get
