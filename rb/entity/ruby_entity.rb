...
class RubyEntity
  ...
  # @return [Ruby, Hash] the current Ruby data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Ruby fields)
  def match_get
  ...
  # Load a single Ruby.
  #
  # @param reqmatch [RubyLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Ruby.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Ruby, Hash] the loaded Ruby; raises CloudsmithError on failure
  ...
  #
  # @param reqmatch [RubyListMatch, Hash, nil] match filter (any subset of
  #   Ruby fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Ruby>, Array] the matching Ruby items; raises CloudsmithError on failure
  ...
  # Create a new Ruby.
  #
  # @param reqdata [RubyCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Ruby, Hash] the created Ruby; raises CloudsmithError on failure
  ...
  #
  # @param reqdata [RubyUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Ruby, Hash] the updated Ruby; raises CloudsmithError on failure
