...
class OrganizationTeamMemberEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "organization_team_member"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    OrganizationTeamMemberEntity.new(@_client, opts)
  end
  ...
  # @return [OrganizationTeamMember, Hash] the current OrganizationTeamMember data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of OrganizationTeamMember fields)
  def match_get
  ...
  #
  # @param reqmatch [OrganizationTeamMemberListMatch, Hash, nil] match filter (any subset of
  #   OrganizationTeamMember fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<OrganizationTeamMember>, Array] the matching OrganizationTeamMember items; raises CloudsmithError on failure
  ...
  #
  # @param reqdata [OrganizationTeamMemberCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [OrganizationTeamMember, Hash] the created OrganizationTeamMember; raises CloudsmithError on failure
