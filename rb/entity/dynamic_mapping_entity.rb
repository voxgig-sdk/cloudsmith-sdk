...
class DynamicMappingEntity
  ...
  def make
    opts = @_entopts.dup
    DynamicMappingEntity.new(@_client, opts)
  end
  ...
  # @return [DynamicMapping, Hash] the current DynamicMapping data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of DynamicMapping fields)
  def match_get
  ...
  #
  # @param reqmatch [DynamicMappingLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.DynamicMapping.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [DynamicMapping, Hash] the loaded DynamicMapping; raises CloudsmithError on failure
  ...
  #
  # @param reqmatch [DynamicMappingListMatch, Hash, nil] match filter (any subset of
  #   DynamicMapping fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<DynamicMapping>, Array] the matching DynamicMapping items; raises CloudsmithError on failure
