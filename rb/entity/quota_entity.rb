...
class QuotaEntity
  ...
  # @return [Quota, Hash] the current Quota data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Quota fields)
  def match_get
  ...
  # Load a single Quota.
  #
  # @param reqmatch [QuotaLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Quota.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Quota, Hash] the loaded Quota; raises CloudsmithError on failure
