...
class OrganizationInviteEntity
  ...
  def make
    opts = @_entopts.dup
    OrganizationInviteEntity.new(@_client, opts)
  end
  ...
  # @return [OrganizationInvite, Hash] the current OrganizationInvite data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of OrganizationInvite fields)
  def match_get
  ...
  #
  # @param reqmatch [OrganizationInviteListMatch, Hash, nil] match filter (any subset of
  #   OrganizationInvite fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<OrganizationInvite>, Array] the matching OrganizationInvite items; raises CloudsmithError on failure
  ...
  #
  # @param reqdata [OrganizationInviteCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [OrganizationInvite, Hash] the created OrganizationInvite; raises CloudsmithError on failure
  ...
  #
  # @param reqdata [OrganizationInviteUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [OrganizationInvite, Hash] the updated OrganizationInvite; raises CloudsmithError on failure
