# Cloudsmith SDK Composer entity
...
class ComposerEntity
  ...
  # Load a single Composer.
  #
  # @param reqmatch [ComposerLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Composer.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Composer, Hash] the loaded Composer; raises CloudsmithError on failure
  ...
  # List Composer items matching the given filter.
  #
  # @param reqmatch [ComposerListMatch, Hash, nil] match filter (any subset of
  #   Composer fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Composer>, Array] the matching Composer items; raises CloudsmithError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Composer, Hash] the created Composer; raises CloudsmithError on failure
  ...
  #
  # @param reqdata [ComposerUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Composer, Hash] the updated Composer; raises CloudsmithError on failure
