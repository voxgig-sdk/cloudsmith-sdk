# Cloudsmith SDK RepositoryWebhook entity

require_relative '../utility/struct/voxgig_struct'
require_relative '../core/helpers'

class RepositoryWebhookEntity
  ...
  def make
    opts = @_entopts.dup
    RepositoryWebhookEntity.new(@_client, opts)
  end
  ...
  # @return [RepositoryWebhook, Hash] the current RepositoryWebhook data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of RepositoryWebhook fields)
  def match_get
  ...
  #
  # @param reqmatch [RepositoryWebhookLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.RepositoryWebhook.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [RepositoryWebhook, Hash] the loaded RepositoryWebhook; raises CloudsmithError on failure
  ...
  # List RepositoryWebhook items matching the given filter.
  #
  # @param reqmatch [RepositoryWebhookListMatch, Hash, nil] match filter (any subset of
  #   RepositoryWebhook fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<RepositoryWebhook>, Array] the matching RepositoryWebhook items; raises CloudsmithError on failure
  ...
  # Create a new RepositoryWebhook.
  #
  # @param reqdata [RepositoryWebhookCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [RepositoryWebhook, Hash] the created RepositoryWebhook; raises CloudsmithError on failure
  ...
  # Update an existing RepositoryWebhook.
  #
  # @param reqdata [RepositoryWebhookUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [RepositoryWebhook, Hash] the updated RepositoryWebhook; raises CloudsmithError on failure
