...
class RpmEntity
  ...
  # Load a single Rpm.
  #
  # @param reqmatch [RpmLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Rpm.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Rpm, Hash] the loaded Rpm; raises CloudsmithError on failure
  ...
  # List Rpm items matching the given filter.
  #
  # @param reqmatch [RpmListMatch, Hash, nil] match filter (any subset of
  #   Rpm fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Rpm>, Array] the matching Rpm items; raises CloudsmithError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Rpm, Hash] the created Rpm; raises CloudsmithError on failure
  ...
  # Update an existing Rpm.
  #
  # @param reqdata [RpmUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Rpm, Hash] the updated Rpm; raises CloudsmithError on failure
