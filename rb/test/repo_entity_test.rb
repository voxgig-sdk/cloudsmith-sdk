...
class RepoEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    assert_equal repo_ref01_resdata_up0["id"], repo_ref01_data_up0_up["id"]
    ...
    repo_ref01_data_dt0_load_result = Helpers.to_map(repo_ref01_data_dt0_loaded.respond_to?(:data_get) ? repo_ref01_data_dt0_loaded.data_get : repo_ref01_data_dt0_loaded)
