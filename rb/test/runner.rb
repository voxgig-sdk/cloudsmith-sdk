...
module CloudsmithTestRunner
  ...
  def self.env_override(m)
    live = getenv("CLOUDSMITH_TEST_LIVE")
    override = getenv("CLOUDSMITH_TEST_OVERRIDE")
    ...
    explain = getenv("CLOUDSMITH_TEST_EXPLAIN")
    m["CLOUDSMITH_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = CloudsmithTestRunner
Helpers = CloudsmithHelpers
Vs = VoxgigStruct
