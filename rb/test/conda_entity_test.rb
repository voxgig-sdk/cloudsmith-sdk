...
class CondaEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    conda_ref01_data = Helpers.to_map(conda_ref01_data_result.respond_to?(:data_get) ? conda_ref01_data_result.data_get : conda_ref01_data_result)
    assert !conda_ref01_data.nil?
    assert !conda_ref01_data["id"].nil?
    ...
    conda_ref01_resdata_up0 = Helpers.to_map(conda_ref01_resdata_up0_result.respond_to?(:data_get) ? conda_ref01_resdata_up0_result.data_get : conda_ref01_resdata_up0_result)
    assert !conda_ref01_resdata_up0.nil?
    assert_equal conda_ref01_resdata_up0["id"], conda_ref01_data_up0_up["id"]
    ...
    conda_ref01_data_dt0_load_result = Helpers.to_map(conda_ref01_data_dt0_loaded.respond_to?(:data_get) ? conda_ref01_data_dt0_loaded.data_get : conda_ref01_data_dt0_loaded)
    assert !conda_ref01_data_dt0_load_result.nil?
    assert_equal conda_ref01_data_dt0_load_result["id"], conda_ref01_data["id"]
