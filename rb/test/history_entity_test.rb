...
class HistoryEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set CLOUDSMITH_TEST_HISTORY_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def history_basic_setup(extra)
  ...
  entid_env_raw = ENV["CLOUDSMITH_TEST_HISTORY_ENTID"]
