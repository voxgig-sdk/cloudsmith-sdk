...
describe('CranEntity', async () => {
  ...
  test('basic', async () => {
    ...
    assert(cran_ref01_resdata_up0[cran_ref01_markdef_up0.name] === cran_ref01_markdef_up0.value)


    // LOAD
    const cran_ref01_match_dt0 = {}
    const cran_ref01_data_dt0 = await cran_ref01_ent.load(cran_ref01_match_dt0)
    assert(null != cran_ref01_data_dt0)
