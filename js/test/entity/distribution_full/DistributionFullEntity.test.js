...
describe('DistributionFullEntity', async () => {
  ...
  test('basic', async () => {
    ...
    // LOAD
    const distribution_full_ref01_match_dt0 = {}
    const distribution_full_ref01_data_dt0 = await distribution_full_ref01_ent.load(distribution_full_ref01_match_dt0)
    assert(null != distribution_full_ref01_data_dt0)
