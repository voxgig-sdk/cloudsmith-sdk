...
describe('RepositoryRetentionRuleEntity', async () => {
  ...
  test('basic', async () => {
    ...
    assert(repository_retention_rule_ref01_resdata_up0[repository_retention_rule_ref01_markdef_up0.name] === repository_retention_rule_ref01_markdef_up0.value)


    // LOAD
    const repository_retention_rule_ref01_match_dt0 = {}
    const repository_retention_rule_ref01_data_dt0 = await repository_retention_rule_ref01_ent.load(repository_retention_rule_ref01_match_dt0)
    assert(null != repository_retention_rule_ref01_data_dt0)
