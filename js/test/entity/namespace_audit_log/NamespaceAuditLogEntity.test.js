...
describe('NamespaceAuditLogEntity', async () => {
  ...
  test('basic', async () => {
    ...
    const namespace_audit_log_ref01_data_dt0 = await namespace_audit_log_ref01_ent.load(namespace_audit_log_ref01_match_dt0)
    assert(null != namespace_audit_log_ref01_data_dt0)
