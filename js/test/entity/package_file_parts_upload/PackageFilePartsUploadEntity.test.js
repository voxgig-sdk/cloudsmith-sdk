...
describe('PackageFilePartsUploadEntity', async () => {
  ...
  test('basic', async () => {
    ...
    const package_file_parts_upload_ref01_match_dt0 = {}
    const package_file_parts_upload_ref01_data_dt0 = await package_file_parts_upload_ref01_ent.load(package_file_parts_upload_ref01_match_dt0)
    assert(null != package_file_parts_upload_ref01_data_dt0)
