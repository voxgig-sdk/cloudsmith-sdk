...
describe('RepositoryX509RsaCertificateEntity', async () => {
  ...
  test('basic', async () => {
    ...
    const repository_x509_rsa_certificate_ref01_match_dt0 = {}
    const repository_x509_rsa_certificate_ref01_data_dt0 = await repository_x509_rsa_certificate_ref01_ent.load(repository_x509_rsa_certificate_ref01_match_dt0)
    assert(null != repository_x509_rsa_certificate_ref01_data_dt0)
