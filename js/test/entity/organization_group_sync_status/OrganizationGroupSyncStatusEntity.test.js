...
describe('OrganizationGroupSyncStatusEntity', async () => {
  ...
  test('basic', async () => {
    ...
    const organization_group_sync_status_ref01_match_dt0 = {}
    const organization_group_sync_status_ref01_data_dt0 = await organization_group_sync_status_ref01_ent.load(organization_group_sync_status_ref01_match_dt0)
    assert(null != organization_group_sync_status_ref01_data_dt0)
