...
describe('RepositoryRsaKeyEntity', async () => {
  ...
  test('basic', async () => {
    ...
    // LOAD
    const repository_rsa_key_ref01_match_dt0 = {}
    const repository_rsa_key_ref01_data_dt0 = await repository_rsa_key_ref01_ent.load(repository_rsa_key_ref01_match_dt0)
    assert(null != repository_rsa_key_ref01_data_dt0)
