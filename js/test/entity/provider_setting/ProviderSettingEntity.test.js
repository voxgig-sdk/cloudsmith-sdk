...
describe('ProviderSettingEntity', async () => {
  ...
  test('basic', async () => {
    ...
    // LOAD
    const provider_setting_ref01_match_dt0 = {}
    const provider_setting_ref01_data_dt0 = await provider_setting_ref01_ent.load(provider_setting_ref01_match_dt0)
    assert(null != provider_setting_ref01_data_dt0)
