...
describe('RepositoryGeoIpRuleEntity', async () => {
  ...
  test('basic', async () => {
    ...
    // LOAD
    const repository_geo_ip_rule_ref01_match_dt0 = {}
    const repository_geo_ip_rule_ref01_data_dt0 = await repository_geo_ip_rule_ref01_ent.load(repository_geo_ip_rule_ref01_match_dt0)
    assert(null != repository_geo_ip_rule_ref01_data_dt0)
