...
describe('OrganizationMembershipRoleUpdateEntity', async () => {
  ...
  test('basic', async () => {
    ...
    assert(organization_membership_role_update_ref01_resdata_up0[organization_membership_role_update_ref01_markdef_up0.name] === organization_membership_role_update_ref01_markdef_up0.value)
