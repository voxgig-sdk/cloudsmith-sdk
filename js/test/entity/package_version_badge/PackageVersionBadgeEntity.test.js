...
describe('PackageVersionBadgeEntity', async () => {
  ...
  test('basic', async () => {
    ...
    const package_version_badge_ref01_data_dt0 = await package_version_badge_ref01_ent.load(package_version_badge_ref01_match_dt0)
    assert(null != package_version_badge_ref01_data_dt0)
