...
describe('RepositoryX509EcdsaCertificateEntity', async () => {
  ...
  test('basic', async () => {
    ...
    const repository_x509_ecdsa_certificate_ref01_match_dt0 = {}
    const repository_x509_ecdsa_certificate_ref01_data_dt0 = await repository_x509_ecdsa_certificate_ref01_ent.load(repository_x509_ecdsa_certificate_ref01_match_dt0)
    assert(null != repository_x509_ecdsa_certificate_ref01_data_dt0)
...
function basicSetup(extra) {
  ...
  let idmap = transform(
    ['repository_x509_ecdsa_certificate01','repository_x509_ecdsa_certificate02','repository_x509_ecdsa_certificate03','repo01','repo02','repo03'],
    {
      '`$PACK`': ['', {
        '`$KEY`': '`$COPY`',
