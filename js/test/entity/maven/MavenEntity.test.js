...
describe('MavenEntity', async () => {
  ...
  test('basic', async () => {
    ...
    assert(maven_ref01_resdata_up0[maven_ref01_markdef_up0.name] === maven_ref01_markdef_up0.value)


    // LOAD
    const maven_ref01_match_dt0 = {}
    const maven_ref01_data_dt0 = await maven_ref01_ent.load(maven_ref01_match_dt0)
    assert(null != maven_ref01_data_dt0)
