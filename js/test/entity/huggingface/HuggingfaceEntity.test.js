...
describe('HuggingfaceEntity', async () => {
  ...
  test('basic', async () => {
    ...
    assert(huggingface_ref01_resdata_up0[huggingface_ref01_markdef_up0.name] === huggingface_ref01_markdef_up0.value)


    // LOAD
    const huggingface_ref01_match_dt0 = {}
    const huggingface_ref01_data_dt0 = await huggingface_ref01_ent.load(huggingface_ref01_match_dt0)
    assert(null != huggingface_ref01_data_dt0)
...
function basicSetup(extra) {
  ...
  const entityDataFile =
    Path.resolve(__dirname,
      '../../../../.sdk/test/entity/huggingface/HuggingfaceTestData.json')
  ...
  let idmap = transform(
    ['huggingface01','huggingface02','huggingface03','package01','package02','package03','repo01','repo02','repo03'],
    {
      '`$PACK`': ['', {
        '`$KEY`': '`$COPY`',
