# Cloudsmith JavaScript SDK Reference

Complete API reference for the Cloudsmith JavaScript SDK.
...
```ts
const results = await client.Gon().list()
```
...
| `slug_perm` | `string` | No |  |
| `tagline` | `string` | No |  |
| `vulnerability_scan_results` | `Object` | Yes |  |
