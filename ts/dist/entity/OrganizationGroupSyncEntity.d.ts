...
declare class OrganizationGroupSyncEntity extends CloudsmithEntityBase<OrganizationGroupSync> {
    ...
    list(this: any, reqmatch?: OrganizationGroupSyncListMatch, ctrl?: Control): Promise<OrganizationGroupSyncEntity[]>;
    create(this: any, reqdata?: OrganizationGroupSyncCreateData, ctrl?: Control): Promise<OrganizationGroupSyncEntity>;
}
