...
(0, node_test_1.describe)('StatusEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        if (setup.live) {
            return (0, live_entity_1.runLiveEntity)(setup, { "active": true, "alias": { "field": {} }, "fields": [], "name": "status", "op": {}, "relations": { "ancestors": [["org"], ["package"], ["repo"]] }, "key$": "status", "name__orig": "status", "Name": "Status", "name_": "status", "name-": "status", "NAME": "STATUS", "index$": 107 }, { "active": true, "entity": "status", "key$": "BasicStatusFlow", "kind": "basic", "name": "BasicStatusFlow", "param": {}, "step": [] }, 'Status');
        }
...
function basicSetup(extra) {
    ...
    let idmap = transform(['status01', 'status02', 'status03', 'org01', 'org02', 'org03', 'package01', 'package02', 'package03', 'repo01', 'repo02', 'repo03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
