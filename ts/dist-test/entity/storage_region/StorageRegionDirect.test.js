...
(0, node_test_1.describe)('StorageRegionDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-storage_region', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-storage_region', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-storage_region', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-storage_region', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['CLOUDSMITH_TEST_STORAGE_REGION_ENTID'];
...
//# sourceMappingURL=StorageRegionDirect.test.js.map