...
(0, node_test_1.describe)('HexDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-hex', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-hex', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-hex', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-hex', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["identifier01", "owner01"]))
            return;
        const { client, calls } = setup;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['CLOUDSMITH_TEST_HEX_ENTID'];
...
//# sourceMappingURL=HexDirect.test.js.map