...
(0, node_test_1.describe)('DockerEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create', 'list', 'update', 'load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'docker.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(null != docker_ref01_data.id);
        // LIST
        ...
        (0, node_assert_1.default)(!isempty(select(docker_ref01_list, { id: docker_ref01_data.id })));
        // UPDATE
        ...
        (0, node_assert_1.default)(docker_ref01_resdata_up0.id === docker_ref01_data_up0.id);
        ...
        (0, node_assert_1.default)(docker_ref01_data_dt0.id === docker_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/docker/DockerTestData.json');
    ...
    let idmap = transform(['docker01', 'docker02', 'docker03', 'package01', 'package02', 'package03', 'repo01', 'repo02', 'repo03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['CLOUDSMITH_TEST_DOCKER_ENTID'];
...
//# sourceMappingURL=DockerEntity.test.js.map