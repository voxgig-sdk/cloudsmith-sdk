...
(0, node_test_1.describe)('OrgDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-org', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-org', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["member01"]))
            return;
    ...
    (0, node_test_1.test)('direct-list-org', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-org', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['CLOUDSMITH_TEST_ORG_ENTID'];
...
//# sourceMappingURL=OrgDirect.test.js.map