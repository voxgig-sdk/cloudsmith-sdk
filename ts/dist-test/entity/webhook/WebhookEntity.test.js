...
(0, node_test_1.describe)('WebhookEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        let webhook_ref01_data = Object.values(setup.data.existing.webhook)[0];
    });
});
function basicSetup(extra) {
    ...
    let idmap = transform(['webhook01', 'webhook02', 'webhook03', 'webhook01', 'webhook02', 'webhook03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['CLOUDSMITH_TEST_WEBHOOK_ENTID'];
