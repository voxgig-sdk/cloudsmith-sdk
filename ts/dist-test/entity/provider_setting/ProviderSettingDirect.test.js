...
(0, node_test_1.describe)('ProviderSettingDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-provider_setting', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-provider_setting', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["org01", "slug_perm01"]))
            return;
    ...
    (0, node_test_1.test)('direct-list-provider_setting', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-provider_setting', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['CLOUDSMITH_TEST_PROVIDER_SETTING_ENTID'];
...
//# sourceMappingURL=ProviderSettingDirect.test.js.map