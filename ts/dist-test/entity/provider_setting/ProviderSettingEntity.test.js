...
(0, node_test_1.describe)('ProviderSettingEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['list', 'load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'provider_setting.' + op, live))
                return;
        }
...
function basicSetup(extra) {
    ...
    let idmap = transform(['provider_setting01', 'provider_setting02', 'provider_setting03', 'org01', 'org02', 'org03', 'org01', 'org02', 'org03', 'openid_connect01', 'openid_connect02', 'openid_connect03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['CLOUDSMITH_TEST_PROVIDER_SETTING_ENTID'];
