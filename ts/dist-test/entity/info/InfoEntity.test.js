...
(0, node_test_1.describe)('InfoEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        if (setup.live) {
            return (0, live_entity_1.runLiveEntity)(setup, { "active": true, "alias": { "field": {} }, "fields": [], "name": "info", "op": {}, "relations": { "ancestors": [["file"]] }, "key$": "info", "name__orig": "info", "Name": "Info", "name_": "info", "name-": "info", "NAME": "INFO", "index$": 35 }, { "active": true, "entity": "info", "key$": "BasicInfoFlow", "kind": "basic", "name": "BasicInfoFlow", "param": {}, "step": [] }, 'Info');
        }
...
function basicSetup(extra) {
    ...
    let idmap = transform(['info01', 'info02', 'info03', 'file01', 'file02', 'file03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const env = (0, utility_1.envOverride)({
        'CLOUDSMITH_TEST_INFO_ENTID': idmap,
        'CLOUDSMITH_TEST_LIVE': 'FALSE',
        'CLOUDSMITH_TEST_EXPLAIN': 'FALSE',
        'CLOUDSMITH_APIKEY': '',
    });
    idmap = env['CLOUDSMITH_TEST_INFO_ENTID'];
    const live = 'TRUE' === env.CLOUDSMITH_TEST_LIVE;
    const transport = (0, live_runner_1.createLiveTransport)();
    if (live) {
        const rawIds = process.env['CLOUDSMITH_TEST_INFO_ENTID'];
