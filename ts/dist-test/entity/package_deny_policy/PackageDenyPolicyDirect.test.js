...
(0, node_test_1.describe)('PackageDenyPolicyDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-package_deny_policy', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-package_deny_policy', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-package_deny_policy', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-package_deny_policy', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["org01"]))
            return;
        const { client, calls } = setup;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['CLOUDSMITH_TEST_PACKAGE_DENY_POLICY_ENTID'];
...
//# sourceMappingURL=PackageDenyPolicyDirect.test.js.map