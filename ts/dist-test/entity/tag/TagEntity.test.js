...
(0, node_test_1.describe)('TagEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        if (setup.live) {
            return (0, live_entity_1.runLiveEntity)(setup, { "active": true, "alias": { "field": {} }, "fields": [], "name": "tag", "op": {}, "relations": { "ancestors": [["package"]] }, "key$": "tag", "name__orig": "tag", "Name": "Tag", "name_": "tag", "name-": "tag", "NAME": "TAG", "index$": 112 }, { "active": true, "entity": "tag", "key$": "BasicTagFlow", "kind": "basic", "name": "BasicTagFlow", "param": {}, "step": [] }, 'Tag');
        }
...
function basicSetup(extra) {
    ...
    let idmap = transform(['tag01', 'tag02', 'tag03', 'package01', 'package02', 'package03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const env = (0, utility_1.envOverride)({
        'CLOUDSMITH_TEST_TAG_ENTID': idmap,
        'CLOUDSMITH_TEST_LIVE': 'FALSE',
        'CLOUDSMITH_TEST_EXPLAIN': 'FALSE',
        'CLOUDSMITH_APIKEY': '',
    });
    idmap = env['CLOUDSMITH_TEST_TAG_ENTID'];
    const live = 'TRUE' === env.CLOUDSMITH_TEST_LIVE;
    const transport = (0, live_runner_1.createLiveTransport)();
    if (live) {
        const rawIds = process.env['CLOUDSMITH_TEST_TAG_ENTID'];
