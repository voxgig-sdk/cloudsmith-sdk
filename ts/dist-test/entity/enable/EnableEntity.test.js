...
(0, node_test_1.describe)('EnableEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        if (setup.live) {
            return (0, live_entity_1.runLiveEntity)(setup, { "active": true, "alias": { "field": {} }, "fields": [], "name": "enable", "op": {}, "relations": { "ancestors": [["entitlement"], ["org"], ["repo"]] }, "key$": "enable", "name__orig": "enable", "Name": "Enable", "name_": "enable", "name-": "enable", "NAME": "ENABLE", "index$": 22 }, { "active": true, "entity": "enable", "key$": "BasicEnableFlow", "kind": "basic", "name": "BasicEnableFlow", "param": {}, "step": [] }, 'Enable');
        }
...
function basicSetup(extra) {
    ...
    let idmap = transform(['enable01', 'enable02', 'enable03', 'entitlement01', 'entitlement02', 'entitlement03', 'org01', 'org02', 'org03', 'repo01', 'repo02', 'repo03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
