...
(0, node_test_1.describe)('MavenEntity', async () => {
    ...
    (0, node_test_1.test)('instance', async () => {
        ...
        const ent = testsdk.Maven();
        (0, node_assert_1.default)(null != ent);
    });
    (0, node_test_1.test)('basic', async (t) => {
        const live = 'TRUE' === process.env.CLOUDSMITH_TEST_LIVE;
        for (const op of ['create', 'list', 'update', 'load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'maven.' + op, live))
                return;
        }
        ...
        // CREATE
        const maven_ref01_ent = client.Maven();
        ...
        (0, node_assert_1.default)(null != maven_ref01_data.id);
        // LIST
        ...
        (0, node_assert_1.default)(!isempty(select(maven_ref01_list, { id: maven_ref01_data.id })));
        // UPDATE
        const maven_ref01_data_up0 = {};
        maven_ref01_data_up0.id = maven_ref01_data.id;
        ...
        (0, node_assert_1.default)(maven_ref01_resdata_up0.id === maven_ref01_data_up0.id);
        (0, node_assert_1.default)(maven_ref01_resdata_up0[maven_ref01_markdef_up0.name] === maven_ref01_markdef_up0.value);
        // LOAD
        const maven_ref01_match_dt0 = {};
        maven_ref01_match_dt0.id = maven_ref01_data.id;
        const maven_ref01_data_dt0 = (await maven_ref01_ent.load(maven_ref01_match_dt0)).data();
        (0, node_assert_1.default)(maven_ref01_data_dt0.id === maven_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/maven/MavenTestData.json');
    ...
    let idmap = transform(['maven01', 'maven02', 'maven03', 'package01', 'package02', 'package03', 'repo01', 'repo02', 'repo03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['CLOUDSMITH_TEST_MAVEN_ENTID'];
    ...
    idmap = env['CLOUDSMITH_TEST_MAVEN_ENTID'];
...
//# sourceMappingURL=MavenEntity.test.js.map