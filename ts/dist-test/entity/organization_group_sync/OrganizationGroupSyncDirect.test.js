...
(0, node_test_1.describe)('OrganizationGroupSyncDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-organization_group_sync', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-organization_group_sync', setup.live))
            return;
...
//# sourceMappingURL=OrganizationGroupSyncDirect.test.js.map