...
(0, node_test_1.describe)('FileEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'file.' + op, live))
                return;
        }
...
function basicSetup(extra) {
    ...
    let idmap = transform(['file01', 'file02', 'file03', 'file01', 'file02', 'file03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['CLOUDSMITH_TEST_FILE_ENTID'];
