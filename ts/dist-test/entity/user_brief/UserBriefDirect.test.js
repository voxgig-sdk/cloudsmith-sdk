...
(0, node_test_1.describe)('UserBriefDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-user_brief', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-user_brief', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['CLOUDSMITH_TEST_USER_BRIEF_ENTID'];
...
//# sourceMappingURL=UserBriefDirect.test.js.map