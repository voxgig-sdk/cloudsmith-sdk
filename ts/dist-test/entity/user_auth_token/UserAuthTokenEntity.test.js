...
(0, node_test_1.describe)('UserAuthTokenEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create']) {
            if (!live && (0, utility_1.maybeSkipControl)(t, 'entityOp', 'user_auth_token.' + op, live))
                return;
        }
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/user_auth_token/UserAuthTokenTestData.json');
    ...
    let idmap = transform(['user_auth_token01', 'user_auth_token02', 'user_auth_token03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=UserAuthTokenEntity.test.js.map