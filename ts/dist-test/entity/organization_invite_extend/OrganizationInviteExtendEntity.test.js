...
function basicSetup(extra) {
    ...
    let idmap = transform(['organization_invite_extend01', 'organization_invite_extend02', 'organization_invite_extend03', 'org01', 'org02', 'org03', 'invite01', 'invite02', 'invite03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
