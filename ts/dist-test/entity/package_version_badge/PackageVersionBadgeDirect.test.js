...
(0, node_test_1.describe)('PackageVersionBadgeDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-package_version_badge', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-package_version_badge', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["owner01", "package_format01", "package_identifier01", "package_name01", "package_version01", "repo01"]))
            return;
...
function directSetup(mockres) {
    ...
    const env = (0, utility_1.envOverride)({
        'CLOUDSMITH_TEST_PACKAGE_VERSION_BADGE_ENTID': {},
    ...
    if (live) {
        ...
        let idmap = env['CLOUDSMITH_TEST_PACKAGE_VERSION_BADGE_ENTID'];
...
//# sourceMappingURL=PackageVersionBadgeDirect.test.js.map