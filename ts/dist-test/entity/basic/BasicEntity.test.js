...
(0, node_test_1.describe)('BasicEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        if (setup.live) {
            return (0, live_entity_1.runLiveEntity)(setup, { "active": true, "alias": { "field": {} }, "fields": [], "name": "basic", "op": {}, "relations": { "ancestors": [] }, "key$": "basic", "name__orig": "basic", "Name": "Basic", "name_": "basic", "name-": "basic", "NAME": "BASIC", "index$": 3 }, { "active": true, "entity": "basic", "key$": "BasicBasicFlow", "kind": "basic", "name": "BasicBasicFlow", "param": {}, "step": [] }, 'Basic');
        }
...
function basicSetup(extra) {
    ...
    let idmap = transform(['basic01', 'basic02', 'basic03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    idmap = env['CLOUDSMITH_TEST_BASIC_ENTID'];
    const live = 'TRUE' === env.CLOUDSMITH_TEST_LIVE;
    const transport = (0, live_runner_1.createLiveTransport)();
    if (live) {
        const rawIds = process.env['CLOUDSMITH_TEST_BASIC_ENTID'];
