...
(0, node_test_1.describe)('BasicEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of []) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'basic.' + op, live))
                return;
        }
        ...
        if (setup.syntheticOnly) {
            t.skip('live entity test uses synthetic IDs from fixture — set CLOUDSMITH_TEST_BASIC_ENTID JSON to run live');
            return;
        }
...
function basicSetup(extra) {
    ...
    const idmapEnvVal = process.env['CLOUDSMITH_TEST_BASIC_ENTID'];
