...
(0, node_test_1.describe)('RepositoryAuditLogEntity', async () => {
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/repository_audit_log/RepositoryAuditLogTestData.json');
    ...
    let idmap = transform(['repository_audit_log01', 'repository_audit_log02', 'repository_audit_log03', 'audit_log01', 'audit_log02', 'audit_log03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=RepositoryAuditLogEntity.test.js.map