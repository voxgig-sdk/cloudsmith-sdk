...
(0, node_test_1.describe)('CargoEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create', 'list', 'update', 'load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'cargo.' + op, live))
                return;
        }
...
function basicSetup(extra) {
    ...
    let idmap = transform(['cargo01', 'cargo02', 'cargo03', 'package01', 'package02', 'package03', 'repo01', 'repo02', 'repo03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
