...
(0, node_test_1.describe)('OrganizationMembershipVisibilityUpdateEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['update']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'organization_membership_visibility_update.' + op, live))
                return;
        }
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/organization_membership_visibility_update/OrganizationMembershipVisibilityUpdateTestData.json');
    ...
    let idmap = transform(['organization_membership_visibility_update01', 'organization_membership_visibility_update02', 'organization_membership_visibility_update03', 'org01', 'org02', 'org03', 'member01', 'member02', 'member03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['CLOUDSMITH_TEST_ORGANIZATION_MEMBERSHIP_VISIBILITY_UPDATE_ENTID'];
...
//# sourceMappingURL=OrganizationMembershipVisibilityUpdateEntity.test.js.map