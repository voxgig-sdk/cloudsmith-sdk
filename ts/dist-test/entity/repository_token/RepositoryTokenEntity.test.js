...
(0, node_test_1.describe)('RepositoryTokenEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create', 'list', 'update', 'load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'repository_token.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(null != repository_token_ref01_data.id);
        // LIST
        ...
        (0, node_assert_1.default)(!isempty(select(repository_token_ref01_list, { id: repository_token_ref01_data.id })));
        // UPDATE
        ...
        (0, node_assert_1.default)(repository_token_ref01_resdata_up0.id === repository_token_ref01_data_up0.id);
        ...
        // LOAD
        const repository_token_ref01_match_dt0 = {};
        ...
        (0, node_assert_1.default)(repository_token_ref01_data_dt0.id === repository_token_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/repository_token/RepositoryTokenTestData.json');
    ...
    let idmap = transform(['repository_token01', 'repository_token02', 'repository_token03', 'entitlement01', 'entitlement02', 'entitlement03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['CLOUDSMITH_TEST_REPOSITORY_TOKEN_ENTID'];
...
//# sourceMappingURL=RepositoryTokenEntity.test.js.map