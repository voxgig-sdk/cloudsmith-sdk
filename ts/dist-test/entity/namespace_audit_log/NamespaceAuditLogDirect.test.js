...
(0, node_test_1.describe)('NamespaceAuditLogDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-namespace_audit_log', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-namespace_audit_log', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['CLOUDSMITH_TEST_NAMESPACE_AUDIT_LOG_ENTID'];
...
//# sourceMappingURL=NamespaceAuditLogDirect.test.js.map