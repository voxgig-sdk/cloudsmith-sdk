...
(0, node_test_1.describe)('NpmDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-npm', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-npm', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-npm', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-npm', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["identifier01", "owner01"]))
            return;
        const { client, calls } = setup;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['CLOUDSMITH_TEST_NPM_ENTID'];
...
//# sourceMappingURL=NpmDirect.test.js.map