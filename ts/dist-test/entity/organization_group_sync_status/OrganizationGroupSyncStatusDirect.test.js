...
(0, node_test_1.describe)('OrganizationGroupSyncStatusDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-organization_group_sync_status', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-organization_group_sync_status', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["org_id01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['CLOUDSMITH_TEST_ORGANIZATION_GROUP_SYNC_STATUS_ENTID'];
...
//# sourceMappingURL=OrganizationGroupSyncStatusDirect.test.js.map