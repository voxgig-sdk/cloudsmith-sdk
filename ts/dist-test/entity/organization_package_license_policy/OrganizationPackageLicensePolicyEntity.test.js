...
(0, node_test_1.describe)('OrganizationPackageLicensePolicyEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create', 'list', 'update', 'load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'organization_package_license_policy.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(null != organization_package_license_policy_ref01_data);
        // LIST
        ...
        (0, node_assert_1.default)(null != organization_package_license_policy_ref01_resdata_up0);
...
function basicSetup(extra) {
    ...
    const idmapEnvVal = process.env['CLOUDSMITH_TEST_ORGANIZATION_PACKAGE_LICENSE_POLICY_ENTID'];
