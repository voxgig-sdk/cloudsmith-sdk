...
(0, node_test_1.describe)('OrganizationPackageLicensePolicyDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.CloudsmithSDK({
    ...
    (0, node_test_1.test)('direct-load-organization_package_license_policy', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-organization_package_license_policy', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["org01"]))
            return;
    ...
    (0, node_test_1.test)('direct-list-organization_package_license_policy', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-organization_package_license_policy', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["org01"]))
            return;
        const { client, calls } = setup;
...
function liveScenariosActive() { return false && process.env.CLOUDSMITH_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.CloudsmithSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
            apikey: env.CLOUDSMITH_APIKEY,
        }));
        let idmap = env['CLOUDSMITH_TEST_ORGANIZATION_PACKAGE_LICENSE_POLICY_ENTID'];
...
//# sourceMappingURL=OrganizationPackageLicensePolicyDirect.test.js.map