...
(0, node_test_1.describe)('NugetDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-nuget', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-nuget', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-nuget', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-nuget', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["identifier01", "owner01"]))
            return;
        const { client, calls } = setup;
...
//# sourceMappingURL=NugetDirect.test.js.map