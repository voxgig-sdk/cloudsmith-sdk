...
(0, node_test_1.describe)('NugetEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        (0, node_assert_1.default)(null != nuget_ref01_data.id);
        // LIST
        ...
        (0, node_assert_1.default)(!isempty(select(nuget_ref01_list, { id: nuget_ref01_data.id })));
        // UPDATE
        ...
        (0, node_assert_1.default)(nuget_ref01_resdata_up0.id === nuget_ref01_data_up0.id);
        ...
        (0, node_assert_1.default)(nuget_ref01_data_dt0.id === nuget_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    let idmap = transform(['nuget01', 'nuget02', 'nuget03', 'package01', 'package02', 'package03', 'repo01', 'repo02', 'repo03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['CLOUDSMITH_TEST_NUGET_ENTID'];
