...
(0, node_test_1.describe)('HuggingfaceEntity', async () => {
    ...
    (0, node_test_1.test)('instance', async () => {
        ...
        const ent = testsdk.Huggingface();
        (0, node_assert_1.default)(null != ent);
    });
    (0, node_test_1.test)('basic', async (t) => {
        const live = 'TRUE' === process.env.CLOUDSMITH_TEST_LIVE;
        for (const op of ['create', 'list', 'update', 'load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'huggingface.' + op, live))
                return;
        }
        ...
        // CREATE
        const huggingface_ref01_ent = client.Huggingface();
        ...
        (0, node_assert_1.default)(null != huggingface_ref01_data.id);
        // LIST
        ...
        (0, node_assert_1.default)(!isempty(select(huggingface_ref01_list, { id: huggingface_ref01_data.id })));
        // UPDATE
        ...
        (0, node_assert_1.default)(huggingface_ref01_resdata_up0.id === huggingface_ref01_data_up0.id);
        ...
        // LOAD
        const huggingface_ref01_match_dt0 = {};
        ...
        (0, node_assert_1.default)(huggingface_ref01_data_dt0.id === huggingface_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/huggingface/HuggingfaceTestData.json');
    ...
    let idmap = transform(['huggingface01', 'huggingface02', 'huggingface03', 'package01', 'package02', 'package03', 'repo01', 'repo02', 'repo03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['CLOUDSMITH_TEST_HUGGINGFACE_ENTID'];
    ...
    idmap = env['CLOUDSMITH_TEST_HUGGINGFACE_ENTID'];
...
//# sourceMappingURL=HuggingfaceEntity.test.js.map