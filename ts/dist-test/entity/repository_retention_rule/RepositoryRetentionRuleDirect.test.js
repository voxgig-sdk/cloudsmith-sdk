...
(0, node_test_1.describe)('RepositoryRetentionRuleDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-repository_retention_rule', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-repository_retention_rule', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['CLOUDSMITH_TEST_REPOSITORY_RETENTION_RULE_ENTID'];
...
//# sourceMappingURL=RepositoryRetentionRuleDirect.test.js.map