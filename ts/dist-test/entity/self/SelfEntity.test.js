...
(0, node_test_1.describe)('SelfEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        if (setup.live) {
            return (0, live_entity_1.runLiveEntity)(setup, { "active": true, "alias": { "field": {} }, "fields": [], "name": "self", "op": {}, "relations": { "ancestors": [] }, "key$": "self", "name__orig": "self", "Name": "Self", "name_": "self", "name-": "self", "NAME": "SELF", "index$": 105 }, { "active": true, "entity": "self", "key$": "BasicSelfFlow", "kind": "basic", "name": "BasicSelfFlow", "param": {}, "step": [] }, 'Self');
        }
...
function basicSetup(extra) {
    ...
    idmap = env['CLOUDSMITH_TEST_SELF_ENTID'];
    const live = 'TRUE' === env.CLOUDSMITH_TEST_LIVE;
    const transport = (0, live_runner_1.createLiveTransport)();
    if (live) {
        const rawIds = process.env['CLOUDSMITH_TEST_SELF_ENTID'];
