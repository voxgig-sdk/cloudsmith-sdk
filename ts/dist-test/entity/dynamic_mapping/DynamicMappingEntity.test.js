...
function basicSetup(extra) {
    ...
    let idmap = transform(['dynamic_mapping01', 'dynamic_mapping02', 'dynamic_mapping03', 'org01', 'org02', 'org03', 'openid_connect01', 'openid_connect02', 'openid_connect03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
