...
(0, node_test_1.describe)('UserProfileEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        let user_profile_ref01_data = Object.values(setup.data.existing.user_profile)[0];
        // LOAD
        const user_profile_ref01_ent = client.UserProfile();
        const user_profile_ref01_match_dt0 = {};
        ...
        (0, node_assert_1.default)(user_profile_ref01_data_dt0.id === user_profile_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/user_profile/UserProfileTestData.json');
    ...
    let idmap = transform(['user_profile01', 'user_profile02', 'user_profile03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=UserProfileEntity.test.js.map