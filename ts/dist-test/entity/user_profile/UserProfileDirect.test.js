...
(0, node_test_1.describe)('UserProfileDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-user_profile', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-user_profile', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['CLOUDSMITH_TEST_USER_PROFILE_ENTID'];
...
//# sourceMappingURL=UserProfileDirect.test.js.map