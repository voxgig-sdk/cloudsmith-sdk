...
(0, node_test_1.describe)('DebEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create', 'list', 'update', 'load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'deb.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(null != deb_ref01_data.id);
        // LIST
        ...
        (0, node_assert_1.default)(!isempty(select(deb_ref01_list, { id: deb_ref01_data.id })));
        // UPDATE
        ...
        (0, node_assert_1.default)(deb_ref01_resdata_up0.id === deb_ref01_data_up0.id);
        ...
        (0, node_assert_1.default)(deb_ref01_data_dt0.id === deb_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/deb/DebTestData.json');
    ...
    let idmap = transform(['deb01', 'deb02', 'deb03', 'package01', 'package02', 'package03', 'repo01', 'repo02', 'repo03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['CLOUDSMITH_TEST_DEB_ENTID'];
...
//# sourceMappingURL=DebEntity.test.js.map