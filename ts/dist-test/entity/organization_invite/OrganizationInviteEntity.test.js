...
(0, node_test_1.describe)('OrganizationInviteEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create', 'list', 'update']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'organization_invite.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(null != organization_invite_ref01_data);
        // LIST
        ...
        (0, node_assert_1.default)(null != organization_invite_ref01_resdata_up0);
