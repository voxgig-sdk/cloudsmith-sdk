...
(0, node_test_1.describe)('TeamEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        if (setup.live) {
            return (0, live_entity_1.runLiveEntity)(setup, { "active": true, "alias": { "field": {} }, "fields": [], "name": "team", "op": {}, "relations": { "ancestors": [["org"]] }, "key$": "team", "name__orig": "team", "Name": "Team", "name_": "team", "name-": "team", "NAME": "TEAM", "index$": 113 }, { "active": true, "entity": "team", "key$": "BasicTeamFlow", "kind": "basic", "name": "BasicTeamFlow", "param": {}, "step": [] }, 'Team');
        }
...
function basicSetup(extra) {
    ...
    let idmap = transform(['team01', 'team02', 'team03', 'org01', 'org02', 'org03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const env = (0, utility_1.envOverride)({
        'CLOUDSMITH_TEST_TEAM_ENTID': idmap,
        'CLOUDSMITH_TEST_LIVE': 'FALSE',
        'CLOUDSMITH_TEST_EXPLAIN': 'FALSE',
        'CLOUDSMITH_APIKEY': '',
    });
    idmap = env['CLOUDSMITH_TEST_TEAM_ENTID'];
    const live = 'TRUE' === env.CLOUDSMITH_TEST_LIVE;
    const transport = (0, live_runner_1.createLiveTransport)();
    if (live) {
        const rawIds = process.env['CLOUDSMITH_TEST_TEAM_ENTID'];
