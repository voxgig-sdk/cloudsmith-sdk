...
(0, node_test_1.describe)('OrganizationTeamEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create', 'list', 'update', 'load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'organization_team.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(null != organization_team_ref01_data);
        // LIST
        ...
        (0, node_assert_1.default)(null != organization_team_ref01_resdata_up0);
...
function basicSetup(extra) {
    ...
    const idmapEnvVal = process.env['CLOUDSMITH_TEST_ORGANIZATION_TEAM_ENTID'];
