...
(0, node_test_1.describe)('PythonEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create', 'list', 'update', 'load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'python.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(null != python_ref01_data.id);
        // LIST
        ...
        (0, node_assert_1.default)(!isempty(select(python_ref01_list, { id: python_ref01_data.id })));
        // UPDATE
        const python_ref01_data_up0 = {};
        python_ref01_data_up0.id = python_ref01_data.id;
        ...
        (0, node_assert_1.default)(python_ref01_resdata_up0.id === python_ref01_data_up0.id);
        ...
        python_ref01_match_dt0.id = python_ref01_data.id;
        const python_ref01_data_dt0 = (await python_ref01_ent.load(python_ref01_match_dt0)).data();
        (0, node_assert_1.default)(python_ref01_data_dt0.id === python_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/python/PythonTestData.json');
    ...
    let idmap = transform(['python01', 'python02', 'python03', 'package01', 'package02', 'package03', 'repo01', 'repo02', 'repo03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['CLOUDSMITH_TEST_PYTHON_ENTID'];
...
//# sourceMappingURL=PythonEntity.test.js.map