...
(0, node_test_1.describe)('SwiftEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create', 'list', 'update', 'load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'swift.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(null != swift_ref01_data.id);
        // LIST
        ...
        (0, node_assert_1.default)(!isempty(select(swift_ref01_list, { id: swift_ref01_data.id })));
        // UPDATE
        ...
        (0, node_assert_1.default)(swift_ref01_resdata_up0.id === swift_ref01_data_up0.id);
        ...
        (0, node_assert_1.default)(swift_ref01_data_dt0.id === swift_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/swift/SwiftTestData.json');
    ...
    let idmap = transform(['swift01', 'swift02', 'swift03', 'package01', 'package02', 'package03', 'repo01', 'repo02', 'repo03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=SwiftEntity.test.js.map