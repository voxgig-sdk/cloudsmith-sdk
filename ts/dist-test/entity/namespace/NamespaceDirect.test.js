...
(0, node_test_1.describe)('NamespaceDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-namespace', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-namespace', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-namespace', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-namespace', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    const env = (0, utility_1.envOverride)({
        'CLOUDSMITH_TEST_NAMESPACE_ENTID': {},
    ...
    if (live) {
        ...
        let idmap = env['CLOUDSMITH_TEST_NAMESPACE_ENTID'];
...
//# sourceMappingURL=NamespaceDirect.test.js.map