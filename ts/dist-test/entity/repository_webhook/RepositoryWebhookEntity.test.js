...
function basicSetup(extra) {
    ...
    let idmap = transform(['repository_webhook01', 'repository_webhook02', 'repository_webhook03', 'webhook01', 'webhook02', 'webhook03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['CLOUDSMITH_TEST_REPOSITORY_WEBHOOK_ENTID'];
