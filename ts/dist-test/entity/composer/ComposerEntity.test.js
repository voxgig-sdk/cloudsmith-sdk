...
function basicSetup(extra) {
    ...
    let idmap = transform(['composer01', 'composer02', 'composer03', 'package01', 'package02', 'package03', 'repo01', 'repo02', 'repo03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['CLOUDSMITH_TEST_COMPOSER_ENTID'];
