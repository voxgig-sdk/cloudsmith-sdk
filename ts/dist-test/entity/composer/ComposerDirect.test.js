...
(0, node_test_1.describe)('ComposerDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-composer', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-composer', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-composer', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-composer', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["identifier01", "owner01"]))
            return;
        const { client, calls } = setup;
...
function directSetup(mockres) {
    ...
    const env = (0, utility_1.envOverride)({
        'CLOUDSMITH_TEST_COMPOSER_ENTID': {},
    ...
    if (live) {
        ...
        let idmap = env['CLOUDSMITH_TEST_COMPOSER_ENTID'];
...
//# sourceMappingURL=ComposerDirect.test.js.map