...
(0, node_test_1.describe)('UserAuthenticationTokenEntity', async () => {
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/user_authentication_token/UserAuthenticationTokenTestData.json');
    ...
    let idmap = transform(['user_authentication_token01', 'user_authentication_token02', 'user_authentication_token03', 'token01', 'token02', 'token03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=UserAuthenticationTokenEntity.test.js.map