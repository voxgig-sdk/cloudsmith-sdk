...
(0, node_test_1.describe)('GonEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create', 'list', 'update', 'load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'gon.' + op, live))
                return;
        }
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/gon/GonTestData.json');
    ...
    let idmap = transform(['gon01', 'gon02', 'gon03', 'package01', 'package02', 'package03', 'repo01', 'repo02', 'repo03', 'repo01', 'repo02', 'repo03', 'go01', 'go02', 'go03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['CLOUDSMITH_TEST_GON_ENTID'];
...
//# sourceMappingURL=GonEntity.test.js.map