...
(0, node_test_1.describe)('DistributionFullDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-distribution_full', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-distribution_full', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["slug01"]))
            return;
    ...
    (0, node_test_1.test)('direct-list-distribution_full', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-distribution_full', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['CLOUDSMITH_TEST_DISTRIBUTION_FULL_ENTID'];
...
//# sourceMappingURL=DistributionFullDirect.test.js.map