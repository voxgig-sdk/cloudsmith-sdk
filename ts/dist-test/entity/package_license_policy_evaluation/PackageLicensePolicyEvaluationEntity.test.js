...
(0, node_test_1.describe)('PackageLicensePolicyEvaluationEntity', async () => {
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/package_license_policy_evaluation/PackageLicensePolicyEvaluationTestData.json');
    ...
    let idmap = transform(['package_license_policy_evaluation01', 'package_license_policy_evaluation02', 'package_license_policy_evaluation03', 'org01', 'org02', 'org03', 'license_policy01', 'license_policy02', 'license_policy03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=PackageLicensePolicyEvaluationEntity.test.js.map