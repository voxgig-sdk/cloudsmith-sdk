...
(0, node_test_1.describe)('PackageLicensePolicyEvaluationDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-package_license_policy_evaluation', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-package_license_policy_evaluation', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["license_policy01", "org01"]))
            return;
    ...
    (0, node_test_1.test)('direct-list-package_license_policy_evaluation', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-package_license_policy_evaluation', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["org01", "policy_slug_perm01"]))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
//# sourceMappingURL=PackageLicensePolicyEvaluationDirect.test.js.map