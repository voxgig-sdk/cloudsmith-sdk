...
(0, node_test_1.describe)('RepositoryGeoIpTestAddressEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'repository_geo_ip_test_address.' + op, live))
                return;
        }
...
function basicSetup(extra) {
    ...
    let idmap = transform(['repository_geo_ip_test_address01', 'repository_geo_ip_test_address02', 'repository_geo_ip_test_address03', 'repo01', 'repo02', 'repo03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
