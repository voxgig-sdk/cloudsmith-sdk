...
function envOverride(m) {
    if ('TRUE' === process.env.CLOUDSMITH_TEST_LIVE ||
        'TRUE' === process.env.CLOUDSMITH_TEST_OVERRIDE) {
    ...
    m.CLOUDSMITH_TEST_EXPLAIN = process.env.CLOUDSMITH_TEST_EXPLAIN || m.CLOUDSMITH_TEST_EXPLAIN;
    return m;
}
