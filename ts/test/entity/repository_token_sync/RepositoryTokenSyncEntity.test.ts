...
describe('RepositoryTokenSyncEntity', async () => {
...
function basicSetup(extra?: any) {
  ...
  const entityDataFile =
    Path.resolve(__dirname, 
      '../../../../.sdk/test/entity/repository_token_sync/RepositoryTokenSyncTestData.json')
  ...
  let idmap = transform(
    ['repository_token_sync01','repository_token_sync02','repository_token_sync03','entitlement01','entitlement02','entitlement03'],
    {
      '`$PACK`': ['', {
        '`$KEY`': '`$COPY`',
