...
|---|---|---|
| `ts/` | @voxgig-sdk/cloudsmith | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/cloudsmith \
      --repository voxgig-sdk/cloudsmith-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/cloudsmith` shows it, and
`npm trust revoke @voxgig-sdk/cloudsmith --id=<id>` removes it.
