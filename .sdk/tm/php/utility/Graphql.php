...
// Cloudsmith SDK utility: graphql
//
...
class CloudsmithGraphql
{
    ...
    // equivalent.
    public static function body(CloudsmithContext $ctx): mixed
    {
    ...
    public static function errors(CloudsmithContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
