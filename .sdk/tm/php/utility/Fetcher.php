...
// Cloudsmith SDK utility: fetcher

class CloudsmithFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; CloudsmithSDK/1.0)';
    ...
    public static function call(CloudsmithContext $ctx, string $fullurl, array $fetchdef): array
    {
