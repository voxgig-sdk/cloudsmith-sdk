...
// Cloudsmith SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class CloudsmithTransformResponse
{
    public static function call(CloudsmithContext $ctx): mixed
    {
        ...
        $transform = CloudsmithHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
