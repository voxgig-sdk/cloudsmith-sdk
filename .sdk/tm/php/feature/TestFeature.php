...
// Cloudsmith SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class CloudsmithTestFeature extends CloudsmithBaseFeature
{
    ...
    public function init(CloudsmithContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (CloudsmithContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = CloudsmithParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (CloudsmithContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(CloudsmithContext $ctx, $op, $args): array
    {
