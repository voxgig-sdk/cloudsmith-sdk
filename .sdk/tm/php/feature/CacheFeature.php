...
class CloudsmithCacheFeature extends CloudsmithBaseFeature
{
    ...
    private function _through(CloudsmithContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
