...
class CloudsmithNetsimFeature extends CloudsmithBaseFeature
{
    ...
    private function _simulate(CloudsmithContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(CloudsmithContext $ctx, array $applied): void
    {
        $client = $this->client;
