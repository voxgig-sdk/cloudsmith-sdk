...
{
    private static function utility(): CloudsmithUtility
    {
        return new CloudsmithUtility();
    }
    ...
    private static function ctx(array $over = []): CloudsmithContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new CloudsmithContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new CloudsmithOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof CloudsmithError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new CloudsmithOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = CloudsmithMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new CloudsmithOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = CloudsmithMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new CloudsmithOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = CloudsmithMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new CloudsmithSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = CloudsmithMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new CloudsmithResponse([]),
            'result' => new CloudsmithResult([]),
        ]);
        [, $err] = CloudsmithMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new CloudsmithSpec([]),
            'response' => null,
            'result' => new CloudsmithResult([]),
        ]);
        [, $err] = CloudsmithMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new CloudsmithSpec(['step' => 's']),
            'response' => new CloudsmithResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new CloudsmithResult([]),
        ]);
        [, $err] = CloudsmithMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new CloudsmithSpec(['step' => 's']),
            'response' => new CloudsmithResponse(self::resp(200, ['v' => 1])),
            'result' => new CloudsmithResult([]),
        ]);
        [, $err] = CloudsmithMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new CloudsmithSpec(['step' => 's']),
            'response' => new CloudsmithResponse(self::resp(200, ['v' => 2])),
            'result' => new CloudsmithResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        CloudsmithMakeResponse::call($ctx);
    ...
    {
        $preset = new CloudsmithResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new CloudsmithSpec([]),
            'response' => new CloudsmithResponse([]),
            'result' => new CloudsmithResult([]),
        ...
        [$got, $err] = CloudsmithMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new CloudsmithResult([])]);
        [, $err] = CloudsmithMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new CloudsmithSpec([]), 'result' => null]);
        [, $err] = CloudsmithMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new CloudsmithSpec(['step' => 's']),
            'result' => new CloudsmithResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new CloudsmithOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = CloudsmithMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new CloudsmithSpec(['step' => 's']),
            'result' => new CloudsmithResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new CloudsmithOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = CloudsmithMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new CloudsmithResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new CloudsmithSpec([]),
            'result' => new CloudsmithResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = CloudsmithMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = CloudsmithMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new CloudsmithError('boom', 'boom');
        $utility->fetcher = function (CloudsmithContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new CloudsmithSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = CloudsmithMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (CloudsmithContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = CloudsmithMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(CloudsmithResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        CloudsmithMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (CloudsmithContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new CloudsmithSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = CloudsmithMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new CloudsmithResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new CloudsmithSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = CloudsmithMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = CloudsmithMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = CloudsmithMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new CloudsmithResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, CloudsmithDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new CloudsmithResult(['ok' => false])]);
        $this->expectException(CloudsmithError::class);
        CloudsmithDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new CloudsmithResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', CloudsmithMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        CloudsmithMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new CloudsmithBaseFeature();
        $b = new CloudsmithBaseFeature();
        CloudsmithFeatureAdd::call($ctx, $a);
        CloudsmithFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): CloudsmithBaseFeature
    {
        $f = new CloudsmithBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        CloudsmithFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): CloudsmithContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new CloudsmithSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = CloudsmithPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        CloudsmithPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new CloudsmithResponse(['headers' => null]),
            'result' => new CloudsmithResult([]),
        ]);
        CloudsmithResultHeaders::call($ctx);
