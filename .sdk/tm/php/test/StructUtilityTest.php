...
// Cloudsmith SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = CloudsmithOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(CloudsmithOmni::structfix($now, Struct::undef()))
                        !== json_encode(CloudsmithOmni::structfix($val, Struct::undef()))) {
