...
class CloudsmithTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = CloudsmithTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = CloudsmithTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = CloudsmithTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
