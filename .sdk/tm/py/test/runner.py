...
class CloudsmithTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = CloudsmithTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = CloudsmithTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = CloudsmithTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
