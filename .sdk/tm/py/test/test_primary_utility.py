...
from projectname_sdk import CloudsmithSDK
from projectname_sdk.core.spec import CloudsmithSpec
from projectname_sdk.core.result import CloudsmithResult
from projectname_sdk.core.response import CloudsmithResponse
from projectname_sdk.core.operation import CloudsmithOperation
from projectname_sdk.core.error import CloudsmithError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import CloudsmithBaseFeature
...
def _err_from_map(m):
    ...
    if msg == "":
        return None
    code = m.get("code", "")
    return CloudsmithError(code, msg)
...
class TestPrimaryUtility:
    ...
    def test_exists(self):
        client = CloudsmithSDK.test(None, None)
    ...
    def test_feature_init_basic(self):
        init_client = CloudsmithSDK.test(None, None)
        ...
        class TestInitFeature(CloudsmithBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(CloudsmithBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = CloudsmithSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = CloudsmithSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = CloudsmithSDK.test(None, setup_opts)
