...
from projectname_sdk.core.control import CloudsmithControl
...
class CloudsmithContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, CloudsmithSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, CloudsmithResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, CloudsmithResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return CloudsmithError(code, msg, self)
