...
local RepositoryTokenEntity = {}
RepositoryTokenEntity.__index = RepositoryTokenEntity


function RepositoryTokenEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, RepositoryTokenEntity)
  self._name = "repository_token"
  self._client = client
...
function RepositoryTokenEntity:get_name()
  return self._name
end


function RepositoryTokenEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return RepositoryTokenEntity.new(self._client, opts)
end
...
function RepositoryTokenEntity:mark_deleted()
  self._deleted = true
end


function RepositoryTokenEntity:deleted()
  return true == self._deleted
end


function RepositoryTokenEntity:data_set(args)
  if args ~= nil then
...
function RepositoryTokenEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function RepositoryTokenEntity:match_set(args)
  if args ~= nil then
...
function RepositoryTokenEntity:match_get()
...
function RepositoryTokenEntity:stream(action, args, callopts)
...
---@param reqmatch RepositoryTokenLoadMatch
---@param ctrl? table
---@return RepositoryToken
---@return string? err
function RepositoryTokenEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch RepositoryTokenListMatch
---@param ctrl? table
---@return RepositoryToken[]
---@return string? err
function RepositoryTokenEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata RepositoryTokenCreateData
---@param ctrl? table
---@return RepositoryToken
---@return string? err
function RepositoryTokenEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata RepositoryTokenUpdateData
---@param ctrl? table
---@return RepositoryToken
---@return string? err
function RepositoryTokenEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
function RepositoryTokenEntity:_run_op(ctx, post_done)
  local utility = self._utility
