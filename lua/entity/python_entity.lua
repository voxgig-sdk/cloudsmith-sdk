...
local PythonEntity = {}
PythonEntity.__index = PythonEntity


function PythonEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, PythonEntity)
  self._name = "python"
  self._client = client
...
function PythonEntity:get_name()
  return self._name
end


function PythonEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return PythonEntity.new(self._client, opts)
end
...
function PythonEntity:mark_deleted()
  self._deleted = true
end


function PythonEntity:deleted()
  return true == self._deleted
end


function PythonEntity:data_set(args)
  if args ~= nil then
...
function PythonEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function PythonEntity:match_set(args)
  if args ~= nil then
...
function PythonEntity:match_get()
...
function PythonEntity:stream(action, args, callopts)
...
---@param reqmatch PythonLoadMatch
---@param ctrl? table
---@return Python
---@return string? err
function PythonEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch PythonListMatch
---@param ctrl? table
---@return Python[]
---@return string? err
function PythonEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata PythonCreateData
---@param ctrl? table
---@return Python
---@return string? err
function PythonEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata PythonUpdateData
---@param ctrl? table
---@return Python
---@return string? err
function PythonEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
function PythonEntity:_run_op(ctx, post_done)
  local utility = self._utility
