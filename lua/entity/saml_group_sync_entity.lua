-- Cloudsmith SDK SamlGroupSync entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local SamlGroupSyncEntity = {}
SamlGroupSyncEntity.__index = SamlGroupSyncEntity


function SamlGroupSyncEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, SamlGroupSyncEntity)
  self._name = "saml_group_sync"
  self._client = client
...
function SamlGroupSyncEntity:get_name()
  return self._name
end


function SamlGroupSyncEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return SamlGroupSyncEntity.new(self._client, opts)
end
...
function SamlGroupSyncEntity:mark_deleted()
  self._deleted = true
end


function SamlGroupSyncEntity:deleted()
  return true == self._deleted
end


function SamlGroupSyncEntity:data_set(args)
  if args ~= nil then
...
function SamlGroupSyncEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function SamlGroupSyncEntity:match_set(args)
  if args ~= nil then
...
function SamlGroupSyncEntity:match_get()
...
function SamlGroupSyncEntity:stream(action, args, callopts)
...
function SamlGroupSyncEntity:_run_op(ctx, post_done)
  local utility = self._utility
