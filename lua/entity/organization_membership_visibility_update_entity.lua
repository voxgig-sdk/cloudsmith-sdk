-- Cloudsmith SDK OrganizationMembershipVisibilityUpdate entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local OrganizationMembershipVisibilityUpdateEntity = {}
OrganizationMembershipVisibilityUpdateEntity.__index = OrganizationMembershipVisibilityUpdateEntity


function OrganizationMembershipVisibilityUpdateEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, OrganizationMembershipVisibilityUpdateEntity)
  self._name = "organization_membership_visibility_update"
  self._client = client
...
function OrganizationMembershipVisibilityUpdateEntity:get_name()
  return self._name
end


function OrganizationMembershipVisibilityUpdateEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return OrganizationMembershipVisibilityUpdateEntity.new(self._client, opts)
end
...
function OrganizationMembershipVisibilityUpdateEntity:mark_deleted()
  self._deleted = true
end


function OrganizationMembershipVisibilityUpdateEntity:deleted()
  return true == self._deleted
end


function OrganizationMembershipVisibilityUpdateEntity:data_set(args)
  if args ~= nil then
...
function OrganizationMembershipVisibilityUpdateEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function OrganizationMembershipVisibilityUpdateEntity:match_set(args)
  if args ~= nil then
...
function OrganizationMembershipVisibilityUpdateEntity:match_get()
...
function OrganizationMembershipVisibilityUpdateEntity:stream(action, args, callopts)
...
---@param reqdata OrganizationMembershipVisibilityUpdateUpdateData
---@param ctrl? table
---@return OrganizationMembershipVisibilityUpdate
---@return string? err
function OrganizationMembershipVisibilityUpdateEntity:update(reqdata, ctrl)
  local utility = self._utility
...
function OrganizationMembershipVisibilityUpdateEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return OrganizationMembershipVisibilityUpdateEntity
