-- Cloudsmith SDK Gon9 entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local Gon9Entity = {}
Gon9Entity.__index = Gon9Entity


function Gon9Entity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, Gon9Entity)
  self._name = "gon9"
  self._client = client
...
function Gon9Entity:get_name()
  return self._name
end


function Gon9Entity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return Gon9Entity.new(self._client, opts)
end


function Gon9Entity:data_set(args)
  if args ~= nil then
...
function Gon9Entity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function Gon9Entity:match_set(args)
  if args ~= nil then
...
function Gon9Entity:stream(action, args, callopts)
...
---@param reqdata Gon9UpdateData
---@param ctrl? table
---@return Gon9
---@return string? err
function Gon9Entity:update(reqdata, ctrl)
  local utility = self._utility
...
function Gon9Entity:_run_op(ctx, post_done)
  local utility = self._utility
