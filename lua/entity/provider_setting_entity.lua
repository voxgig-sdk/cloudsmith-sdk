...
local ProviderSettingEntity = {}
ProviderSettingEntity.__index = ProviderSettingEntity


function ProviderSettingEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ProviderSettingEntity)
  self._name = "provider_setting"
  self._client = client
...
function ProviderSettingEntity:get_name()
  return self._name
end


function ProviderSettingEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ProviderSettingEntity.new(self._client, opts)
end
...
function ProviderSettingEntity:mark_deleted()
  self._deleted = true
end


function ProviderSettingEntity:deleted()
  return true == self._deleted
end


function ProviderSettingEntity:data_set(args)
  if args ~= nil then
...
function ProviderSettingEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ProviderSettingEntity:match_set(args)
  if args ~= nil then
...
function ProviderSettingEntity:match_get()
...
function ProviderSettingEntity:stream(action, args, callopts)
...
---@param reqmatch ProviderSettingLoadMatch
---@param ctrl? table
---@return ProviderSetting
---@return string? err
function ProviderSettingEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch ProviderSettingListMatch
---@param ctrl? table
---@return ProviderSetting[]
---@return string? err
function ProviderSettingEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
function ProviderSettingEntity:_run_op(ctx, post_done)
  local utility = self._utility
