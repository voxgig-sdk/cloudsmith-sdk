...
local RepositoryWebhookEntity = {}
RepositoryWebhookEntity.__index = RepositoryWebhookEntity


function RepositoryWebhookEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, RepositoryWebhookEntity)
  self._name = "repository_webhook"
  self._client = client
...
function RepositoryWebhookEntity:get_name()
  return self._name
end


function RepositoryWebhookEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return RepositoryWebhookEntity.new(self._client, opts)
end
...
function RepositoryWebhookEntity:mark_deleted()
  self._deleted = true
end


function RepositoryWebhookEntity:deleted()
  return true == self._deleted
end


function RepositoryWebhookEntity:data_set(args)
  if args ~= nil then
...
function RepositoryWebhookEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function RepositoryWebhookEntity:match_set(args)
  if args ~= nil then
...
function RepositoryWebhookEntity:match_get()
...
function RepositoryWebhookEntity:stream(action, args, callopts)
...
---@param reqmatch RepositoryWebhookLoadMatch
---@param ctrl? table
---@return RepositoryWebhook
---@return string? err
function RepositoryWebhookEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch RepositoryWebhookListMatch
---@param ctrl? table
---@return RepositoryWebhook[]
---@return string? err
function RepositoryWebhookEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata RepositoryWebhookCreateData
---@param ctrl? table
---@return RepositoryWebhook
---@return string? err
function RepositoryWebhookEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata RepositoryWebhookUpdateData
---@param ctrl? table
---@return RepositoryWebhook
---@return string? err
function RepositoryWebhookEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
function RepositoryWebhookEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return RepositoryWebhookEntity
