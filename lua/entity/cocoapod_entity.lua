-- Cloudsmith SDK Cocoapod entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local CocoapodEntity = {}
CocoapodEntity.__index = CocoapodEntity


function CocoapodEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, CocoapodEntity)
  self._name = "cocoapod"
  self._client = client
...
function CocoapodEntity:get_name()
  return self._name
end


function CocoapodEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return CocoapodEntity.new(self._client, opts)
end
...
function CocoapodEntity:mark_deleted()
  self._deleted = true
end


function CocoapodEntity:deleted()
  return true == self._deleted
end


function CocoapodEntity:data_set(args)
  if args ~= nil then
...
function CocoapodEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function CocoapodEntity:match_set(args)
  if args ~= nil then
...
function CocoapodEntity:match_get()
...
function CocoapodEntity:stream(action, args, callopts)
...
function CocoapodEntity:_run_op(ctx, post_done)
  local utility = self._utility
