...
local HexEntity = {}
HexEntity.__index = HexEntity


function HexEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, HexEntity)
  self._name = "hex"
  self._client = client
...
function HexEntity:get_name()
  return self._name
end


function HexEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return HexEntity.new(self._client, opts)
end
...
function HexEntity:mark_deleted()
  self._deleted = true
end


function HexEntity:deleted()
  return true == self._deleted
end


function HexEntity:data_set(args)
  if args ~= nil then
...
function HexEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function HexEntity:match_set(args)
  if args ~= nil then
...
function HexEntity:stream(action, args, callopts)
...
---@param reqmatch HexLoadMatch
---@param ctrl? table
---@return Hex
---@return string? err
function HexEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch HexListMatch
---@param ctrl? table
---@return Hex[]
---@return string? err
function HexEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata HexCreateData
---@param ctrl? table
---@return Hex
---@return string? err
function HexEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata HexUpdateData
---@param ctrl? table
---@return Hex
---@return string? err
function HexEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
function HexEntity:_run_op(ctx, post_done)
  local utility = self._utility
