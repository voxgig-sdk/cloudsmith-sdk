...
local PackageDenyPolicyEntity = {}
PackageDenyPolicyEntity.__index = PackageDenyPolicyEntity


function PackageDenyPolicyEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, PackageDenyPolicyEntity)
  self._name = "package_deny_policy"
  self._client = client
...
function PackageDenyPolicyEntity:get_name()
  return self._name
end


function PackageDenyPolicyEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return PackageDenyPolicyEntity.new(self._client, opts)
end
...
function PackageDenyPolicyEntity:mark_deleted()
  self._deleted = true
end


function PackageDenyPolicyEntity:deleted()
  return true == self._deleted
end


function PackageDenyPolicyEntity:data_set(args)
  if args ~= nil then
...
function PackageDenyPolicyEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function PackageDenyPolicyEntity:match_set(args)
  if args ~= nil then
...
function PackageDenyPolicyEntity:match_get()
...
function PackageDenyPolicyEntity:stream(action, args, callopts)
...
---@param reqmatch PackageDenyPolicyLoadMatch
---@param ctrl? table
---@return PackageDenyPolicy
---@return string? err
function PackageDenyPolicyEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch PackageDenyPolicyListMatch
---@param ctrl? table
---@return PackageDenyPolicy[]
---@return string? err
function PackageDenyPolicyEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata PackageDenyPolicyCreateData
---@param ctrl? table
---@return PackageDenyPolicy
---@return string? err
function PackageDenyPolicyEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata PackageDenyPolicyUpdateData
---@param ctrl? table
---@return PackageDenyPolicy
---@return string? err
function PackageDenyPolicyEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
function PackageDenyPolicyEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return PackageDenyPolicyEntity
