-- Cloudsmith SDK Luarock entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local LuarockEntity = {}
LuarockEntity.__index = LuarockEntity


function LuarockEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, LuarockEntity)
  self._name = "luarock"
  self._client = client
...
function LuarockEntity:get_name()
  return self._name
end


function LuarockEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return LuarockEntity.new(self._client, opts)
end
...
function LuarockEntity:mark_deleted()
  self._deleted = true
end


function LuarockEntity:deleted()
  return true == self._deleted
end


function LuarockEntity:data_set(args)
  if args ~= nil then
...
function LuarockEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function LuarockEntity:match_set(args)
  if args ~= nil then
...
function LuarockEntity:match_get()
...
function LuarockEntity:stream(action, args, callopts)
...
function LuarockEntity:_run_op(ctx, post_done)
  local utility = self._utility
