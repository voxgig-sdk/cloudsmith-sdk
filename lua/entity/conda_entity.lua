...
local CondaEntity = {}
CondaEntity.__index = CondaEntity


function CondaEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, CondaEntity)
  self._name = "conda"
  self._client = client
...
function CondaEntity:get_name()
  return self._name
end


function CondaEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return CondaEntity.new(self._client, opts)
end
...
function CondaEntity:mark_deleted()
  self._deleted = true
end


function CondaEntity:deleted()
  return true == self._deleted
end


function CondaEntity:data_set(args)
  if args ~= nil then
...
function CondaEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function CondaEntity:match_set(args)
  if args ~= nil then
...
function CondaEntity:match_get()
...
function CondaEntity:stream(action, args, callopts)
...
---@param reqmatch CondaLoadMatch
---@param ctrl? table
---@return Conda
---@return string? err
function CondaEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch CondaListMatch
---@param ctrl? table
---@return Conda[]
---@return string? err
function CondaEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata CondaCreateData
---@param ctrl? table
---@return Conda
---@return string? err
function CondaEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata CondaUpdateData
---@param ctrl? table
---@return Conda
---@return string? err
function CondaEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
function CondaEntity:_run_op(ctx, post_done)
  local utility = self._utility
