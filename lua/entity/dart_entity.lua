...
local DartEntity = {}
DartEntity.__index = DartEntity


function DartEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, DartEntity)
  self._name = "dart"
  self._client = client
...
function DartEntity:get_name()
  return self._name
end


function DartEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return DartEntity.new(self._client, opts)
end
...
function DartEntity:mark_deleted()
  self._deleted = true
end


function DartEntity:deleted()
  return true == self._deleted
end


function DartEntity:data_set(args)
  if args ~= nil then
...
function DartEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function DartEntity:match_set(args)
  if args ~= nil then
...
function DartEntity:stream(action, args, callopts)
...
---@param reqmatch DartLoadMatch
---@param ctrl? table
---@return Dart
---@return string? err
function DartEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch DartListMatch
---@param ctrl? table
---@return Dart[]
---@return string? err
function DartEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata DartCreateData
---@param ctrl? table
---@return Dart
---@return string? err
function DartEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata DartUpdateData
---@param ctrl? table
---@return Dart
---@return string? err
function DartEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
function DartEntity:_run_op(ctx, post_done)
  local utility = self._utility
