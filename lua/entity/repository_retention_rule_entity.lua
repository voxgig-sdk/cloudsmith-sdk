-- Cloudsmith SDK RepositoryRetentionRule entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local RepositoryRetentionRuleEntity = {}
RepositoryRetentionRuleEntity.__index = RepositoryRetentionRuleEntity


function RepositoryRetentionRuleEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, RepositoryRetentionRuleEntity)
  self._name = "repository_retention_rule"
  self._client = client
...
function RepositoryRetentionRuleEntity:get_name()
  return self._name
end


function RepositoryRetentionRuleEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return RepositoryRetentionRuleEntity.new(self._client, opts)
end
...
function RepositoryRetentionRuleEntity:mark_deleted()
  self._deleted = true
end


function RepositoryRetentionRuleEntity:deleted()
  return true == self._deleted
end


function RepositoryRetentionRuleEntity:data_set(args)
  if args ~= nil then
...
function RepositoryRetentionRuleEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function RepositoryRetentionRuleEntity:match_set(args)
  if args ~= nil then
...
function RepositoryRetentionRuleEntity:match_get()
...
function RepositoryRetentionRuleEntity:stream(action, args, callopts)
...
---@param reqmatch RepositoryRetentionRuleLoadMatch
---@param ctrl? table
---@return RepositoryRetentionRule
---@return string? err
function RepositoryRetentionRuleEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata RepositoryRetentionRuleUpdateData
---@param ctrl? table
---@return RepositoryRetentionRule
---@return string? err
function RepositoryRetentionRuleEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
function RepositoryRetentionRuleEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return RepositoryRetentionRuleEntity
