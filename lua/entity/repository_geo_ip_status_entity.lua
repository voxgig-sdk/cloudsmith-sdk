-- Cloudsmith SDK RepositoryGeoIpStatus entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local RepositoryGeoIpStatusEntity = {}
RepositoryGeoIpStatusEntity.__index = RepositoryGeoIpStatusEntity


function RepositoryGeoIpStatusEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, RepositoryGeoIpStatusEntity)
  self._name = "repository_geo_ip_status"
  self._client = client
...
function RepositoryGeoIpStatusEntity:get_name()
  return self._name
end


function RepositoryGeoIpStatusEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return RepositoryGeoIpStatusEntity.new(self._client, opts)
end
...
function RepositoryGeoIpStatusEntity:mark_deleted()
  self._deleted = true
end


function RepositoryGeoIpStatusEntity:deleted()
  return true == self._deleted
end


function RepositoryGeoIpStatusEntity:data_set(args)
  if args ~= nil then
...
function RepositoryGeoIpStatusEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function RepositoryGeoIpStatusEntity:match_set(args)
  if args ~= nil then
...
function RepositoryGeoIpStatusEntity:match_get()
...
function RepositoryGeoIpStatusEntity:stream(action, args, callopts)
...
---@param reqmatch RepositoryGeoIpStatusLoadMatch
---@param ctrl? table
---@return RepositoryGeoIpStatus
---@return string? err
function RepositoryGeoIpStatusEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function RepositoryGeoIpStatusEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return RepositoryGeoIpStatusEntity
