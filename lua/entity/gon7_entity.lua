-- Cloudsmith SDK Gon7 entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local Gon7Entity = {}
Gon7Entity.__index = Gon7Entity


function Gon7Entity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, Gon7Entity)
  self._name = "gon7"
  self._client = client
...
function Gon7Entity:get_name()
  return self._name
end


function Gon7Entity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return Gon7Entity.new(self._client, opts)
end


function Gon7Entity:data_set(args)
  if args ~= nil then
...
function Gon7Entity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function Gon7Entity:match_set(args)
  if args ~= nil then
...
function Gon7Entity:stream(action, args, callopts)
...
function Gon7Entity:_run_op(ctx, post_done)
  local utility = self._utility
