-- Cloudsmith SDK RepositoryAuditLog entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local RepositoryAuditLogEntity = {}
RepositoryAuditLogEntity.__index = RepositoryAuditLogEntity


function RepositoryAuditLogEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, RepositoryAuditLogEntity)
  self._name = "repository_audit_log"
  self._client = client
...
function RepositoryAuditLogEntity:get_name()
  return self._name
end


function RepositoryAuditLogEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return RepositoryAuditLogEntity.new(self._client, opts)
end
...
function RepositoryAuditLogEntity:mark_deleted()
  self._deleted = true
end


function RepositoryAuditLogEntity:deleted()
  return true == self._deleted
end


function RepositoryAuditLogEntity:data_set(args)
  if args ~= nil then
...
function RepositoryAuditLogEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function RepositoryAuditLogEntity:match_set(args)
  if args ~= nil then
...
function RepositoryAuditLogEntity:match_get()
...
function RepositoryAuditLogEntity:stream(action, args, callopts)
...
---@param reqmatch RepositoryAuditLogListMatch
---@param ctrl? table
---@return RepositoryAuditLog[]
---@return string? err
function RepositoryAuditLogEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function RepositoryAuditLogEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return RepositoryAuditLogEntity
