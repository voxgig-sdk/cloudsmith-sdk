-- Cloudsmith SDK OrganizationGroupSyncStatus entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local OrganizationGroupSyncStatusEntity = {}
OrganizationGroupSyncStatusEntity.__index = OrganizationGroupSyncStatusEntity


function OrganizationGroupSyncStatusEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, OrganizationGroupSyncStatusEntity)
  self._name = "organization_group_sync_status"
  self._client = client
...
function OrganizationGroupSyncStatusEntity:get_name()
  return self._name
end


function OrganizationGroupSyncStatusEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return OrganizationGroupSyncStatusEntity.new(self._client, opts)
end
...
function OrganizationGroupSyncStatusEntity:mark_deleted()
  self._deleted = true
end


function OrganizationGroupSyncStatusEntity:deleted()
  return true == self._deleted
end


function OrganizationGroupSyncStatusEntity:data_set(args)
  if args ~= nil then
...
function OrganizationGroupSyncStatusEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function OrganizationGroupSyncStatusEntity:match_set(args)
  if args ~= nil then
...
function OrganizationGroupSyncStatusEntity:match_get()
...
function OrganizationGroupSyncStatusEntity:stream(action, args, callopts)
...
---@param reqmatch OrganizationGroupSyncStatusLoadMatch
---@param ctrl? table
---@return OrganizationGroupSyncStatus
---@return string? err
function OrganizationGroupSyncStatusEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function OrganizationGroupSyncStatusEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return OrganizationGroupSyncStatusEntity
