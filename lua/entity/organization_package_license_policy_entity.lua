...
local OrganizationPackageLicensePolicyEntity = {}
OrganizationPackageLicensePolicyEntity.__index = OrganizationPackageLicensePolicyEntity


function OrganizationPackageLicensePolicyEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, OrganizationPackageLicensePolicyEntity)
  self._name = "organization_package_license_policy"
  self._client = client
...
function OrganizationPackageLicensePolicyEntity:get_name()
  return self._name
end


function OrganizationPackageLicensePolicyEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return OrganizationPackageLicensePolicyEntity.new(self._client, opts)
end
...
function OrganizationPackageLicensePolicyEntity:mark_deleted()
  self._deleted = true
end


function OrganizationPackageLicensePolicyEntity:deleted()
  return true == self._deleted
end


function OrganizationPackageLicensePolicyEntity:data_set(args)
  if args ~= nil then
...
function OrganizationPackageLicensePolicyEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function OrganizationPackageLicensePolicyEntity:match_set(args)
  if args ~= nil then
...
function OrganizationPackageLicensePolicyEntity:match_get()
...
function OrganizationPackageLicensePolicyEntity:stream(action, args, callopts)
...
---@param reqmatch OrganizationPackageLicensePolicyLoadMatch
---@param ctrl? table
---@return OrganizationPackageLicensePolicy
---@return string? err
function OrganizationPackageLicensePolicyEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch OrganizationPackageLicensePolicyListMatch
---@param ctrl? table
---@return OrganizationPackageLicensePolicy[]
---@return string? err
function OrganizationPackageLicensePolicyEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata OrganizationPackageLicensePolicyCreateData
---@param ctrl? table
---@return OrganizationPackageLicensePolicy
---@return string? err
function OrganizationPackageLicensePolicyEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata OrganizationPackageLicensePolicyUpdateData
---@param ctrl? table
---@return OrganizationPackageLicensePolicy
---@return string? err
function OrganizationPackageLicensePolicyEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
function OrganizationPackageLicensePolicyEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return OrganizationPackageLicensePolicyEntity
