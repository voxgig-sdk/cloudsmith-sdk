-- Cloudsmith SDK UserAuthenticationToken entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local UserAuthenticationTokenEntity = {}
UserAuthenticationTokenEntity.__index = UserAuthenticationTokenEntity


function UserAuthenticationTokenEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, UserAuthenticationTokenEntity)
  self._name = "user_authentication_token"
  self._client = client
...
function UserAuthenticationTokenEntity:get_name()
  return self._name
end


function UserAuthenticationTokenEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return UserAuthenticationTokenEntity.new(self._client, opts)
end
...
function UserAuthenticationTokenEntity:mark_deleted()
  self._deleted = true
end


function UserAuthenticationTokenEntity:deleted()
  return true == self._deleted
end


function UserAuthenticationTokenEntity:data_set(args)
  if args ~= nil then
...
function UserAuthenticationTokenEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function UserAuthenticationTokenEntity:match_set(args)
  if args ~= nil then
...
function UserAuthenticationTokenEntity:match_get()
...
function UserAuthenticationTokenEntity:stream(action, args, callopts)
...
---@param reqdata UserAuthenticationTokenCreateData
---@param ctrl? table
---@return UserAuthenticationToken
---@return string? err
function UserAuthenticationTokenEntity:create(reqdata, ctrl)
  local utility = self._utility
...
---@param reqdata UserAuthenticationTokenUpdateData
---@param ctrl? table
---@return UserAuthenticationToken
---@return string? err
function UserAuthenticationTokenEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
function UserAuthenticationTokenEntity:_run_op(ctx, post_done)
  local utility = self._utility
