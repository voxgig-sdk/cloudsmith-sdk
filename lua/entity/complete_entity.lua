-- Cloudsmith SDK Complete entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local CompleteEntity = {}
CompleteEntity.__index = CompleteEntity


function CompleteEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, CompleteEntity)
  self._name = "complete"
  self._client = client
...
function CompleteEntity:get_name()
  return self._name
end


function CompleteEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return CompleteEntity.new(self._client, opts)
end
...
function CompleteEntity:mark_deleted()
  self._deleted = true
end


function CompleteEntity:deleted()
  return true == self._deleted
end


function CompleteEntity:data_set(args)
  if args ~= nil then
...
function CompleteEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function CompleteEntity:match_set(args)
  if args ~= nil then
...
function CompleteEntity:match_get()
...
function CompleteEntity:stream(action, args, callopts)
...
function CompleteEntity:_run_op(ctx, post_done)
  local utility = self._utility
