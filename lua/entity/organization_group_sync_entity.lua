...
local OrganizationGroupSyncEntity = {}
OrganizationGroupSyncEntity.__index = OrganizationGroupSyncEntity


function OrganizationGroupSyncEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, OrganizationGroupSyncEntity)
  self._name = "organization_group_sync"
  self._client = client
...
function OrganizationGroupSyncEntity:get_name()
  return self._name
end


function OrganizationGroupSyncEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return OrganizationGroupSyncEntity.new(self._client, opts)
end
...
function OrganizationGroupSyncEntity:mark_deleted()
  self._deleted = true
end


function OrganizationGroupSyncEntity:deleted()
  return true == self._deleted
end


function OrganizationGroupSyncEntity:data_set(args)
  if args ~= nil then
...
function OrganizationGroupSyncEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function OrganizationGroupSyncEntity:match_set(args)
  if args ~= nil then
...
function OrganizationGroupSyncEntity:match_get()
...
function OrganizationGroupSyncEntity:stream(action, args, callopts)
...
---@param reqmatch OrganizationGroupSyncListMatch
---@param ctrl? table
---@return OrganizationGroupSync[]
---@return string? err
function OrganizationGroupSyncEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata OrganizationGroupSyncCreateData
---@param ctrl? table
---@return OrganizationGroupSync
---@return string? err
function OrganizationGroupSyncEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
function OrganizationGroupSyncEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return OrganizationGroupSyncEntity
