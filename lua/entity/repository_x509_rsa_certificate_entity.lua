-- Cloudsmith SDK RepositoryX509RsaCertificate entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local RepositoryX509RsaCertificateEntity = {}
RepositoryX509RsaCertificateEntity.__index = RepositoryX509RsaCertificateEntity


function RepositoryX509RsaCertificateEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, RepositoryX509RsaCertificateEntity)
  self._name = "repository_x509_rsa_certificate"
  self._client = client
...
function RepositoryX509RsaCertificateEntity:get_name()
  return self._name
end


function RepositoryX509RsaCertificateEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return RepositoryX509RsaCertificateEntity.new(self._client, opts)
end
...
function RepositoryX509RsaCertificateEntity:mark_deleted()
  self._deleted = true
end


function RepositoryX509RsaCertificateEntity:deleted()
  return true == self._deleted
end


function RepositoryX509RsaCertificateEntity:data_set(args)
  if args ~= nil then
...
function RepositoryX509RsaCertificateEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function RepositoryX509RsaCertificateEntity:match_set(args)
  if args ~= nil then
...
function RepositoryX509RsaCertificateEntity:match_get()
...
function RepositoryX509RsaCertificateEntity:stream(action, args, callopts)
...
---@param reqmatch RepositoryX509RsaCertificateLoadMatch
---@param ctrl? table
---@return RepositoryX509RsaCertificate
---@return string? err
function RepositoryX509RsaCertificateEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function RepositoryX509RsaCertificateEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return RepositoryX509RsaCertificateEntity
