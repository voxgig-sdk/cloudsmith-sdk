-- Cloudsmith SDK OrganizationSamlAuth entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local OrganizationSamlAuthEntity = {}
OrganizationSamlAuthEntity.__index = OrganizationSamlAuthEntity


function OrganizationSamlAuthEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, OrganizationSamlAuthEntity)
  self._name = "organization_saml_auth"
  self._client = client
...
function OrganizationSamlAuthEntity:get_name()
  return self._name
end


function OrganizationSamlAuthEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return OrganizationSamlAuthEntity.new(self._client, opts)
end
...
function OrganizationSamlAuthEntity:mark_deleted()
  self._deleted = true
end


function OrganizationSamlAuthEntity:deleted()
  return true == self._deleted
end


function OrganizationSamlAuthEntity:data_set(args)
  if args ~= nil then
...
function OrganizationSamlAuthEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function OrganizationSamlAuthEntity:match_set(args)
  if args ~= nil then
...
function OrganizationSamlAuthEntity:match_get()
...
function OrganizationSamlAuthEntity:stream(action, args, callopts)
...
---@param reqmatch OrganizationSamlAuthLoadMatch
---@param ctrl? table
---@return OrganizationSamlAuth
---@return string? err
function OrganizationSamlAuthEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata OrganizationSamlAuthUpdateData
---@param ctrl? table
---@return OrganizationSamlAuth
---@return string? err
function OrganizationSamlAuthEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
function OrganizationSamlAuthEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return OrganizationSamlAuthEntity
