-- Cloudsmith SDK Gon5 entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local Gon5Entity = {}
Gon5Entity.__index = Gon5Entity


function Gon5Entity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, Gon5Entity)
  self._name = "gon5"
  self._client = client
...
function Gon5Entity:get_name()
  return self._name
end


function Gon5Entity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return Gon5Entity.new(self._client, opts)
end


function Gon5Entity:data_set(args)
  if args ~= nil then
...
function Gon5Entity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function Gon5Entity:match_set(args)
  if args ~= nil then
...
function Gon5Entity:stream(action, args, callopts)
...
---@param reqdata Gon5CreateData
---@param ctrl? table
---@return Gon5
---@return string? err
function Gon5Entity:create(reqdata, ctrl)
  local utility = self._utility
...
function Gon5Entity:_run_op(ctx, post_done)
  local utility = self._utility
