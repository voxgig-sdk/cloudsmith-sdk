-- Cloudsmith SDK OrganizationInviteExtend entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local OrganizationInviteExtendEntity = {}
OrganizationInviteExtendEntity.__index = OrganizationInviteExtendEntity


function OrganizationInviteExtendEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, OrganizationInviteExtendEntity)
  self._name = "organization_invite_extend"
  self._client = client
...
function OrganizationInviteExtendEntity:get_name()
  return self._name
end


function OrganizationInviteExtendEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return OrganizationInviteExtendEntity.new(self._client, opts)
end
...
function OrganizationInviteExtendEntity:mark_deleted()
  self._deleted = true
end


function OrganizationInviteExtendEntity:deleted()
  return true == self._deleted
end


function OrganizationInviteExtendEntity:data_set(args)
  if args ~= nil then
...
function OrganizationInviteExtendEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function OrganizationInviteExtendEntity:match_set(args)
  if args ~= nil then
...
function OrganizationInviteExtendEntity:match_get()
...
function OrganizationInviteExtendEntity:stream(action, args, callopts)
...
---@param reqdata OrganizationInviteExtendCreateData
---@param ctrl? table
---@return OrganizationInviteExtend
---@return string? err
function OrganizationInviteExtendEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function OrganizationInviteExtendEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return OrganizationInviteExtendEntity
