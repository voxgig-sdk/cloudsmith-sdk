-- Cloudsmith SDK Gon8 entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local Gon8Entity = {}
Gon8Entity.__index = Gon8Entity


function Gon8Entity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, Gon8Entity)
  self._name = "gon8"
  self._client = client
...
function Gon8Entity:get_name()
  return self._name
end


function Gon8Entity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return Gon8Entity.new(self._client, opts)
end


function Gon8Entity:data_set(args)
  if args ~= nil then
...
function Gon8Entity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function Gon8Entity:match_set(args)
  if args ~= nil then
...
function Gon8Entity:stream(action, args, callopts)
...
---@param reqdata Gon8UpdateData
---@param ctrl? table
---@return Gon8
---@return string? err
function Gon8Entity:update(reqdata, ctrl)
  local utility = self._utility
...
function Gon8Entity:_run_op(ctx, post_done)
  local utility = self._utility
