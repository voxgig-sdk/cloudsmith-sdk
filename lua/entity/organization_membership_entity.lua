...
local OrganizationMembershipEntity = {}
OrganizationMembershipEntity.__index = OrganizationMembershipEntity


function OrganizationMembershipEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, OrganizationMembershipEntity)
  self._name = "organization_membership"
  self._client = client
...
function OrganizationMembershipEntity:get_name()
  return self._name
end


function OrganizationMembershipEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return OrganizationMembershipEntity.new(self._client, opts)
end
...
function OrganizationMembershipEntity:mark_deleted()
  self._deleted = true
end


function OrganizationMembershipEntity:deleted()
  return true == self._deleted
end


function OrganizationMembershipEntity:data_set(args)
  if args ~= nil then
...
function OrganizationMembershipEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function OrganizationMembershipEntity:match_set(args)
  if args ~= nil then
...
function OrganizationMembershipEntity:match_get()
...
function OrganizationMembershipEntity:stream(action, args, callopts)
...
---@param reqmatch OrganizationMembershipLoadMatch
---@param ctrl? table
---@return OrganizationMembership
---@return string? err
function OrganizationMembershipEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch OrganizationMembershipListMatch
---@param ctrl? table
---@return OrganizationMembership[]
---@return string? err
function OrganizationMembershipEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata OrganizationMembershipUpdateData
---@param ctrl? table
---@return OrganizationMembership
---@return string? err
function OrganizationMembershipEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
function OrganizationMembershipEntity:_run_op(ctx, post_done)
  local utility = self._utility
