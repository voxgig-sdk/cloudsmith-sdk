...
local Gon3Entity = {}
Gon3Entity.__index = Gon3Entity


function Gon3Entity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, Gon3Entity)
  self._name = "gon3"
  self._client = client
...
function Gon3Entity:get_name()
  return self._name
end


function Gon3Entity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return Gon3Entity.new(self._client, opts)
end


function Gon3Entity:data_set(args)
  if args ~= nil then
...
function Gon3Entity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function Gon3Entity:match_set(args)
  if args ~= nil then
...
function Gon3Entity:stream(action, args, callopts)
...
---@param reqmatch Gon3ListMatch
---@param ctrl? table
---@return Gon3[]
---@return string? err
function Gon3Entity:list(reqmatch, ctrl)
  local utility = self._utility
...
function Gon3Entity:_run_op(ctx, post_done)
  local utility = self._utility
