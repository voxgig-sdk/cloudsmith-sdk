-- Cloudsmith SDK RepositoryEcdsaKey entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local RepositoryEcdsaKeyEntity = {}
RepositoryEcdsaKeyEntity.__index = RepositoryEcdsaKeyEntity


function RepositoryEcdsaKeyEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, RepositoryEcdsaKeyEntity)
  self._name = "repository_ecdsa_key"
  self._client = client
...
function RepositoryEcdsaKeyEntity:get_name()
  return self._name
end


function RepositoryEcdsaKeyEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return RepositoryEcdsaKeyEntity.new(self._client, opts)
end
...
function RepositoryEcdsaKeyEntity:mark_deleted()
  self._deleted = true
end


function RepositoryEcdsaKeyEntity:deleted()
  return true == self._deleted
end


function RepositoryEcdsaKeyEntity:data_set(args)
  if args ~= nil then
...
function RepositoryEcdsaKeyEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function RepositoryEcdsaKeyEntity:match_set(args)
  if args ~= nil then
...
function RepositoryEcdsaKeyEntity:match_get()
...
function RepositoryEcdsaKeyEntity:stream(action, args, callopts)
...
---@param reqmatch RepositoryEcdsaKeyLoadMatch
---@param ctrl? table
---@return RepositoryEcdsaKey
---@return string? err
function RepositoryEcdsaKeyEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata RepositoryEcdsaKeyCreateData
---@param ctrl? table
---@return RepositoryEcdsaKey
---@return string? err
function RepositoryEcdsaKeyEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
function RepositoryEcdsaKeyEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return RepositoryEcdsaKeyEntity
