-- Cloudsmith SDK RepositoryTokenRefresh entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local RepositoryTokenRefreshEntity = {}
RepositoryTokenRefreshEntity.__index = RepositoryTokenRefreshEntity


function RepositoryTokenRefreshEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, RepositoryTokenRefreshEntity)
  self._name = "repository_token_refresh"
  self._client = client
...
function RepositoryTokenRefreshEntity:get_name()
  return self._name
end


function RepositoryTokenRefreshEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return RepositoryTokenRefreshEntity.new(self._client, opts)
end
...
function RepositoryTokenRefreshEntity:mark_deleted()
  self._deleted = true
end


function RepositoryTokenRefreshEntity:deleted()
  return true == self._deleted
end


function RepositoryTokenRefreshEntity:data_set(args)
  if args ~= nil then
...
function RepositoryTokenRefreshEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function RepositoryTokenRefreshEntity:match_set(args)
  if args ~= nil then
...
function RepositoryTokenRefreshEntity:match_get()
...
function RepositoryTokenRefreshEntity:stream(action, args, callopts)
...
---@param reqdata RepositoryTokenRefreshCreateData
---@param ctrl? table
---@return RepositoryTokenRefresh
---@return string? err
function RepositoryTokenRefreshEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function RepositoryTokenRefreshEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return RepositoryTokenRefreshEntity
