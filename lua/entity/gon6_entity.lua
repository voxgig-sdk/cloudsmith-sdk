-- Cloudsmith SDK Gon6 entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local Gon6Entity = {}
Gon6Entity.__index = Gon6Entity


function Gon6Entity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, Gon6Entity)
  self._name = "gon6"
  self._client = client
...
function Gon6Entity:get_name()
  return self._name
end


function Gon6Entity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return Gon6Entity.new(self._client, opts)
end


function Gon6Entity:data_set(args)
  if args ~= nil then
...
function Gon6Entity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function Gon6Entity:match_set(args)
  if args ~= nil then
...
function Gon6Entity:stream(action, args, callopts)
...
---@param reqmatch Gon6LoadMatch
---@param ctrl? table
---@return Gon6
---@return string? err
function Gon6Entity:load(reqmatch, ctrl)
  local utility = self._utility
...
function Gon6Entity:_run_op(ctx, post_done)
  local utility = self._utility
