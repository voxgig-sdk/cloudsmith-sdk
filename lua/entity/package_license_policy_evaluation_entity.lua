...
local PackageLicensePolicyEvaluationEntity = {}
PackageLicensePolicyEvaluationEntity.__index = PackageLicensePolicyEvaluationEntity


function PackageLicensePolicyEvaluationEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, PackageLicensePolicyEvaluationEntity)
  self._name = "package_license_policy_evaluation"
  self._client = client
...
function PackageLicensePolicyEvaluationEntity:get_name()
  return self._name
end


function PackageLicensePolicyEvaluationEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return PackageLicensePolicyEvaluationEntity.new(self._client, opts)
end
...
function PackageLicensePolicyEvaluationEntity:mark_deleted()
  self._deleted = true
end


function PackageLicensePolicyEvaluationEntity:deleted()
  return true == self._deleted
end


function PackageLicensePolicyEvaluationEntity:data_set(args)
  if args ~= nil then
...
function PackageLicensePolicyEvaluationEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function PackageLicensePolicyEvaluationEntity:match_set(args)
  if args ~= nil then
...
function PackageLicensePolicyEvaluationEntity:match_get()
...
function PackageLicensePolicyEvaluationEntity:stream(action, args, callopts)
...
---@param reqmatch PackageLicensePolicyEvaluationLoadMatch
---@param ctrl? table
---@return PackageLicensePolicyEvaluation
---@return string? err
function PackageLicensePolicyEvaluationEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch PackageLicensePolicyEvaluationListMatch
---@param ctrl? table
---@return PackageLicensePolicyEvaluation[]
---@return string? err
function PackageLicensePolicyEvaluationEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata PackageLicensePolicyEvaluationCreateData
---@param ctrl? table
---@return PackageLicensePolicyEvaluation
---@return string? err
function PackageLicensePolicyEvaluationEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
function PackageLicensePolicyEvaluationEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return PackageLicensePolicyEvaluationEntity
