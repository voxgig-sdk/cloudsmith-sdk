-- Cloudsmith SDK RepositoryGpgKey entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local RepositoryGpgKeyEntity = {}
RepositoryGpgKeyEntity.__index = RepositoryGpgKeyEntity


function RepositoryGpgKeyEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, RepositoryGpgKeyEntity)
  self._name = "repository_gpg_key"
  self._client = client
...
function RepositoryGpgKeyEntity:get_name()
  return self._name
end


function RepositoryGpgKeyEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return RepositoryGpgKeyEntity.new(self._client, opts)
end
...
function RepositoryGpgKeyEntity:mark_deleted()
  self._deleted = true
end


function RepositoryGpgKeyEntity:deleted()
  return true == self._deleted
end


function RepositoryGpgKeyEntity:data_set(args)
  if args ~= nil then
...
function RepositoryGpgKeyEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function RepositoryGpgKeyEntity:match_set(args)
  if args ~= nil then
...
function RepositoryGpgKeyEntity:match_get()
...
function RepositoryGpgKeyEntity:stream(action, args, callopts)
...
---@param reqmatch RepositoryGpgKeyLoadMatch
---@param ctrl? table
---@return RepositoryGpgKey
---@return string? err
function RepositoryGpgKeyEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata RepositoryGpgKeyCreateData
---@param ctrl? table
---@return RepositoryGpgKey
---@return string? err
function RepositoryGpgKeyEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
function RepositoryGpgKeyEntity:_run_op(ctx, post_done)
  local utility = self._utility
