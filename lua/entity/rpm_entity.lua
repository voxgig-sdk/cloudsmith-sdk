...
---@param reqmatch RpmLoadMatch
---@param ctrl? table
---@return Rpm
---@return string? err
function RpmEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch RpmListMatch
---@param ctrl? table
---@return Rpm[]
---@return string? err
function RpmEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata RpmUpdateData
---@param ctrl? table
---@return Rpm
---@return string? err
function RpmEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
