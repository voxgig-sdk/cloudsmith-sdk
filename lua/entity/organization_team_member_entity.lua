...
local OrganizationTeamMemberEntity = {}
OrganizationTeamMemberEntity.__index = OrganizationTeamMemberEntity


function OrganizationTeamMemberEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, OrganizationTeamMemberEntity)
  self._name = "organization_team_member"
  self._client = client
...
function OrganizationTeamMemberEntity:get_name()
  return self._name
end


function OrganizationTeamMemberEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return OrganizationTeamMemberEntity.new(self._client, opts)
end
...
function OrganizationTeamMemberEntity:mark_deleted()
  self._deleted = true
end


function OrganizationTeamMemberEntity:deleted()
  return true == self._deleted
end


function OrganizationTeamMemberEntity:data_set(args)
  if args ~= nil then
...
function OrganizationTeamMemberEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function OrganizationTeamMemberEntity:match_set(args)
  if args ~= nil then
...
function OrganizationTeamMemberEntity:match_get()
...
function OrganizationTeamMemberEntity:stream(action, args, callopts)
...
---@param reqmatch OrganizationTeamMemberListMatch
---@param ctrl? table
---@return OrganizationTeamMember[]
---@return string? err
function OrganizationTeamMemberEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata OrganizationTeamMemberCreateData
---@param ctrl? table
---@return OrganizationTeamMember
---@return string? err
function OrganizationTeamMemberEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
function OrganizationTeamMemberEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return OrganizationTeamMemberEntity
