...
local OrganizationInviteEntity = {}
OrganizationInviteEntity.__index = OrganizationInviteEntity


function OrganizationInviteEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, OrganizationInviteEntity)
  self._name = "organization_invite"
  self._client = client
...
function OrganizationInviteEntity:get_name()
  return self._name
end


function OrganizationInviteEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return OrganizationInviteEntity.new(self._client, opts)
end
...
function OrganizationInviteEntity:mark_deleted()
  self._deleted = true
end


function OrganizationInviteEntity:deleted()
  return true == self._deleted
end


function OrganizationInviteEntity:data_set(args)
  if args ~= nil then
...
function OrganizationInviteEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function OrganizationInviteEntity:match_set(args)
  if args ~= nil then
...
function OrganizationInviteEntity:match_get()
...
function OrganizationInviteEntity:stream(action, args, callopts)
...
---@param reqmatch OrganizationInviteListMatch
---@param ctrl? table
---@return OrganizationInvite[]
---@return string? err
function OrganizationInviteEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata OrganizationInviteCreateData
---@param ctrl? table
---@return OrganizationInvite
---@return string? err
function OrganizationInviteEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata OrganizationInviteUpdateData
---@param ctrl? table
---@return OrganizationInvite
---@return string? err
function OrganizationInviteEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
function OrganizationInviteEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return OrganizationInviteEntity
