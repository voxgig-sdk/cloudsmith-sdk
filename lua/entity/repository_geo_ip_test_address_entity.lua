-- Cloudsmith SDK RepositoryGeoIpTestAddress entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local RepositoryGeoIpTestAddressEntity = {}
RepositoryGeoIpTestAddressEntity.__index = RepositoryGeoIpTestAddressEntity


function RepositoryGeoIpTestAddressEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, RepositoryGeoIpTestAddressEntity)
  self._name = "repository_geo_ip_test_address"
  self._client = client
...
function RepositoryGeoIpTestAddressEntity:get_name()
  return self._name
end


function RepositoryGeoIpTestAddressEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return RepositoryGeoIpTestAddressEntity.new(self._client, opts)
end
...
function RepositoryGeoIpTestAddressEntity:mark_deleted()
  self._deleted = true
end


function RepositoryGeoIpTestAddressEntity:deleted()
  return true == self._deleted
end


function RepositoryGeoIpTestAddressEntity:data_set(args)
  if args ~= nil then
...
function RepositoryGeoIpTestAddressEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function RepositoryGeoIpTestAddressEntity:match_set(args)
  if args ~= nil then
...
function RepositoryGeoIpTestAddressEntity:match_get()
...
function RepositoryGeoIpTestAddressEntity:stream(action, args, callopts)
...
---@param reqdata RepositoryGeoIpTestAddressCreateData
---@param ctrl? table
---@return RepositoryGeoIpTestAddress
---@return string? err
function RepositoryGeoIpTestAddressEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function RepositoryGeoIpTestAddressEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return RepositoryGeoIpTestAddressEntity
