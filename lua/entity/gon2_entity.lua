-- Cloudsmith SDK Gon2 entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local Gon2Entity = {}
Gon2Entity.__index = Gon2Entity


function Gon2Entity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, Gon2Entity)
  self._name = "gon2"
  self._client = client
...
function Gon2Entity:get_name()
  return self._name
end


function Gon2Entity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return Gon2Entity.new(self._client, opts)
end


function Gon2Entity:data_set(args)
  if args ~= nil then
...
function Gon2Entity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function Gon2Entity:match_set(args)
  if args ~= nil then
...
function Gon2Entity:stream(action, args, callopts)
...
function Gon2Entity:_run_op(ctx, post_done)
  local utility = self._utility
