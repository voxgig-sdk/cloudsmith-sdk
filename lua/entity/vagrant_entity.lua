-- Cloudsmith SDK Vagrant entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local VagrantEntity = {}
VagrantEntity.__index = VagrantEntity


function VagrantEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, VagrantEntity)
  self._name = "vagrant"
  self._client = client
...
function VagrantEntity:get_name()
  return self._name
end


function VagrantEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return VagrantEntity.new(self._client, opts)
end
...
function VagrantEntity:mark_deleted()
  self._deleted = true
end


function VagrantEntity:deleted()
  return true == self._deleted
end


function VagrantEntity:data_set(args)
  if args ~= nil then
...
function VagrantEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function VagrantEntity:match_set(args)
  if args ~= nil then
...
function VagrantEntity:match_get()
...
function VagrantEntity:stream(action, args, callopts)
...
function VagrantEntity:_run_op(ctx, post_done)
  local utility = self._utility
