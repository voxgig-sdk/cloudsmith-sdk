-- Cloudsmith SDK OrganizationMembershipRoleUpdate entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local OrganizationMembershipRoleUpdateEntity = {}
OrganizationMembershipRoleUpdateEntity.__index = OrganizationMembershipRoleUpdateEntity


function OrganizationMembershipRoleUpdateEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, OrganizationMembershipRoleUpdateEntity)
  self._name = "organization_membership_role_update"
  self._client = client
...
function OrganizationMembershipRoleUpdateEntity:get_name()
  return self._name
end


function OrganizationMembershipRoleUpdateEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return OrganizationMembershipRoleUpdateEntity.new(self._client, opts)
end
...
function OrganizationMembershipRoleUpdateEntity:mark_deleted()
  self._deleted = true
end


function OrganizationMembershipRoleUpdateEntity:deleted()
  return true == self._deleted
end


function OrganizationMembershipRoleUpdateEntity:data_set(args)
  if args ~= nil then
...
function OrganizationMembershipRoleUpdateEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function OrganizationMembershipRoleUpdateEntity:match_set(args)
  if args ~= nil then
...
function OrganizationMembershipRoleUpdateEntity:match_get()
...
function OrganizationMembershipRoleUpdateEntity:stream(action, args, callopts)
...
---@param reqdata OrganizationMembershipRoleUpdateUpdateData
---@param ctrl? table
---@return OrganizationMembershipRoleUpdate
---@return string? err
function OrganizationMembershipRoleUpdateEntity:update(reqdata, ctrl)
  local utility = self._utility
...
function OrganizationMembershipRoleUpdateEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return OrganizationMembershipRoleUpdateEntity
