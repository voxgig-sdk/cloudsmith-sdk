...
function RepositoryX509EcdsaCertificateEntity:mark_deleted()
  self._deleted = true
end


function RepositoryX509EcdsaCertificateEntity:deleted()
...
function RepositoryX509EcdsaCertificateEntity:stream(action, args, callopts)
