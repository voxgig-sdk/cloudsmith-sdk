-- Cloudsmith SDK P2n2 entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local P2n2Entity = {}
P2n2Entity.__index = P2n2Entity


function P2n2Entity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, P2n2Entity)
  self._name = "p2n2"
  self._client = client
...
function P2n2Entity:get_name()
  return self._name
end


function P2n2Entity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return P2n2Entity.new(self._client, opts)
end


function P2n2Entity:data_set(args)
  if args ~= nil then
...
function P2n2Entity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function P2n2Entity:match_set(args)
  if args ~= nil then
...
function P2n2Entity:stream(action, args, callopts)
...
function P2n2Entity:_run_op(ctx, post_done)
  local utility = self._utility
