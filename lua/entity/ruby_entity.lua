...
local RubyEntity = {}
RubyEntity.__index = RubyEntity


function RubyEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, RubyEntity)
  self._name = "ruby"
  self._client = client
...
function RubyEntity:get_name()
  return self._name
end


function RubyEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return RubyEntity.new(self._client, opts)
end
...
function RubyEntity:mark_deleted()
  self._deleted = true
end


function RubyEntity:deleted()
  return true == self._deleted
end


function RubyEntity:data_set(args)
  if args ~= nil then
...
function RubyEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function RubyEntity:match_set(args)
  if args ~= nil then
...
function RubyEntity:stream(action, args, callopts)
...
---@param reqmatch RubyLoadMatch
---@param ctrl? table
---@return Ruby
---@return string? err
function RubyEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch RubyListMatch
---@param ctrl? table
---@return Ruby[]
---@return string? err
function RubyEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata RubyCreateData
---@param ctrl? table
---@return Ruby
---@return string? err
function RubyEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata RubyUpdateData
---@param ctrl? table
---@return Ruby
---@return string? err
function RubyEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
function RubyEntity:_run_op(ctx, post_done)
  local utility = self._utility
