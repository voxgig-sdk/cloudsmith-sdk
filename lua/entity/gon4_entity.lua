-- Cloudsmith SDK Gon4 entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local Gon4Entity = {}
Gon4Entity.__index = Gon4Entity


function Gon4Entity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, Gon4Entity)
  self._name = "gon4"
  self._client = client
...
function Gon4Entity:get_name()
  return self._name
end


function Gon4Entity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return Gon4Entity.new(self._client, opts)
end


function Gon4Entity:data_set(args)
  if args ~= nil then
...
function Gon4Entity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function Gon4Entity:match_set(args)
  if args ~= nil then
...
function Gon4Entity:stream(action, args, callopts)
...
function Gon4Entity:_run_op(ctx, post_done)
  local utility = self._utility
