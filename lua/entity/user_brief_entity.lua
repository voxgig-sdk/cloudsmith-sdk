-- Cloudsmith SDK UserBrief entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local UserBriefEntity = {}
UserBriefEntity.__index = UserBriefEntity


function UserBriefEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, UserBriefEntity)
  self._name = "user_brief"
  self._client = client
...
function UserBriefEntity:get_name()
  return self._name
end


function UserBriefEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return UserBriefEntity.new(self._client, opts)
end
...
function UserBriefEntity:mark_deleted()
  self._deleted = true
end


function UserBriefEntity:deleted()
  return true == self._deleted
end


function UserBriefEntity:data_set(args)
  if args ~= nil then
...
function UserBriefEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function UserBriefEntity:match_set(args)
  if args ~= nil then
...
function UserBriefEntity:match_get()
...
function UserBriefEntity:stream(action, args, callopts)
...
---@param reqmatch UserBriefLoadMatch
---@param ctrl? table
---@return UserBrief
---@return string? err
function UserBriefEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function UserBriefEntity:_run_op(ctx, post_done)
  local utility = self._utility
