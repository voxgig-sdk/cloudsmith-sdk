...
local OrganizationTeamEntity = {}
OrganizationTeamEntity.__index = OrganizationTeamEntity


function OrganizationTeamEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, OrganizationTeamEntity)
  self._name = "organization_team"
  self._client = client
...
function OrganizationTeamEntity:get_name()
  return self._name
end


function OrganizationTeamEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return OrganizationTeamEntity.new(self._client, opts)
end
...
function OrganizationTeamEntity:mark_deleted()
  self._deleted = true
end


function OrganizationTeamEntity:deleted()
  return true == self._deleted
end


function OrganizationTeamEntity:data_set(args)
  if args ~= nil then
...
function OrganizationTeamEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function OrganizationTeamEntity:match_set(args)
  if args ~= nil then
...
function OrganizationTeamEntity:match_get()
...
function OrganizationTeamEntity:stream(action, args, callopts)
...
---@param reqmatch OrganizationTeamLoadMatch
---@param ctrl? table
---@return OrganizationTeam
---@return string? err
function OrganizationTeamEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch OrganizationTeamListMatch
---@param ctrl? table
---@return OrganizationTeam[]
---@return string? err
function OrganizationTeamEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata OrganizationTeamCreateData
---@param ctrl? table
---@return OrganizationTeam
---@return string? err
function OrganizationTeamEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata OrganizationTeamUpdateData
---@param ctrl? table
---@return OrganizationTeam
---@return string? err
function OrganizationTeamEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
function OrganizationTeamEntity:_run_op(ctx, post_done)
  local utility = self._utility
