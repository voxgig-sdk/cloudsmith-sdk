-- RepositoryAuditLog direct test
...
describe("RepositoryAuditLogDirect", function()
  it("should direct-list-repository_audit_log", function()
    local setup = repository_audit_log_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-repository_audit_log", setup.live and "live" or "unit")
...
function repository_audit_log_direct_setup(mockres)
