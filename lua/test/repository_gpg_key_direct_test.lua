...
describe("RepositoryGpgKeyDirect", function()
  it("should direct-load-repository_gpg_key", function()
    local setup = repository_gpg_key_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-repository_gpg_key", setup.live and "live" or "unit")
...
function repository_gpg_key_direct_setup(mockres)
