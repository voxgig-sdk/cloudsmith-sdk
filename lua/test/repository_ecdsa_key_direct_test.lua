-- RepositoryEcdsaKey direct test
...
describe("RepositoryEcdsaKeyDirect", function()
  it("should direct-load-repository_ecdsa_key", function()
    local setup = repository_ecdsa_key_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-repository_ecdsa_key", setup.live and "live" or "unit")
...
function repository_ecdsa_key_direct_setup(mockres)
