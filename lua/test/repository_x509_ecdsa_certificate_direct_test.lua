...
describe("RepositoryX509EcdsaCertificateDirect", function()
  it("should direct-load-repository_x509_ecdsa_certificate", function()
    local setup = repository_x509_ecdsa_certificate_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-repository_x509_ecdsa_certificate", setup.live and "live" or "unit")
