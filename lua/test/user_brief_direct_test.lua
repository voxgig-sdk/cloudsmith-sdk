...
describe("UserBriefDirect", function()
  it("should direct-load-user_brief", function()
    local setup = user_brief_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-user_brief", setup.live and "live" or "unit")
...
function user_brief_direct_setup(mockres)
