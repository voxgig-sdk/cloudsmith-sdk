...
describe("NpmEntity", function()
  ...
  it("should run basic flow", function()
    ...
    assert.is_not_nil(npm_ref01_data["id"])
    ...
    assert.is_nil(err)
    local npm_ref01_data_dt0_load_result = helpers.to_map(type(npm_ref01_data_dt0_loaded) == 'table' and npm_ref01_data_dt0_loaded.data_get and npm_ref01_data_dt0_loaded:data_get() or npm_ref01_data_dt0_loaded)
    assert.is_not_nil(npm_ref01_data_dt0_load_result)
    assert.are.equal(npm_ref01_data_dt0_load_result["id"], npm_ref01_data["id"])
