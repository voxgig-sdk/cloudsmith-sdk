...
describe("NamespaceDirect", function()
  it("should direct-list-namespace", function()
    local setup = namespace_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-namespace", setup.live and "live" or "unit")
  ...
  it("should direct-load-namespace", function()
    local setup = namespace_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-namespace", setup.live and "live" or "unit")
    if _should_skip then
      pending(_reason or "skipped via sdk-test-control.json")
      return
    end
...
function namespace_direct_setup(mockres)
