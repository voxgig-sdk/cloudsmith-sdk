-- OrganizationGroupSync direct test
...
describe("OrganizationGroupSyncDirect", function()
  it("should direct-list-organization_group_sync", function()
    local setup = organization_group_sync_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-organization_group_sync", setup.live and "live" or "unit")
...
function organization_group_sync_direct_setup(mockres)
