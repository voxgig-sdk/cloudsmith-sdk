...
describe("Gon3Direct", function()
  it("should direct-list-gon3", function()
    local setup = gon3_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-gon3", setup.live and "live" or "unit")
...
function gon3_direct_setup(mockres)
