...
describe("StatusBasicDirect", function()
  it("should direct-load-status_basic", function()
    local setup = status_basic_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-status_basic", setup.live and "live" or "unit")
...
function status_basic_direct_setup(mockres)
