...
describe("UserProfileDirect", function()
  it("should direct-load-user_profile", function()
    local setup = user_profile_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-user_profile", setup.live and "live" or "unit")
...
function user_profile_direct_setup(mockres)
