-- RepositoryGeoIpRule direct test
...
describe("RepositoryGeoIpRuleDirect", function()
  it("should direct-load-repository_geo_ip_rule", function()
    local setup = repository_geo_ip_rule_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-repository_geo_ip_rule", setup.live and "live" or "unit")
...
function repository_geo_ip_rule_direct_setup(mockres)
