...
describe("Gon6Direct", function()
  it("should direct-load-gon6", function()
    local setup = gon6_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-gon6", setup.live and "live" or "unit")
...
function gon6_direct_setup(mockres)
