...
describe("RubyDirect", function()
  it("should direct-list-ruby", function()
    local setup = ruby_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-ruby", setup.live and "live" or "unit")
  ...
  it("should direct-load-ruby", function()
    local setup = ruby_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-ruby", setup.live and "live" or "unit")
    if _should_skip then
      pending(_reason or "skipped via sdk-test-control.json")
      return
    end
...
function ruby_direct_setup(mockres)
