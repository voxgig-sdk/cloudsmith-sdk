...
describe("EntitlementDirect", function()
  it("should direct-load-entitlement", function()
    local setup = entitlement_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-entitlement", setup.live and "live" or "unit")
...
function entitlement_direct_setup(mockres)
