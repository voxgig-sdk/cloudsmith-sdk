...
describe("NamespaceAuditLogDirect", function()
  it("should direct-load-namespace_audit_log", function()
    local setup = namespace_audit_log_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-namespace_audit_log", setup.live and "live" or "unit")
...
function namespace_audit_log_direct_setup(mockres)
