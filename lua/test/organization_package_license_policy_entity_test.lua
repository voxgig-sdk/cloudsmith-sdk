...
describe("OrganizationPackageLicensePolicyEntity", function()
  ...
  it("should stream", function()
    ...
    local seen = {}
    for item in base:OrganizationPackageLicensePolicy(nil):stream("list", nil, nil) do
    ...
    if type(config.feature) == "table" and config.feature.streaming ~= nil then
      ...
      local got = {}
      for item in streamsdk:OrganizationPackageLicensePolicy(nil):stream("list", nil, nil) do
  ...
  it("should run basic flow", function()
    ...
    assert.is_nil(err)
    organization_package_license_policy_ref01_data = helpers.to_map(type(organization_package_license_policy_ref01_data_result) == 'table' and organization_package_license_policy_ref01_data_result.data_get and organization_package_license_policy_ref01_data_result:data_get() or organization_package_license_policy_ref01_data_result)
    assert.is_not_nil(organization_package_license_policy_ref01_data)
    assert.is_not_nil(organization_package_license_policy_ref01_data["id"])
    ...
    local organization_package_license_policy_ref01_markdef_up0_name = "description"
    ...
    assert.is_nil(err)
    local organization_package_license_policy_ref01_resdata_up0 = helpers.to_map(type(organization_package_license_policy_ref01_resdata_up0_result) == 'table' and organization_package_license_policy_ref01_resdata_up0_result.data_get and organization_package_license_policy_ref01_resdata_up0_result:data_get() or organization_package_license_policy_ref01_resdata_up0_result)
    assert.is_not_nil(organization_package_license_policy_ref01_resdata_up0)
    assert.are.equal(organization_package_license_policy_ref01_resdata_up0["id"], organization_package_license_policy_ref01_data_up0_up["id"])
    ...
    assert.is_nil(err)
    local organization_package_license_policy_ref01_data_dt0_load_result = helpers.to_map(type(organization_package_license_policy_ref01_data_dt0_loaded) == 'table' and organization_package_license_policy_ref01_data_dt0_loaded.data_get and organization_package_license_policy_ref01_data_dt0_loaded:data_get() or organization_package_license_policy_ref01_data_dt0_loaded)
    assert.is_not_nil(organization_package_license_policy_ref01_data_dt0_load_result)
    assert.are.equal(organization_package_license_policy_ref01_data_dt0_load_result["id"], organization_package_license_policy_ref01_data["id"])
