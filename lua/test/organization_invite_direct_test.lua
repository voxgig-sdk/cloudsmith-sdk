-- OrganizationInvite direct test
...
describe("OrganizationInviteDirect", function()
  it("should direct-list-organization_invite", function()
    local setup = organization_invite_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-organization_invite", setup.live and "live" or "unit")
...
function organization_invite_direct_setup(mockres)
