-- PackageVersionBadge direct test
...
describe("PackageVersionBadgeDirect", function()
  it("should direct-load-package_version_badge", function()
    local setup = package_version_badge_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-package_version_badge", setup.live and "live" or "unit")
...
function package_version_badge_direct_setup(mockres)
