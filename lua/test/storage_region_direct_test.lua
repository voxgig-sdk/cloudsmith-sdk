...
describe("StorageRegionDirect", function()
  it("should direct-list-storage_region", function()
    local setup = storage_region_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-storage_region", setup.live and "live" or "unit")
  ...
  it("should direct-load-storage_region", function()
    local setup = storage_region_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-storage_region", setup.live and "live" or "unit")
    if _should_skip then
      pending(_reason or "skipped via sdk-test-control.json")
      return
    end
...
function storage_region_direct_setup(mockres)
