...
describe("GonEntity", function()
  it("should create instance", function()
    local testsdk = sdk.test(nil, nil)
    local ent = testsdk:Gon(nil)
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set CLOUDSMITH_TEST_GON_ENTID JSON to run live")
      return
    end
...
function gon_basic_setup(extra)
  ...
  local entity_data_file = _test_dir .. "../../.sdk/test/entity/gon/GonTestData.json"
  local f = io.open(entity_data_file, "r")
  if f == nil then
    error("failed to read gon test data: " .. entity_data_file)
  end
  ...
  local entid_env_raw = os.getenv("CLOUDSMITH_TEST_GON_ENTID")
