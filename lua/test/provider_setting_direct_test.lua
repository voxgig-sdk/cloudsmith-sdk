...
describe("ProviderSettingDirect", function()
  it("should direct-list-provider_setting", function()
    local setup = provider_setting_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-provider_setting", setup.live and "live" or "unit")
  ...
  it("should direct-load-provider_setting", function()
    local setup = provider_setting_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-provider_setting", setup.live and "live" or "unit")
    if _should_skip then
      pending(_reason or "skipped via sdk-test-control.json")
      return
    end
...
function provider_setting_direct_setup(mockres)
