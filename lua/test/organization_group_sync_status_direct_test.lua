-- OrganizationGroupSyncStatus direct test
...
describe("OrganizationGroupSyncStatusDirect", function()
  it("should direct-load-organization_group_sync_status", function()
    local setup = organization_group_sync_status_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-organization_group_sync_status", setup.live and "live" or "unit")
...
function organization_group_sync_status_direct_setup(mockres)
