-- RepositoryX509RsaCertificate direct test
...
describe("RepositoryX509RsaCertificateDirect", function()
  it("should direct-load-repository_x509_rsa_certificate", function()
    local setup = repository_x509_rsa_certificate_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-repository_x509_rsa_certificate", setup.live and "live" or "unit")
...
function repository_x509_rsa_certificate_direct_setup(mockres)
