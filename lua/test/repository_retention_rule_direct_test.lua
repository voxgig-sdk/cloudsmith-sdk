-- RepositoryRetentionRule direct test
...
describe("RepositoryRetentionRuleDirect", function()
  it("should direct-load-repository_retention_rule", function()
    local setup = repository_retention_rule_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-repository_retention_rule", setup.live and "live" or "unit")
...
function repository_retention_rule_direct_setup(mockres)
