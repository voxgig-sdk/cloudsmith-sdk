-- PackageFilePartsUpload direct test
...
describe("PackageFilePartsUploadDirect", function()
  it("should direct-load-package_file_parts_upload", function()
    local setup = package_file_parts_upload_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-package_file_parts_upload", setup.live and "live" or "unit")
...
function package_file_parts_upload_direct_setup(mockres)
