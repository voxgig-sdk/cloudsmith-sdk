-- OrganizationSamlAuth direct test
...
describe("OrganizationSamlAuthDirect", function()
  it("should direct-load-organization_saml_auth", function()
    local setup = organization_saml_auth_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-organization_saml_auth", setup.live and "live" or "unit")
...
function organization_saml_auth_direct_setup(mockres)
