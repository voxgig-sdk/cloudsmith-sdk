-- ResourcesRateCheck direct test
...
describe("ResourcesRateCheckDirect", function()
  it("should direct-load-resources_rate_check", function()
    local setup = resources_rate_check_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-resources_rate_check", setup.live and "live" or "unit")
...
function resources_rate_check_direct_setup(mockres)
