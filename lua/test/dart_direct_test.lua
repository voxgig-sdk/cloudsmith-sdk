...
describe("DartDirect", function()
  it("should direct-list-dart", function()
    local setup = dart_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-dart", setup.live and "live" or "unit")
  ...
  it("should direct-load-dart", function()
    local setup = dart_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-dart", setup.live and "live" or "unit")
    if _should_skip then
      pending(_reason or "skipped via sdk-test-control.json")
      return
    end
...
function dart_direct_setup(mockres)
