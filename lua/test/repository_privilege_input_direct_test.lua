...
describe("RepositoryPrivilegeInputDirect", function()
  it("should direct-list-repository_privilege_input", function()
    local setup = repository_privilege_input_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-repository_privilege_input", setup.live and "live" or "unit")
